...
os.system("git pull")
os.system("python3 -m pip install -e . --no-deps")
os.system("python3 -m pip install https://github.com/w4ffl35/diffusers/archive/refs/tags/v0.15.0.ckpt_fix_0.0.1.tar.gz")
