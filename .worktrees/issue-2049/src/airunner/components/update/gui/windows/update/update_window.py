...
class UpdateWindow(BaseWindow):
    ...
    def initialize_window(self):
        ...
        self.template.current_version_label.setText(
            f"{current_text} {self.application_settings.app_version}"
        )
        self.template.latest_version_label.setText(
            f"{latest_text} {self.application_settings.app_version}"
        )
