...
if python3 -c "import torch" 2>/dev/null; then
  ...
  pip install -v --cache-dir $PIP_CACHE_DIR --prefix $PYTHONUSERBASE torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu118
fi
...
if [ -d "/home/appuser/nltk_data/tokenizers/punkt" ]; then
