...
if os.getenv('DOCKER_ENV') == 'true':
    ...
    dist = os.path.join(base_path, "dist")
...
shutil.copytree(styles_path, os.path.join(internal_path, "airunner/styles"))

print(f"Copy alembic from {alembic_path}...")
shutil.copytree(alembic_path, os.path.join(internal_path, "alembic"))

print(f"Copy data from {data_path}...")
shutil.copytree(data_path, data_path_out)

print(f"Copy punkt from {punkt_path}...")
shutil.copytree(punkt_path, os.path.join(internal_path, "llama_index/core/_static/nltk_cache/tokenizers/punkt"))
