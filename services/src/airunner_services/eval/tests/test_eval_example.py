...
from airunner_services.eval.utils.tracking import track_trajectory_sync
from airunner_services.eval.utils.quality_metrics import (
    evaluate_tool_usage,
...
class TestEvalExample:
    ...
    @patch("airunner_services.llm.tools.agent_tools.AgentConfig")
    @patch("airunner_services.llm.tools.agent_tools.session_scope")
    ...
    @patch("airunner_services.llm.tools.web_tools.AggregatedSearchTool")
