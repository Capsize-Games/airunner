        ...
        app=SimpleNamespace(
            state=SimpleNamespace(
                ...
                lifecycle_service=SimpleNamespace(
                    ...
                    current_llm_model_status=current_llm_model_status,
                ),
            )
        )
    )
...
def test_list_runtimes_deduplicates_aliases_and_infers_loaded_state():
    ...
    from airunner_api.routes.daemon import list_runtimes
...
def test_daemon_runtime_status_includes_lifecycle_and_runtimes():
    ...
    from airunner_api.routes.daemon import daemon_runtime_status
...
def test_unload_runtime_invokes_control_action():
    ...
    from airunner_api.routes.daemon import RuntimeRouteRequest, unload_runtime
