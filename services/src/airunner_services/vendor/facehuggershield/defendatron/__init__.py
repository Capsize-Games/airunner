...
import airunner_services.vendor.facehuggershield.shadowlogger
import airunner_services.vendor.facehuggershield.darklock
import airunner_services.vendor.facehuggershield.nullscream
from airunner_services.vendor.facehuggershield.defendatron.nullscream_tracker import (
    NullscreamTracker,
)
...
def activate(
    ...
    if activate_shadowlogger:
        ...
        airunner_services.vendor.facehuggershield.shadowlogger.manager.activate(
    ...
    if activate_darklock:
        ...
        airunner_services.vendor.facehuggershield.darklock.activate(
    ...
    if activate_nullscream:
        ...
        airunner_services.vendor.facehuggershield.nullscream.activate(
...
def deactivate(
    ...
    airunner_services.vendor.facehuggershield.shadowlogger.manager.deactivate()
    airunner_services.vendor.facehuggershield.darklock.manager.deactivate()
    airunner_services.vendor.facehuggershield.nullscream.manager.deactivate(
        blacklist=nullscream_blacklist,
    )
