...
- [ ] Every inventoried bot capability has an executable issue or recorded acceptance evidence.
- [ ] No capability is silently dropped because it was absent from the initial port list.
- [ ] New issues use the same bounded template and do not include private content.
