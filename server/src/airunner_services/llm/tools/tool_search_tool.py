...
from airunner_services.llm.core.tool_search import get_tool_search_engine
from airunner_services.llm.core.tool_schema import (
...
def search_tools(
    query: Annotated[
        str, "Natural language query describing the tool you need"
    ],
