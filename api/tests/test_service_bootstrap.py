"""Smoke tests for the API service bootstrap.
...
# Ensure the api/src, services/src, model/src, and native/src directories
# are on the path for the transitional wrapper imports.
_API_ROOT = Path(__file__).resolve().parents[2]
_PROJECT_ROOT = _API_ROOT.parent
_SERVICES_SRC = _PROJECT_ROOT / "src" / "airunner" / "services" / "src"
...
for _path in (_API_ROOT / "src", _MODEL_SRC, _NATIVE_SRC, _SERVICES_SRC):
    _path_str = str(_path)
...
class TestImportChain:
    """Verify that the transitional wrapper import chain resolves."""

    def test_import_airunner_api_server(self):
        """The airunner_api.server module imports via transitional wrapper."""
        import airunner_api.server  # noqa: F401

    def test_import_airunner_api_routes_health(self):
        """Health route module resolves."""
        import airunner_api.routes.health  # noqa: F401

    def test_import_airunner_api_routes_art(self):
        """Art route module resolves."""
        import airunner_api.routes.art  # noqa: F401

    def test_import_airunner_api_routes_llm(self):
        """LLM route module resolves."""
        import airunner_api.routes.llm  # noqa: F401

    def test_import_airunner_api_routes_tts(self):
        """TTS route module resolves."""
        import airunner_api.routes.tts  # noqa: F401

    def test_import_airunner_api_routes_stt(self):
        """STT route module resolves."""
        import airunner_api.routes.stt  # noqa: F401

    def test_import_airunner_api_routes_daemon(self):
        """Daemon route module resolves."""
        import airunner_api.routes.daemon  # noqa: F401

    def test_import_airunner_api_routes_downloads(self):
        """Downloads route module resolves."""
        import airunner_api.routes.downloads  # noqa: F401

    def test_import_airunner_api_routes_conversations(self):
        """Conversations route module resolves."""
        import airunner_api.routes.conversations  # noqa: F401
