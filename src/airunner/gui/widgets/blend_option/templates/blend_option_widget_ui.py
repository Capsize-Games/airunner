...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.image_form.setWidget(
            0, QFormLayout.ItemRole.LabelRole, self.image_container
        )
        ...
        self.image_form.setLayout(
            0, QFormLayout.ItemRole.FieldRole, self.verticalLayout
        )
    ...
    def retranslateUi(self, Form):
        ...
        self.import_image_button.setText(
            QCoreApplication.translate("Form", "Import new image", None)
        )
        self.image_or_text_combobox.setItemText(
            0, QCoreApplication.translate("Form", "Image", None)
        )
        self.image_or_text_combobox.setItemText(
            1, QCoreApplication.translate("Form", "Text", None)
        )
