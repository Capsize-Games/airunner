...
class Ui_user_settings_widget(object):
    def setupUi(self, user_settings_widget):
        if not user_settings_widget.objectName():
            user_settings_widget.setObjectName("user_settings_widget")
        ...
        self.unit_system.currentTextChanged.connect(
            user_settings_widget.unit_system_changed
        )
    ...
    def retranslateUi(self, user_settings_widget):
        user_settings_widget.setWindowTitle(
            QCoreApplication.translate("user_settings_widget", "Form", None)
        )
        self.groupBox_3.setTitle(
            QCoreApplication.translate("user_settings_widget", "Unit System", None)
        )
        self.unit_system.setItemText(
            0, QCoreApplication.translate("user_settings_widget", "Imperial", None)
        )
        self.unit_system.setItemText(
            1, QCoreApplication.translate("user_settings_widget", "Metric", None)
        )

        self.groupBox_2.setTitle(
            QCoreApplication.translate("user_settings_widget", "Zipcode", None)
        )
        self.groupBox.setTitle(
            QCoreApplication.translate("user_settings_widget", "Username", None)
        )
