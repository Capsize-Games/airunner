...
class Ui_whisper_settings(object):
    def setupUi(self, whisper_settings):
        ...
        self.temperature.setProperty(u"slider_maximum", 1000)
        self.temperature.setProperty(u"spinbox_minimum", 0.000000000000000)
        ...
        self.compression_ratio_threshold.setProperty(u"slider_minimum", 1)
        self.compression_ratio_threshold.setProperty(u"slider_maximum", 5000)
        self.compression_ratio_threshold.setProperty(u"spinbox_minimum", 0.000000000000000)
        self.compression_ratio_threshold.setProperty(u"spinbox_maximum", 5.000000000000000)
        self.compression_ratio_threshold.setProperty(u"display_as_float", True)
        self.compression_ratio_threshold.setProperty(u"slider_single_step", 1)
        self.compression_ratio_threshold.setProperty(u"slider_page_step", 10)
        self.compression_ratio_threshold.setProperty(u"spinbox_single_step", 0.010000000000000)
        self.compression_ratio_threshold.setProperty(u"spinbox_page_step", 0.100000000000000)
        ...
        self.logprob_threshold.setProperty(u"slider_minimum", -1000)
        self.logprob_threshold.setProperty(u"slider_maximum", 1000)
        self.logprob_threshold.setProperty(u"spinbox_minimum", -1.000000000000000)
        self.logprob_threshold.setProperty(u"spinbox_maximum", 1.000000000000000)
        self.logprob_threshold.setProperty(u"display_as_float", True)
        self.logprob_threshold.setProperty(u"slider_single_step", 1)
        self.logprob_threshold.setProperty(u"slider_page_step", 10)
        self.logprob_threshold.setProperty(u"spinbox_single_step", 0.010000000000000)
        self.logprob_threshold.setProperty(u"spinbox_page_step", 0.100000000000000)
        ...
        self.no_speech_threshold.setProperty(u"slider_minimum", 0)
        self.no_speech_threshold.setProperty(u"slider_maximum", 1000)
        self.no_speech_threshold.setProperty(u"spinbox_minimum", 0.000000000000000)
        self.no_speech_threshold.setProperty(u"spinbox_maximum", 1.000000000000000)
        self.no_speech_threshold.setProperty(u"display_as_float", True)
        self.no_speech_threshold.setProperty(u"slider_single_step", 1)
        self.no_speech_threshold.setProperty(u"slider_page_step", 10)
        self.no_speech_threshold.setProperty(u"spinbox_single_step", 0.010000000000000)
        self.no_speech_threshold.setProperty(u"spinbox_page_step", 0.100000000000000)
        ...
        self.time_precision.setProperty(u"slider_minimum", 0)
        self.time_precision.setProperty(u"slider_maximum", 1000)
        self.time_precision.setProperty(u"spinbox_minimum", 0.000000000000000)
        self.time_precision.setProperty(u"spinbox_maximum", 1.000000000000000)
        self.time_precision.setProperty(u"display_as_float", True)
        self.time_precision.setProperty(u"slider_single_step", 1)
        self.time_precision.setProperty(u"slider_page_step", 10)
        self.time_precision.setProperty(u"spinbox_single_step", 0.010000000000000)
        self.time_precision.setProperty(u"spinbox_page_step", 0.100000000000000)
    ...
    def retranslateUi(self, whisper_settings):
        ...
        self.temperature.setProperty(u"settings_property", QCoreApplication.translate("whisper_settings", u"whisper_settings.temperature", None))
        self.temperature.setProperty(u"label_text", QCoreApplication.translate("whisper_settings", u"Temperature", None))
        self.compression_ratio_threshold.setProperty(u"settings_property", QCoreApplication.translate("whisper_settings", u"whisper_settings.compression_ratio_threshold", None))
        self.compression_ratio_threshold.setProperty(u"label_text", QCoreApplication.translate("whisper_settings", u"Compression ratio threshold", None))
        self.logprob_threshold.setProperty(u"settings_property", QCoreApplication.translate("whisper_settings", u"whisper_settings.logprob_threshold", None))
        self.logprob_threshold.setProperty(u"label_text", QCoreApplication.translate("whisper_settings", u"Logprob threshold", None))
        self.no_speech_threshold.setProperty(u"settings_property", QCoreApplication.translate("whisper_settings", u"whisper_settings.no_speech_threshold", None))
        self.no_speech_threshold.setProperty(u"label_text", QCoreApplication.translate("whisper_settings", u"No speech threshold", None))
        self.time_precision.setProperty(u"settings_property", QCoreApplication.translate("whisper_settings", u"whisper_settings.time_precision", None))
        self.time_precision.setProperty(u"label_text", QCoreApplication.translate("whisper_settings", u"Time precision", None))
