...
from airunner.gui.widgets.stt.whisper_settings_widget import WhisperSettingsWidget


class Ui_stt_settings(object):
    def setupUi(self, stt_settings):
        if not stt_settings.objectName():
            stt_settings.setObjectName("stt_settings")
        ...
        self.volume_input_threshold_slider.setObjectName(
            "volume_input_threshold_slider"
        )
        ...
        sizePolicy1.setHeightForWidth(
            self.volume_input_threshold_slider.sizePolicy().hasHeightForWidth()
        )
        ...
        self.volume_input_threshold_slider.setProperty(
            "spinbox_minimum", 0.000000000000000
        )
        self.volume_input_threshold_slider.setProperty(
            "spinbox_maximum", 2.000000000000000
        )
        ...
        self.silence_buffer_seconds.setObjectName("silence_buffer_seconds")
        sizePolicy1.setHeightForWidth(
            self.silence_buffer_seconds.sizePolicy().hasHeightForWidth()
        )
        ...
        self.silence_buffer_seconds.setProperty(
            "spinbox_single_step", 0.010000000000000
        )
        ...
        self.verticalSpacer = QSpacerItem(
            20, 724, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding
        )
    ...
    def retranslateUi(self, stt_settings):
        stt_settings.setWindowTitle(
            QCoreApplication.translate("stt_settings", "Form", None)
        )
        self.label_2.setText(
            QCoreApplication.translate("stt_settings", "LLM Settings", None)
        )
        self.volume_input_threshold_slider.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "stt_settings", "stt_settings.volume_input_threshold", None
            ),
        )
        self.volume_input_threshold_slider.setProperty(
            "label_text",
            QCoreApplication.translate("stt_settings", "Input Volume", None),
        )
        self.silence_buffer_seconds.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "stt_settings", "stt_settings.silence_buffer_seconds", None
            ),
        )
        self.silence_buffer_seconds.setProperty(
            "label_text",
            QCoreApplication.translate("stt_settings", "Silence Buffer", None),
        )
