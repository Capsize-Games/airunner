...
class Ui_language_settings_widget(object):
    def setupUi(self, language_settings_widget):
        if not language_settings_widget.objectName():
            language_settings_widget.setObjectName("language_settings_widget")
        ...
        self.gui_language.setObjectName("gui_language")
        ...
        self.user_language.setObjectName("user_language")
        ...
        self.bot_language.setObjectName("bot_language")
    ...
    def retranslateUi(self, language_settings_widget):
        language_settings_widget.setWindowTitle(
            QCoreApplication.translate("language_settings_widget", "Form", None)
        )
        self.groupBox.setTitle(
            QCoreApplication.translate("language_settings_widget", "GUI Langauge", None)
        )
        self.groupBox_2.setTitle(
            QCoreApplication.translate(
                "language_settings_widget", "User Language", None
            )
        )
        self.groupBox_3.setTitle(
            QCoreApplication.translate("language_settings_widget", "Bot Language", None)
        )
