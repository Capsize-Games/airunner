...
class Ui_api_token(object):
    def setupUi(self, api_token):
        ...
        self.hf_api_key_text_generation.textEdited.connect(
            api_token.action_text_edited_api_key
        )
        self.hf_api_key_writetoken.textEdited.connect(
            api_token.action_text_edited_writekey
        )
    ...
    def retranslateUi(self, api_token):
        api_token.setWindowTitle(QCoreApplication.translate("api_token", "Form", None))
        self.groupBox_2.setTitle(
            QCoreApplication.translate("api_token", "Write token", None)
        )
        self.label_3.setText(
            QCoreApplication.translate("api_token", "Huggingface Access Tokens", None)
        )
        self.label_2.setText(
            QCoreApplication.translate(
                "api_token", "https://huggingface.co/settings/tokens", None
            )
        )
        self.groupBox.setTitle(
            QCoreApplication.translate("api_token", "Read token", None)
        )
        self.label.setText(
            QCoreApplication.translate(
                "api_token",
                "Get your Huggingface read API token by creating an account on huggingface.co then navigating to",
                None,
            )
        )
