...
class Ui_image_layer_item(object):
    def setupUi(self, image_layer_item):
        if not image_layer_item.objectName():
            image_layer_item.setObjectName("image_layer_item")
    ...
    def retranslateUi(self, image_layer_item):
        image_layer_item.setWindowTitle(
            QCoreApplication.translate("image_layer_item", "Form", None)
        )
        self.total_images.setText(
            QCoreApplication.translate("image_layer_item", "TextLabel", None)
        )
        self.image.setText("")
