...
from airunner.gui.widgets.controlnet.controlnet_settings_widget import (
...
class Ui_input_image(object):
    def setupUi(self, input_image):
        ...
        sizePolicy.setHeightForWidth(
            self.image_container.sizePolicy().hasHeightForWidth()
        )
        ...
        self.strength_slider_widget.setObjectName("strength_slider_widget")
        ...
        sizePolicy1.setHeightForWidth(
            self.strength_slider_widget.sizePolicy().hasHeightForWidth()
        )
        ...
        self.strength_slider_widget.setProperty(
        ...
        self.mask_blur_slider_widget.setObjectName("mask_blur_slider_widget")
        sizePolicy1.setHeightForWidth(
            self.mask_blur_slider_widget.sizePolicy().hasHeightForWidth()
        )
        ...
        self.mask_blur_slider_widget.setProperty(
            "spinbox_single_step", 0.010000000000000
        )
        ...
        self.link_to_grid_image_button.setObjectName("link_to_grid_image_button")
        icon = QIcon()
        icon.addFile(
            ":/light/icons/feather/light/link.svg",
            QSize(),
            QIcon.Mode.Normal,
            QIcon.State.Off,
        )
        ...
        icon2 = QIcon()
        icon2.addFile(
            ":/light/icons/feather/light/refresh-ccw.svg",
            QSize(),
            QIcon.Mode.Normal,
            QIcon.State.Off,
        )
        ...
        self.EnableSwitch.setObjectName("EnableSwitch")
        ...
        self.link_to_grid_image_button.toggled.connect(
            input_image.use_grid_image_as_input_toggled
        )
    ...
    def retranslateUi(self, input_image):
        input_image.setWindowTitle(
            QCoreApplication.translate("input_image", "Form", None)
        )
        self.strength_slider_widget.setProperty(
            "label_text", QCoreApplication.translate("input_image", "Strength", None)
        )
        self.strength_slider_widget.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "input_image", "generator_settings.strength", None
            ),
        )
        self.mask_blur_slider_widget.setProperty(
            "label_text", QCoreApplication.translate("input_image", "Mask Blur", None)
        )
        self.mask_blur_slider_widget.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "input_image", "outpaint_settings.mask_blur", None
            ),
        )
        # if QT_CONFIG(tooltip)
        self.link_to_grid_image_button.setToolTip(
            QCoreApplication.translate("input_image", "Link to Grid image", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.link_to_grid_image_button.setText("")
        # if QT_CONFIG(tooltip)
        self.lock_input_image_button.setToolTip(
            QCoreApplication.translate("input_image", "Lock current input image", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.lock_input_image_button.setText("")
        # if QT_CONFIG(tooltip)
        self.refresh_button.setToolTip(
            QCoreApplication.translate("input_image", "Refresh from grid image", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.refresh_button.setText("")
        # if QT_CONFIG(tooltip)
        self.import_button.setToolTip(
            QCoreApplication.translate("input_image", "Import", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.import_button.setText("")
        # if QT_CONFIG(tooltip)
        self.delete_button.setToolTip(
            QCoreApplication.translate("input_image", "Delete", None)
        )
        # endif // QT_CONFIG(tooltip)
