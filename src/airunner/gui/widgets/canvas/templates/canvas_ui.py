...
from airunner.gui.widgets.stablediffusion.stablediffusion_generator_form import (
    StableDiffusionGeneratorForm,
)
from airunner.gui.widgets.stablediffusion.stablediffusion_tool_tab_widget import (
...
class Ui_canvas(object):
    ...
    def retranslateUi(self, canvas):
        canvas.setWindowTitle(QCoreApplication.translate("canvas", "Form", None))
