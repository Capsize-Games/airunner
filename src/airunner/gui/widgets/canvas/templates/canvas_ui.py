...
class Ui_canvas(object):
    def setupUi(self, canvas):
        ...
        self.prompts.setMinimumSize(QSize(225, 0))
        self.prompts.setMaximumSize(QSize(16777215, 16777215))
        self.prompts.setBaseSize(QSize(225, 0))
        ...
        self.canvas_container.setMinimumSize(QSize(512, 0))
        ...
        self.widget2.setMinimumSize(QSize(275, 0))
        self.widget2.setMaximumSize(QSize(16777215, 16777215))
        self.widget2.setBaseSize(QSize(275, 0))
