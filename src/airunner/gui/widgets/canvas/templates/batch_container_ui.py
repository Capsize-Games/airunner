...
class Ui_batch_conatiner(object):
    def setupUi(self, batch_conatiner):
        if not batch_conatiner.objectName():
            batch_conatiner.setObjectName("batch_conatiner")
        ...
        self.image_folders.setObjectName("image_folders")
    ...
    def retranslateUi(self, batch_conatiner):
        batch_conatiner.setWindowTitle(
            QCoreApplication.translate("batch_conatiner", "Form", None)
        )
