...
class Ui_civitai_preferences(object):
    def setupUi(self, civitai_preferences):
        if not civitai_preferences.objectName():
            civitai_preferences.setObjectName("civitai_preferences")
    ...
    def retranslateUi(self, civitai_preferences):
        civitai_preferences.setWindowTitle(
            QCoreApplication.translate("civitai_preferences", "Form", None)
        )
        self.groupBox.setTitle(
            QCoreApplication.translate("civitai_preferences", "API Key", None)
        )
