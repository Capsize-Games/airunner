...
class Ui_memory_preferences(object):
    def setupUi(self, memory_preferences):
        ...
        self.sd_combobox.setObjectName("sd_combobox")
        ...
        self.stt_combobox.setObjectName("stt_combobox")
        ...
        self.tts_combobox.setObjectName("tts_combobox")
        ...
        self.llm_combobox.setObjectName("llm_combobox")
        ...
        self.prevent_unload_on_llm_image_generation.setObjectName(
        ...
        self.gridLayout.addWidget(
            self.prevent_unload_on_llm_image_generation, 3, 0, 1, 1
        )

        self.use_enable_sequential_cpu_offload = QCheckBox(memory_preferences)
        self.use_enable_sequential_cpu_offload.setObjectName(
        ...
        self.verticalSpacer = QSpacerItem(
            624, 13, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding
        )
        ...
        self.use_enable_vae_slicing.toggled.connect(
            memory_preferences.action_toggled_vae_slicing
        )
        ...
        self.use_enable_sequential_cpu_offload.toggled.connect(
            memory_preferences.action_toggled_sequential_cpu_offload
        )
        self.use_accelerated_transformers.toggled.connect(
            memory_preferences.action_toggled_accelerated_transformers
        )
        self.optimize_memory_button.clicked.connect(
            memory_preferences.action_button_clicked_optimize_memory_settings
        )
        self.use_lastchannels.toggled.connect(
            memory_preferences.action_toggled_last_memory
        )
        self.use_attention_slicing.toggled.connect(
            memory_preferences.action_toggled_attention_slicing
        )
        self.enable_model_cpu_offload.toggled.connect(
            memory_preferences.action_toggled_model_cpu_offload
        )
        self.sd_combobox.currentTextChanged.connect(
            memory_preferences.action_changed_sd_combobox
        )
        self.llm_combobox.currentTextChanged.connect(
            memory_preferences.action_changed_llm_combobox
        )
        self.tts_combobox.currentTextChanged.connect(
            memory_preferences.action_changed_tts_combobox
        )
        self.stt_combobox.currentTextChanged.connect(
            memory_preferences.action_changed_stt_combobox
        )
    ...
    def retranslateUi(self, memory_preferences):
        memory_preferences.setWindowTitle(
            QCoreApplication.translate("memory_preferences", "Form", None)
        )
        # if QT_CONFIG(tooltip)
        self.enable_model_cpu_offload.setToolTip(
            QCoreApplication.translate(
                "memory_preferences",
                '<html><head/><body><p><span style=" font-weight:400;">Use with attention slicing for lower memory consumption.</span></p><p><span style=" font-weight:400;">Moves whole models to the GPU, instead of handling each model\u2019s constituent </span><span style=" font-weight:400; font-style:italic;">modules</span><span style=" font-weight:400;">. This results in a negligible impact on inference time (compared with moving the pipeline to </span><span style=" font-family:\'monospace\'; font-weight:400;">cuda</span><span style=" font-weight:400;">), while still providing some memory savings.</span></p></body></html>',
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.enable_model_cpu_offload.setText(
            QCoreApplication.translate("memory_preferences", "Model CPU offload", None)
        )
        # if QT_CONFIG(tooltip)
        self.use_enable_vae_slicing.setToolTip(
            QCoreApplication.translate(
                "memory_preferences",
                '<html><head/><body><p><span style=" font-weight:400;">Use with Attention Slicing or Xformers</span></p><p><span style=" font-weight:400;">Decode large batches of images with limited VRAM, or to enable batches with 32 images or more.</span></p></body></html>',
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.use_enable_vae_slicing.setText(
            QCoreApplication.translate("memory_preferences", "Vae Slicing", None)
        )
        # if QT_CONFIG(tooltip)
        self.use_attention_slicing.setToolTip(
            QCoreApplication.translate(
                "memory_preferences",
                '<html><head/><body><p><span style=" font-weight:400;">Perform computation in steps instead of all at once.</span></p><p><span style=" font-weight:400;">About 10% slower inference times.</span></p><p><span style=" font-weight:400;">Uses as little as 3.2 GB of VRAM.</span></p></body></html>',
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.use_attention_slicing.setText(
            QCoreApplication.translate("memory_preferences", "Attention Slicing", None)
        )
        # if QT_CONFIG(tooltip)
        self.use_tiled_vae.setToolTip(
            QCoreApplication.translate(
                "memory_preferences",
                '<html><head/><body><p><span style=" font-weight:400;">Use with Attention Slicing or Xformers</span></p><p><span style=" font-weight:400;">Makes it possible to work with large images on limited VRAM. Splits image into overlapping tiles, decodes tiles, blends outputs to make final image.</span></p></body></html>',
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.use_tiled_vae.setText(
            QCoreApplication.translate("memory_preferences", "Tile vae", None)
        )
        self.label_6.setText(
            QCoreApplication.translate(
                "memory_preferences", "Work with large batches", None
            )
        )
        self.groupBox.setTitle(
            QCoreApplication.translate("memory_preferences", "Art Model", None)
        )
        self.groupBox_4.setTitle(
            QCoreApplication.translate("memory_preferences", "Speech to text", None)
        )
        self.groupBox_3.setTitle(
            QCoreApplication.translate("memory_preferences", "Text to speech", None)
        )
        self.groupBox_2.setTitle(
            QCoreApplication.translate("memory_preferences", "Text Generator", None)
        )
        self.label_11.setText(
            QCoreApplication.translate(
                "memory_preferences", "Assign models to available cards", None
            )
        )
        self.label_9.setText(
            QCoreApplication.translate(
                "memory_preferences",
                "Keep this checked to take advantage of torch 2.0",
                None,
            )
        )
        # if QT_CONFIG(tooltip)
        self.use_lastchannels.setToolTip(
            QCoreApplication.translate(
                "memory_preferences",
                '<html><head/><body><p><span style=" font-weight:400;">Alternative way of ordering NCHW tensors in memory preserving dimensions ordering. Channels last tensors ordered in such a way that channels become the densest dimension (aka storing images pixel-per-pixel). </span></p><p><span style=" font-weight:400;">Since not all operators currently support channels last format it may result in a worst performance, so it\u2019s better to try it and see if it works for your model.</span></p></body></html>',
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.use_lastchannels.setText(
            QCoreApplication.translate(
                "memory_preferences", "Channels last memory", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.use_tf32.setToolTip(
            QCoreApplication.translate(
                "memory_preferences",
                '<html><head/><body><p><span style=" font-weight:400;">On Ampere and later CUDA devices matrix multiplications and convolutions can use the TensorFloat32 (TF32) mode for faster but slightly less accurate computations.</span></p></body></html>',
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.use_tf32.setText(
            QCoreApplication.translate("memory_preferences", "TF32", None)
        )
        self.label.setText(
            QCoreApplication.translate(
                "memory_preferences", "Less VRAM usage, slower inference", None
            )
        )
        self.label_2.setText(
            QCoreApplication.translate(
                "memory_preferences", "Less VRAM usage, slight inference impact", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.use_accelerated_transformers.setToolTip(
            QCoreApplication.translate(
                "memory_preferences",
                '<html><head/><body><p><span style=" font-weight:400;">Optimized and memory-efficient attention implementation.</span></p></body></html>',
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.use_accelerated_transformers.setText(
            QCoreApplication.translate(
                "memory_preferences", "Accelerated Transformers", None
            )
        )
        self.label_7.setText(
            QCoreApplication.translate(
                "memory_preferences", "Work with large images", None
            )
        )
        self.prevent_unload_on_llm_image_generation.setText(
            QCoreApplication.translate(
                "memory_preferences", "Disable automatic model management", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.use_enable_sequential_cpu_offload.setToolTip(
            QCoreApplication.translate(
                "memory_preferences",
                '<html><head/><body><p><span style=" font-weight:400;">Use with </span>attention slicing<span style=" font-weight:400;"> for lower memory consumption.</span></p><p><span style=" font-weight:400;">Offloads the weights to CPU and only load them to GPU when performing the forward pass for memory savings.</span></p></body></html>',
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.use_enable_sequential_cpu_offload.setText(
            QCoreApplication.translate(
                "memory_preferences", "Sequential CPU offload", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.use_tome.setToolTip(
            QCoreApplication.translate(
                "memory_preferences",
                "Merge redundant tokens for faster inference. May result in slight reduction in image quality.",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.use_tome.setTitle(
            QCoreApplication.translate("memory_preferences", "ToMe Token Merging", None)
        )
        self.tome_sd_ratio.setProperty(
            "label_text",
            QCoreApplication.translate("memory_preferences", "Ratio", None),
        )
        self.tome_sd_ratio.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "memory_preferences", "memory_settings.tome_sd_ratio", None
            ),
        )
        self.label_10.setText(
            QCoreApplication.translate(
                "memory_preferences", "Faster inference, slight image impact", None
            )
        )
        self.label_8.setText(
            QCoreApplication.translate(
                "memory_preferences", "Faster inference, lower VRAM usage", None
            )
        )
        ...
        self.label_3.setText(
            QCoreApplication.translate(
                "memory_preferences",
                "May slow inference on some models, speed up on others",
                None,
            )
        )
        self.label_5.setText(
            QCoreApplication.translate(
                "memory_preferences",
                "faster matrix multiplications on ampere achitecture",
                None,
            )
        )
        self.optimize_memory_button.setText(
            QCoreApplication.translate(
                "memory_preferences", "Optimize Memory Settings", None
            )
        )
        self.label_12.setText(
            QCoreApplication.translate(
                "memory_preferences",
                "Models will auto load / unload when generating images with the chatbot.",
                None,
            )
        )
