...
class Ui_slider_widget(object):
    def setupUi(self, slider_widget):
        ...
        sizePolicy.setHeightForWidth(
            self.slider_spinbox.sizePolicy().hasHeightForWidth()
        )
        ...
        self.slider_spinbox.setButtonSymbols(
    ...
    def retranslateUi(self, slider_widget):
        slider_widget.setWindowTitle(
            QCoreApplication.translate("slider_widget", "Form", None)
        )
        self.groupBox.setTitle(
            QCoreApplication.translate("slider_widget", "GroupBox", None)
        )
