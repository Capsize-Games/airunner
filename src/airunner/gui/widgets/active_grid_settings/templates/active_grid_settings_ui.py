...
class Ui_active_grid_settings_widget(object):
    def setupUi(self, active_grid_settings_widget):
        ...
        self.width_slider_widget.setProperty(
            "settings_property", "application_settings.working_width"
        )
        ...
        self.size_lock_button.setObjectName("size_lock_button")
        sizePolicy1 = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(
            self.size_lock_button.sizePolicy().hasHeightForWidth()
        )
        self.size_lock_button.setSizePolicy(sizePolicy1)
        icon = QIcon(QIcon.fromTheme("system-lock-screen"))
        ...
        sizePolicy.setHeightForWidth(
            self.active_grid_border_groupbox.sizePolicy().hasHeightForWidth()
        )
        ...
        self.border_opacity_slider_widget = SliderWidget(
            self.active_grid_border_groupbox
        )
        self.border_opacity_slider_widget.setObjectName("border_opacity_slider_widget")
        self.border_opacity_slider_widget.setProperty(
            "spinbox_single_step", 0.010000000000000
        )
        self.border_opacity_slider_widget.setProperty("slider_page_step", 1)
        self.border_opacity_slider_widget.setProperty(
            "spinbox_page_step", 0.100000000000000
        )
        ...
        self.border_opacity_slider_widget.setProperty(
            "spinbox_minimum", 0.000000000000000
        )
        self.border_opacity_slider_widget.setProperty(
            "spinbox_maximum", 1.000000000000000
        )
        self.border_opacity_slider_widget.setProperty(
            "slider_tick_interval", 1.000000000000000
        )
        ...
        self.border_choose_color_button.setObjectName("border_choose_color_button")
        ...
        sizePolicy2.setHeightForWidth(
            self.border_choose_color_button.sizePolicy().hasHeightForWidth()
        )
        self.border_choose_color_button.setSizePolicy(sizePolicy2)
        self.border_choose_color_button.setCursor(
        ...
        sizePolicy.setHeightForWidth(
            self.active_grid_fill_groupbox.sizePolicy().hasHeightForWidth()
        )
        ...
        self.fill_opacity_slider_widget.setProperty(
            "spinbox_single_step", 0.010000000000000
        )
        ...
        self.fill_choose_color_button.setObjectName("fill_choose_color_button")
        sizePolicy2.setHeightForWidth(
            self.fill_choose_color_button.sizePolicy().hasHeightForWidth()
        )
        self.fill_choose_color_button.setSizePolicy(sizePolicy2)
        self.fill_choose_color_button.setCursor(
            QCursor(Qt.CursorShape.PointingHandCursor)
        )
        ...
        self.verticalSpacer = QSpacerItem(
            20, 139, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding
        )
        ...
        self.active_grid_area_checkbox.setObjectName("active_grid_area_checkbox")
        font1 = QFont()
        font1.setBold(False)
        ...
        self.active_grid_area_checkbox.clicked["bool"].connect(
            active_grid_settings_widget.action_clicked_checkbox_toggle_active_grid_area
        )
        self.size_lock_button.toggled.connect(
            active_grid_settings_widget.size_lock_toggled
        )
        self.border_choose_color_button.clicked.connect(
            active_grid_settings_widget.action_choose_border_color_clicked
        )
        self.fill_choose_color_button.clicked.connect(
            active_grid_settings_widget.action_choose_fill_color_clicked
        )
    ...
    def retranslateUi(self, active_grid_settings_widget):
        active_grid_settings_widget.setWindowTitle(
            QCoreApplication.translate("active_grid_settings_widget", "Form", None)
        )
        self.groupBox_3.setTitle(
            QCoreApplication.translate("active_grid_settings_widget", "Size", None)
        )
        self.width_slider_widget.setProperty(
            "label_text",
            QCoreApplication.translate("active_grid_settings_widget", "Width", None),
        )
        self.size_lock_button.setText("")
        self.height_slider_widget.setProperty(
            "label_text",
            QCoreApplication.translate("active_grid_settings_widget", "Height", None),
        )
        self.height_slider_widget.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "active_grid_settings_widget",
                "application_settings.working_height",
                None,
            ),
        )
        self.active_grid_border_groupbox.setTitle(
            QCoreApplication.translate("active_grid_settings_widget", "Border", None)
        )
        self.border_opacity_slider_widget.setProperty(
            "label_text",
            QCoreApplication.translate(
                "active_grid_settings_widget", "Border Opacity", None
            ),
        )
        self.border_opacity_slider_widget.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "active_grid_settings_widget",
                "active_grid_settings.border_opacity",
                None,
            ),
        )
        self.border_choose_color_button.setText(
            QCoreApplication.translate("active_grid_settings_widget", "Color", None)
        )
        self.active_grid_fill_groupbox.setTitle(
            QCoreApplication.translate("active_grid_settings_widget", "Fill", None)
        )
        self.fill_opacity_slider_widget.setProperty(
            "label_text",
            QCoreApplication.translate(
                "active_grid_settings_widget", "Fill Opacity", None
            ),
        )
        self.fill_opacity_slider_widget.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "active_grid_settings_widget", "active_grid_settings.fill_opacity", None
            ),
        )
        ...
        self.label.setText(
            QCoreApplication.translate(
                "active_grid_settings_widget", "Active Grid Settings", None
            )
        )
        self.active_grid_area_checkbox.setText(
            QCoreApplication.translate(
                "active_grid_settings_widget", "Enable Active Grid Area", None
            )
        )
