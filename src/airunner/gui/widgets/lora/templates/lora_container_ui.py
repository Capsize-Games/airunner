...
class Ui_lora_container(object):
    def setupUi(self, lora_container):
        ...
        self.apply_lora_button.setObjectName("apply_lora_button")
        ...
        self.lora_scale_slider.setObjectName("lora_scale_slider")
        sizePolicy.setHeightForWidth(
            self.lora_scale_slider.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, lora_container):
        lora_container.setWindowTitle(
            QCoreApplication.translate("lora_container", "Form", None)
        )
        self.pushButton.setText(
            QCoreApplication.translate("lora_container", "Scan for LoRA", None)
        )
        self.label.setText(QCoreApplication.translate("lora_container", "Lora", None))
        self.apply_lora_button.setText(
            QCoreApplication.translate("lora_container", "Apply Changes", None)
        )
        self.lora_scale_slider.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "lora_container", "generator_settings.lora_scale", None
            ),
        )
        self.lora_scale_slider.setProperty(
            "label_text", QCoreApplication.translate("lora_container", "Scale", None)
        )
        self.lineEdit.setPlaceholderText(
            QCoreApplication.translate("lora_container", "Search", None)
        )
        self.toggleAllLora.setText(
            QCoreApplication.translate("lora_container", "Toggle all", None)
        )
