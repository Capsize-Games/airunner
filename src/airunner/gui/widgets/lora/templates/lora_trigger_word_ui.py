...
class Ui_lora_trigger_word(object):
    def setupUi(self, lora_trigger_word):
        ...
        icon1 = QIcon(QIcon.fromTheme("edit-copy"))
        ...
        self.button_to_prompt.clicked["bool"].connect(
            lora_trigger_word.action_click_button_to_prompt
        )
        self.button_to_negative_prompt.clicked.connect(
            lora_trigger_word.action_click_button_to_negative_prompt
        )
    ...
    def retranslateUi(self, lora_trigger_word):
        lora_trigger_word.setWindowTitle(
            QCoreApplication.translate("lora_trigger_word", "Form", None)
        )
        self.trigger_word.setText(
            QCoreApplication.translate("lora_trigger_word", "Trigger Word", None)
        )
        # if QT_CONFIG(tooltip)
        self.button_to_prompt.setToolTip(
            QCoreApplication.translate(
                "lora_trigger_word", "Send trigger word to prompt", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.button_to_prompt.setText(
            QCoreApplication.translate("lora_trigger_word", "Prompt", None)
        )
        # if QT_CONFIG(tooltip)
        self.button_to_negative_prompt.setToolTip(
            QCoreApplication.translate(
                "lora_trigger_word", "Send trigger word to negative prompt", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.button_to_negative_prompt.setText(
            QCoreApplication.translate("lora_trigger_word", "Negative", None)
        )
        # if QT_CONFIG(tooltip)
        self.button_copy.setToolTip(
            QCoreApplication.translate(
                "lora_trigger_word", "Copy trigger word to clipboard", None
            )
        )
        # endif // QT_CONFIG(tooltip)
