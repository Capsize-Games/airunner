...
from PySide6.QtWidgets import QApplication, QFrame, QGridLayout, QSizePolicy, QWidget
...
class Ui_image_widget(object):
    ...
    def retranslateUi(self, image_widget):
        image_widget.setWindowTitle(
            QCoreApplication.translate("image_widget", "Form", None)
        )
