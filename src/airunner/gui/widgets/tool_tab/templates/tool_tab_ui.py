...
class Ui_tool_tab_widget(object):
    def setupUi(self, tool_tab_widget):
        if not tool_tab_widget.objectName():
            tool_tab_widget.setObjectName("tool_tab_widget")
        ...
        self.llm_settings.setObjectName("llm_settings")
        ...
        self.llm_history_widget.setObjectName("llm_history_widget")
    ...
    def retranslateUi(self, tool_tab_widget):
        tool_tab_widget.setWindowTitle(
            QCoreApplication.translate("tool_tab_widget", "Form", None)
        )
        self.tool_tab_widget_container.setTabText(
            self.tool_tab_widget_container.indexOf(self.tab),
            QCoreApplication.translate("tool_tab_widget", "LLM", None),
        )
        self.tool_tab_widget_container.setTabText(
            self.tool_tab_widget_container.indexOf(self.tab_2),
            QCoreApplication.translate("tool_tab_widget", "Chat History", None),
        )
