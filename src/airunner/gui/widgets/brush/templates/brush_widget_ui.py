...
class Ui_brush_widget(object):
    def setupUi(self, brush_widget):
        ...
        self.toggle_auto_generate_while_drawing = QCheckBox(
            self.scrollAreaWidgetContents
        )
        self.toggle_auto_generate_while_drawing.setObjectName(
            "toggle_auto_generate_while_drawing"
        )
        ...
        sizePolicy.setHeightForWidth(
            self.primary_color_button.sizePolicy().hasHeightForWidth()
        )
        ...
        self.toggle_auto_generate_while_drawing.toggled.connect(
            brush_widget.toggle_auto_generate_while_drawing
        )
    ...
    def retranslateUi(self, brush_widget):
        brush_widget.setWindowTitle(
            QCoreApplication.translate("brush_widget", "Form", None)
        )
        self.brush_size_slider.setProperty(
            "label_text", QCoreApplication.translate("brush_widget", "Brush Size", None)
        )
        self.toggle_auto_generate_while_drawing.setText(
            QCoreApplication.translate(
                "brush_widget", "Auto-generate while drawing", None
            )
        )
        self.groupBox_4.setTitle(
            QCoreApplication.translate("brush_widget", "Brush color", None)
        )
        self.primary_color_button.setText("")
        self.label.setText(
            QCoreApplication.translate("brush_widget", "Brush Settings", None)
        )
