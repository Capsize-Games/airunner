...
class Ui_embeddings_container(object):
    def setupUi(self, embeddings_container):
        ...
        self.embeddings_scroll_area.setObjectName("embeddings_scroll_area")
        font = QFont()
        font.setPointSize(9)
        ...
        self.apply_embeddings_button.setObjectName("apply_embeddings_button")
        ...
        self.toggle_all_embeddings.setObjectName("toggle_all_embeddings")
        ...
        self.pushButton.clicked.connect(
            embeddings_container.action_clicked_button_scan_for_embeddings
        )
        self.lineEdit.textChanged.connect(embeddings_container.search_text_changed)
        self.toggle_all_embeddings.toggled.connect(
            embeddings_container.toggle_all_toggled
        )
        self.apply_embeddings_button.clicked.connect(
            embeddings_container.apply_embeddings
        )
    ...
    def retranslateUi(self, embeddings_container):
        embeddings_container.setWindowTitle(
            QCoreApplication.translate("embeddings_container", "Form", None)
        )
        self.pushButton.setText(
            QCoreApplication.translate(
                "embeddings_container", "Scan for embeddings", None
            )
        )
        self.label.setText(
            QCoreApplication.translate("embeddings_container", "Embeddings", None)
        )
        self.apply_embeddings_button.setText(
            QCoreApplication.translate("embeddings_container", "Apply Changes", None)
        )
        self.lineEdit.setPlaceholderText(
            QCoreApplication.translate("embeddings_container", "Search", None)
        )
        self.toggle_all_embeddings.setText(
            QCoreApplication.translate("embeddings_container", "Toggle all", None)
        )
