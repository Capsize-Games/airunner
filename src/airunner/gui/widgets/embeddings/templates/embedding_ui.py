...
class Ui_embedding(object):
    def setupUi(self, embedding):
        ...
        self.trigger_word_edit.textChanged.connect(
            embedding.action_changed_trigger_word
        )
    ...
    def retranslateUi(self, embedding):
        embedding.setWindowTitle(QCoreApplication.translate("embedding", "Form", None))
        self.enabledCheckbox.setText(
            QCoreApplication.translate("embedding", "enabledCheckbox", None)
        )
        ...
        self.trigger_word_edit.setPlaceholderText(
            QCoreApplication.translate(
                "embedding", "Trigger words (comma separated)", None
            )
        )
