...
class Ui_keyboard_shortcut_widget(object):
    ...
    def retranslateUi(self, keyboard_shortcut_widget):
        keyboard_shortcut_widget.setWindowTitle(
            QCoreApplication.translate("keyboard_shortcut_widget", "Form", None)
        )
        self.label.setText(
            QCoreApplication.translate("keyboard_shortcut_widget", "TextLabel", None)
        )
