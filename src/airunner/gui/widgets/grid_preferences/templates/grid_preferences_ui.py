...
class Ui_grid_preferences(object):
    def setupUi(self, grid_preferences):
        ...
        self.grid_line_width_spinbox.valueChanged.connect(
            grid_preferences.line_width_changed
        )
        self.gridLineColorButton.clicked.connect(
            grid_preferences.action_button_clicked_grid_line_color
        )
        self.canvas_color.clicked.connect(
            grid_preferences.action_button_clicked_canvas_color
        )
        self.show_grid_checkbox.toggled.connect(
            grid_preferences.action_toggled_show_grid
        )
        self.snap_to_grid_checkbox.toggled.connect(
            grid_preferences.action_toggled_snap_to_grid
        )
    ...
    def retranslateUi(self, grid_preferences):
        grid_preferences.setWindowTitle(
            QCoreApplication.translate("grid_preferences", "Form", None)
        )
        self.gridLineColorButton.setText(
            QCoreApplication.translate("grid_preferences", "Line Color", None)
        )
        self.canvas_color.setText(
            QCoreApplication.translate("grid_preferences", "Canvas Color", None)
        )
        self.groupBox.setTitle(
            QCoreApplication.translate("grid_preferences", "Cell Size", None)
        )
        self.groupBox_2.setTitle(
            QCoreApplication.translate("grid_preferences", "Line Width", None)
        )
        self.label_3.setText(
            QCoreApplication.translate("grid_preferences", "Grid Settings", None)
        )
        self.show_grid_checkbox.setText(
            QCoreApplication.translate("grid_preferences", "Show", None)
        )
        self.snap_to_grid_checkbox.setText(
            QCoreApplication.translate("grid_preferences", "Snap to", None)
        )
