...
class Ui_path_widget(object):
    ...
    def retranslateUi(self, path_widget):
        path_widget.setWindowTitle(
            QCoreApplication.translate("path_widget", "Form", None)
        )
        self.title_label.setText(
            QCoreApplication.translate("path_widget", "Title", None)
        )
        self.description_label.setText(
            QCoreApplication.translate("path_widget", "Description", None)
        )
        self.browse_button.setText(
            QCoreApplication.translate("path_widget", "Browse", None)
        )
