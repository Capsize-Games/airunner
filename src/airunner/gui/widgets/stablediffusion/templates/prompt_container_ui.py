...
class Ui_prompt_container_widget(object):
    def setupUi(self, prompt_container_widget):
        if not prompt_container_widget.objectName():
            prompt_container_widget.setObjectName("prompt_container_widget")
        ...
        icon = QIcon(QIcon.fromTheme("user-trash"))
        self.pushButton.setIcon(icon)

        self.gridLayout.addWidget(self.pushButton, 1, 0, 1, 1)

        self.horizontalSpacer = QSpacerItem(
            396, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
        ...
        self.pushButton.clicked.connect(
            prompt_container_widget.handle_delete_prompt_clicked
        )
    ...
    def retranslateUi(self, prompt_container_widget):
        prompt_container_widget.setWindowTitle(
            QCoreApplication.translate("prompt_container_widget", "Form", None)
        )
        self.prompt.setPlaceholderText(
            QCoreApplication.translate("prompt_container_widget", "Enter prompt", None)
        )
        self.secondary_prompt.setPlaceholderText(
            QCoreApplication.translate(
                "prompt_container_widget", "Enter optional second prompt", None
            )
        )
