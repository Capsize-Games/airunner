...
class Ui_stable_diffusion_settings_widget(object):
    def setupUi(self, stable_diffusion_settings_widget):
        if not stable_diffusion_settings_widget.objectName():
            stable_diffusion_settings_widget.setObjectName(
        ...
        self.verticalSpacer = QSpacerItem(
            20, 394, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding
        )
        ...
        self.use_compel.setObjectName("use_compel")
        ...
        sizePolicy.setHeightForWidth(
            self.clip_skip_slider_widget.sizePolicy().hasHeightForWidth()
        )
        ...
        self.clip_skip_slider_widget.setProperty(
            "settings_property", "generator_settings.clip_skip"
        )
        ...
        sizePolicy.setHeightForWidth(
            self.frames_slider_widget.sizePolicy().hasHeightForWidth()
        )
        ...
        self.frames_slider_widget.setProperty(
            "settings_property", "generator_settings.n_samples"
        )
        ...
        sizePolicy.setHeightForWidth(
            self.ddim_eta_slider_widget.sizePolicy().hasHeightForWidth()
        )
        ...
        self.ddim_eta_slider_widget.setProperty(
            "settings_property", "generator_settings.ddim_eta"
        )
        ...
        self.version.currentTextChanged.connect(
            stable_diffusion_settings_widget.handle_version_changed
        )
        self.pipeline.currentTextChanged.connect(
            stable_diffusion_settings_widget.handle_pipeline_changed
        )
        self.use_compel.toggled.connect(
            stable_diffusion_settings_widget.toggled_use_compel
        )
        self.scheduler.currentTextChanged.connect(
            stable_diffusion_settings_widget.handle_scheduler_changed
        )
        self.model.currentTextChanged.connect(
            stable_diffusion_settings_widget.handle_model_changed
        )
        self.custom_model.textEdited.connect(
            stable_diffusion_settings_widget.on_custom_model_textChanged
        )
    ...
    def retranslateUi(self, stable_diffusion_settings_widget):
        stable_diffusion_settings_widget.setWindowTitle(
            QCoreApplication.translate("stable_diffusion_settings_widget", "Form", None)
        )
        self.scale_widget.setProperty(
            "label_text",
            QCoreApplication.translate(
                "stable_diffusion_settings_widget", "Guidance Scale", None
            ),
        )
        self.steps_widget.setProperty(
            "label_text",
            QCoreApplication.translate(
                "stable_diffusion_settings_widget", "Steps", None
            ),
        )
        self.use_compel.setText(
            QCoreApplication.translate(
                "stable_diffusion_settings_widget", "Use Compel", None
            )
        )
        self.clip_skip_slider_widget.setProperty(
            "label_text",
            QCoreApplication.translate(
                "stable_diffusion_settings_widget", "Clip Skip", None
            ),
        )
        self.groupBox_2.setTitle(
            QCoreApplication.translate(
                "stable_diffusion_settings_widget", "Model", None
            )
        )
        self.groupBox_3.setTitle(
            QCoreApplication.translate(
                "stable_diffusion_settings_widget", "Pipeline", None
            )
        )
        self.groupBox_4.setTitle(
            QCoreApplication.translate(
                "stable_diffusion_settings_widget", "Version", None
            )
        )
        self.seed_widget.setProperty("generator_section", "")
        self.seed_widget.setProperty("generator_name", "")
        self.seed_widget.setProperty(
            "property_name",
            QCoreApplication.translate(
                "stable_diffusion_settings_widget",
                "generator_settings.random_seed",
                None,
            ),
        )
        self.frames_slider_widget.setProperty(
            "label_text",
            QCoreApplication.translate(
                "stable_diffusion_settings_widget", "Frames", None
            ),
        )
        self.ddim_eta_slider_widget.setProperty(
            "label_text",
            QCoreApplication.translate(
                "stable_diffusion_settings_widget", "DDIM ETA", None
            ),
        )
        self.groupBox.setTitle(
            QCoreApplication.translate(
                "stable_diffusion_settings_widget", "Custom path", None
            )
        )
        self.browse_button.setText(
            QCoreApplication.translate(
                "stable_diffusion_settings_widget", "Browse", None
            )
        )
        self.groupBox_5.setTitle(
            QCoreApplication.translate(
                "stable_diffusion_settings_widget", "Scheduler", None
            )
        )
        self.label.setText(
            QCoreApplication.translate(
                "stable_diffusion_settings_widget", "Stable Diffusion", None
            )
        )
