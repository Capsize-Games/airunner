...
class Ui_export_preferences(object):
    def setupUi(self, export_preferences):
        ...
        self.verticalSpacer = QSpacerItem(
            17, 37, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding
        )
        ...
        self.actionAuto_export_images.toggled.connect(
            export_preferences.action_toggle_automatically_export_images
        )
        self.image_path.textEdited.connect(
            export_preferences.image_export_path_text_edited
        )
        self.image_path_browse_button.clicked.connect(
            export_preferences.action_clicked_button_browse
        )
        self.image_type_dropdown.currentTextChanged.connect(
            export_preferences.action_image_type_text_changed
        )
        self.export_metadata.toggled.connect(
            export_preferences.action_toggled_export_metadata
        )
        self.metadata_prompt.toggled.connect(export_preferences.action_toggled_prompt)
        self.metadata_negative_prompt.toggled.connect(
            export_preferences.action_toggled_negative_prompt
        )
        ...
        self.metadata_iterations.toggled.connect(
            export_preferences.action_toggled_iterations
        )
        ...
        self.metadata_model_branch.toggled.connect(
            export_preferences.action_toggled_model_branch
        )
        self.metadata_scheduler.toggled.connect(
            export_preferences.action_toggled_scheduler
        )
        self.metadata_ddim_eta.toggled.connect(export_preferences.action_toggled_ddim)
        self.metadata_strength.toggled.connect(
            export_preferences.action_toggled_strength
        )
        self.metadata_clip_skip.toggled.connect(
            export_preferences.action_toggled_clip_skip
        )
        ...
        self.metadata_embeddings.toggled.connect(
            export_preferences.action_toggled_embeddings
        )
        self.metadata_timestamp.toggled.connect(
            export_preferences.action_toggled_timestamp
        )
        self.metadata_controlnet.toggled.connect(
            export_preferences.action_toggled_controlnet
        )
    ...
    def retranslateUi(self, export_preferences):
        export_preferences.setWindowTitle(
            QCoreApplication.translate("export_preferences", "Form", None)
        )
        self.actionAuto_export_images.setText(
            QCoreApplication.translate(
                "export_preferences", "Automatically export images", None
            )
        )
        self.label.setText(
            QCoreApplication.translate(
                "export_preferences", "Image export folder", None
            )
        )
        self.label_2.setText(
            QCoreApplication.translate(
                "export_preferences", "Folder to auto export images to", None
            )
        )
        self.image_path_browse_button.setText(
            QCoreApplication.translate("export_preferences", "Browse", None)
        )
        self.label_5.setText(
            QCoreApplication.translate("export_preferences", "Image type", None)
        )
        self.metadata_iterations.setText(
            QCoreApplication.translate("export_preferences", "Iterations", None)
        )
        self.metadata_model_branch.setText(
            QCoreApplication.translate("export_preferences", "Model Branch", None)
        )
        self.metadata_seed.setText(
            QCoreApplication.translate("export_preferences", "Seed", None)
        )
        self.metadata_model.setText(
            QCoreApplication.translate("export_preferences", "Model", None)
        )
        self.label_3.setText(
            QCoreApplication.translate("export_preferences", "Metadata", None)
        )
        self.metadata_scheduler.setText(
            QCoreApplication.translate("export_preferences", "Scheduler", None)
        )
        # if QT_CONFIG(tooltip)
        self.export_metadata.setToolTip(
            QCoreApplication.translate(
                "export_preferences",
                "<html><head/><body><p>Export metadata along with images. </p><p>Only works with PNG files.</p></body></html>",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.export_metadata.setText(
            QCoreApplication.translate("export_preferences", "Export metadata", None)
        )
        self.metadata_samples.setText(
            QCoreApplication.translate("export_preferences", "Samples", None)
        )
        self.metadata_scale.setText(
            QCoreApplication.translate("export_preferences", "Scale", None)
        )
        self.metadata_negative_prompt.setText(
            QCoreApplication.translate("export_preferences", "Negative prompt", None)
        )
        self.metadata_ddim_eta.setText(
            QCoreApplication.translate("export_preferences", "DDIM ETA", None)
        )
        self.metadata_prompt.setText(
            QCoreApplication.translate("export_preferences", "Prompt", None)
        )
        self.metadata_steps.setText(
            QCoreApplication.translate("export_preferences", "Steps", None)
        )
        self.metadata_clip_skip.setText(
            QCoreApplication.translate("export_preferences", "Clip Skip", None)
        )
        self.metadata_version.setText(
            QCoreApplication.translate("export_preferences", "Version", None)
        )
        self.metadata_lora.setText(
            QCoreApplication.translate("export_preferences", "LoRA", None)
        )
        self.metadata_embeddings.setText(
            QCoreApplication.translate("export_preferences", "Embeddings", None)
        )
        self.metadata_timestamp.setText(
            QCoreApplication.translate("export_preferences", "Timestamp", None)
        )
        self.metadata_strength.setText(
            QCoreApplication.translate("export_preferences", "Strength", None)
        )
        self.metadata_controlnet.setText(
            QCoreApplication.translate("export_preferences", "Controlnet", None)
        )
        self.label_4.setText(
            QCoreApplication.translate(
                "export_preferences",
                "Choose which metadata to include with exported images",
                None,
            )
        )
