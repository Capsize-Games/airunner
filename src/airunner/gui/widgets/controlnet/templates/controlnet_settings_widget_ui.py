...
class Ui_controlnet_settings_widget(object):
    def setupUi(self, controlnet_settings_widget):
        if not controlnet_settings_widget.objectName():
            controlnet_settings_widget.setObjectName("controlnet_settings_widget")
        ...
        self.controlnet_conditioning_scale.setObjectName(
        ...
        self.controlnet_conditioning_scale.setProperty(
        ...
        self.controlnet_conditioning_scale.setProperty(
            "spinbox_single_step", 0.100000000000000
        )
        self.controlnet_conditioning_scale.setProperty(
            "spinbox_page_step", 0.200000000000000
        )
        self.controlnet_conditioning_scale.setProperty(
            "settings_property", "controlnet_settings.conditioning_scale"
        )
        ...
        self.strength_slider.setProperty(
            "settings_property", "controlnet_settings.strength"
        )
        ...
        self.section_header.setObjectName("section_header")
        ...
        sizePolicy.setHeightForWidth(
            self.section_header.sizePolicy().hasHeightForWidth()
        )
        ...
        self.controlnet.currentTextChanged.connect(
            controlnet_settings_widget.controlnet_changed
        )
    ...
    def retranslateUi(self, controlnet_settings_widget):
        controlnet_settings_widget.setWindowTitle(
            QCoreApplication.translate("controlnet_settings_widget", "Form", None)
        )
        self.controlnet_conditioning_scale.setProperty(
            "label_text",
            QCoreApplication.translate(
                "controlnet_settings_widget", "Conditioning Scale", None
            ),
        )
        self.strength_slider.setProperty(
            "label_text",
            QCoreApplication.translate("controlnet_settings_widget", "Strength", None),
        )
