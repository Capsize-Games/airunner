...
class Ui_image_generator_preferences(object):
    def setupUi(self, image_generator_preferences):
        ...
        self.category.currentTextChanged.connect(
            image_generator_preferences.category_changed
        )
        self.pipeline.currentTextChanged.connect(
            image_generator_preferences.pipeline_changed
        )
        self.action.currentTextChanged.connect(
            image_generator_preferences.action_changed
        )
    ...
    def retranslateUi(self, image_generator_preferences):
        image_generator_preferences.setWindowTitle(
            QCoreApplication.translate("image_generator_preferences", "Form", None)
        )
        self.groupBox.setTitle("")
        self.label_4.setText(
            QCoreApplication.translate("image_generator_preferences", "Action", None)
        )
        self.label.setText(
            QCoreApplication.translate("image_generator_preferences", "Category", None)
        )
        self.label_2.setText(
            QCoreApplication.translate("image_generator_preferences", "Pipeline", None)
        )
