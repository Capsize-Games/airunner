...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.verticalSpacer = QSpacerItem(
            17, 0, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding
        )
    ...
    def retranslateUi(self, Form):
        ...
        self.to_canvas_button.setText(
            QCoreApplication.translate("Form", "Send to canvas", None)
        )
        self.export_button.setText(QCoreApplication.translate("Form", "Export", None))
        self.delete_button.setText(QCoreApplication.translate("Form", "Delete", None))
        self.to_slot_button.setText(
            QCoreApplication.translate("Form", "Send to slot", None)
        )
