...
class Ui_generator_tab(object):
    ...
    def retranslateUi(self, generator_tab):
        ...
        self.tab_stablediffusion_txt2img.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"txt2img", None))
        self.tab_stablediffusion_txt2img.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"stablediffusion", None))
        self.generator_form_stablediffusion_txt2img.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"txt2img", None))
        self.generator_form_stablediffusion_txt2img.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"stablediffusion", None))
        ...
        self.tab_stablediffusion_outpaint.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"outpaint", None))
        self.tab_stablediffusion_outpaint.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"stablediffusion", None))
        self.generator_form_stablediffusion_outpaint.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"outpaint", None))
        self.generator_form_stablediffusion_outpaint.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"stablediffusion", None))
        ...
        self.tab_stablediffusion_depth2img.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"depth2img", None))
        self.tab_stablediffusion_depth2img.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"stablediffusion", None))
        self.generator_form_stablediffusion_depth2img.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"depth2img", None))
        self.generator_form_stablediffusion_depth2img.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"stablediffusion", None))
        ...
        self.tab_stablediffusion_pix2pix.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"pix2pix", None))
        self.tab_stablediffusion_pix2pix.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"stablediffusion", None))
        self.generator_form_stablediffusion_pix2pix.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"pix2pix", None))
        self.generator_form_stablediffusion_pix2pix.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"stablediffusion", None))
        ...
        self.tab_stablediffusion_upscale.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"upscale", None))
        self.tab_stablediffusion_upscale.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"stablediffusion", None))
        self.generator_form_stablediffusion_upscale.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"upscale", None))
        self.generator_form_stablediffusion_upscale.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"stablediffusion", None))
        ...
        self.tab_stablediffusion_superresolution.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"superresolution", None))
        self.tab_stablediffusion_superresolution.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"stablediffusion", None))
        self.generator_form_stablediffusion_superresolution.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"superresolution", None))
        self.generator_form_stablediffusion_superresolution.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"stablediffusion", None))
        ...
        self.tab_stablediffusion_txt2vid.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"txt2vid", None))
        self.tab_stablediffusion_txt2vid.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"stablediffusion", None))
        self.generator_form_txt2vid.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"txt2vid", None))
        self.generator_form_txt2vid.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"stablediffusion", None))
        ...
        self.tab_kandinsky_txt2img.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"txt2img", None))
        self.tab_kandinsky_txt2img.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"kandinsky", None))
        self.generator_form_kandinsky_txt2img.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"txt2img", None))
        self.generator_form_kandinsky_txt2img.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"kandinsky", None))
        ...
        self.tab_kandinsky_outpaint.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"outpaint", None))
        self.tab_kandinsky_outpaint.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"kandinsky", None))
        self.generator_form_kandinsky_outpaint.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"outpaint", None))
        self.generator_form_kandinsky_outpaint.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"kandinsky", None))
        ...
        self.tab_shape_txt2img.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"txt2img", None))
        self.tab_shape_txt2img.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"shape", None))
        self.generator_form_shape_txt2img.setProperty(u"generator_section", QCoreApplication.translate("generator_tab", u"txt2img", None))
        self.generator_form_shape_txt2img.setProperty(u"generator_name", QCoreApplication.translate("generator_tab", u"shape", None))
