...
class Ui_generator_tab(object):
    def setupUi(self, generator_tab):
        ...
        sizePolicy1.setHeightForWidth(
            self.generator_tabs.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy2.setHeightForWidth(
            self.tab_stablediffusion.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy2.setHeightForWidth(
            self.tab_stablediffusion_txt2img.sizePolicy().hasHeightForWidth()
        )
        ...
        self.generator_form_stablediffusion_txt2img = GeneratorForm(
            self.tab_stablediffusion_txt2img
        )
        self.generator_form_stablediffusion_txt2img.setObjectName(
            "generator_form_stablediffusion_txt2img"
        )

        self.gridLayout_7.addWidget(
            self.generator_form_stablediffusion_txt2img, 0, 0, 1, 1
        )
        ...
        sizePolicy2.setHeightForWidth(
            self.tab_stablediffusion_outpaint.sizePolicy().hasHeightForWidth()
        )
        ...
        self.generator_form_stablediffusion_outpaint = GeneratorForm(
            self.tab_stablediffusion_outpaint
        )
        self.generator_form_stablediffusion_outpaint.setObjectName(
            "generator_form_stablediffusion_outpaint"
        )

        self.gridLayout_10.addWidget(
            self.generator_form_stablediffusion_outpaint, 0, 0, 1, 1
        )

        self.tab_widget_stablediffusion.addTab(self.tab_stablediffusion_outpaint, "")
        self.tab_stablediffusion_depth2img = QWidget()
        self.tab_stablediffusion_depth2img.setObjectName(
            "tab_stablediffusion_depth2img"
        )
        sizePolicy2.setHeightForWidth(
            self.tab_stablediffusion_depth2img.sizePolicy().hasHeightForWidth()
        )
        ...
        self.generator_form_stablediffusion_depth2img = GeneratorForm(
            self.tab_stablediffusion_depth2img
        )
        self.generator_form_stablediffusion_depth2img.setObjectName(
            "generator_form_stablediffusion_depth2img"
        )

        self.gridLayout_11.addWidget(
            self.generator_form_stablediffusion_depth2img, 0, 0, 1, 1
        )
        ...
        sizePolicy2.setHeightForWidth(
            self.tab_stablediffusion_pix2pix.sizePolicy().hasHeightForWidth()
        )
        ...
        self.generator_form_stablediffusion_pix2pix = GeneratorForm(
            self.tab_stablediffusion_pix2pix
        )
        self.generator_form_stablediffusion_pix2pix.setObjectName(
            "generator_form_stablediffusion_pix2pix"
        )

        self.gridLayout_12.addWidget(
            self.generator_form_stablediffusion_pix2pix, 0, 0, 1, 1
        )
        ...
        sizePolicy2.setHeightForWidth(
            self.tab_stablediffusion_upscale.sizePolicy().hasHeightForWidth()
        )
        ...
        self.generator_form_stablediffusion_upscale = GeneratorForm(
            self.tab_stablediffusion_upscale
        )
        self.generator_form_stablediffusion_upscale.setObjectName(
            "generator_form_stablediffusion_upscale"
        )

        self.gridLayout_5.addWidget(
            self.generator_form_stablediffusion_upscale, 0, 0, 1, 1
        )

        self.tab_widget_stablediffusion.addTab(self.tab_stablediffusion_upscale, "")
        self.tab_stablediffusion_superresolution = QWidget()
        self.tab_stablediffusion_superresolution.setObjectName(
            "tab_stablediffusion_superresolution"
        )
        sizePolicy2.setHeightForWidth(
            self.tab_stablediffusion_superresolution.sizePolicy().hasHeightForWidth()
        )
        ...
        self.generator_form_stablediffusion_superresolution = GeneratorForm(
            self.tab_stablediffusion_superresolution
        )
        self.generator_form_stablediffusion_superresolution.setObjectName(
            "generator_form_stablediffusion_superresolution"
        )

        self.gridLayout_6.addWidget(
            self.generator_form_stablediffusion_superresolution, 0, 0, 1, 1
        )

        self.tab_widget_stablediffusion.addTab(
            self.tab_stablediffusion_superresolution, ""
        )
        self.tab_stablediffusion_txt2vid = QWidget()
        self.tab_stablediffusion_txt2vid.setObjectName("tab_stablediffusion_txt2vid")
        sizePolicy2.setHeightForWidth(
            self.tab_stablediffusion_txt2vid.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy2.setHeightForWidth(
            self.tab_kandinsky.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy2.setHeightForWidth(
            self.tab_kandinsky_txt2img.sizePolicy().hasHeightForWidth()
        )
        ...
        self.generator_form_kandinsky_txt2img = GeneratorForm(
            self.tab_kandinsky_txt2img
        )
        self.generator_form_kandinsky_txt2img.setObjectName(
            "generator_form_kandinsky_txt2img"
        )
        ...
        sizePolicy2.setHeightForWidth(
            self.tab_kandinsky_outpaint.sizePolicy().hasHeightForWidth()
        )
        ...
        self.generator_form_kandinsky_outpaint = GeneratorForm(
            self.tab_kandinsky_outpaint
        )
        self.generator_form_kandinsky_outpaint.setObjectName(
            "generator_form_kandinsky_outpaint"
        )
        ...
        sizePolicy2.setHeightForWidth(
            self.tab_shape_txt2img.sizePolicy().hasHeightForWidth()
        )
        ...
        self.generator_tabs.currentChanged.connect(
            generator_tab.handle_generator_tab_changed
        )
        self.tab_widget_stablediffusion.currentChanged.connect(
            generator_tab.handle_tab_section_changed
        )
    ...
    def retranslateUi(self, generator_tab):
        generator_tab.setWindowTitle(
            QCoreApplication.translate("generator_tab", "Form", None)
        )
        self.tab_stablediffusion_txt2img.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "txt2img", None),
        )
        self.tab_stablediffusion_txt2img.setProperty(
            "generator_name",
            QCoreApplication.translate("generator_tab", "stablediffusion", None),
        )
        self.generator_form_stablediffusion_txt2img.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "txt2img", None),
        )
        self.generator_form_stablediffusion_txt2img.setProperty(
        ...
        self.tab_widget_stablediffusion.setTabText(
            self.tab_widget_stablediffusion.indexOf(self.tab_stablediffusion_txt2img),
            QCoreApplication.translate("generator_tab", "txt2img / img2img", None),
        )
        self.tab_stablediffusion_outpaint.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "outpaint", None),
        )
        self.tab_stablediffusion_outpaint.setProperty(
            "generator_name",
            QCoreApplication.translate("generator_tab", "stablediffusion", None),
        )
        self.generator_form_stablediffusion_outpaint.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "outpaint", None),
        )
        self.generator_form_stablediffusion_outpaint.setProperty(
        ...
        self.tab_widget_stablediffusion.setTabText(
            self.tab_widget_stablediffusion.indexOf(self.tab_stablediffusion_outpaint),
            QCoreApplication.translate("generator_tab", "inpaint / outapint", None),
        )
        self.tab_stablediffusion_depth2img.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "depth2img", None),
        )
        self.tab_stablediffusion_depth2img.setProperty(
            "generator_name",
            QCoreApplication.translate("generator_tab", "stablediffusion", None),
        )
        self.generator_form_stablediffusion_depth2img.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "depth2img", None),
        )
        self.generator_form_stablediffusion_depth2img.setProperty(
        ...
        self.tab_widget_stablediffusion.setTabText(
            self.tab_widget_stablediffusion.indexOf(self.tab_stablediffusion_depth2img),
            QCoreApplication.translate("generator_tab", "depth2img", None),
        )
        self.tab_stablediffusion_pix2pix.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "pix2pix", None),
        )
        self.tab_stablediffusion_pix2pix.setProperty(
            "generator_name",
            QCoreApplication.translate("generator_tab", "stablediffusion", None),
        )
        self.generator_form_stablediffusion_pix2pix.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "pix2pix", None),
        )
        self.generator_form_stablediffusion_pix2pix.setProperty(
        ...
        self.tab_widget_stablediffusion.setTabText(
            self.tab_widget_stablediffusion.indexOf(self.tab_stablediffusion_pix2pix),
            QCoreApplication.translate("generator_tab", "pix2pix", None),
        )
        self.tab_stablediffusion_upscale.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "upscale", None),
        )
        self.tab_stablediffusion_upscale.setProperty(
            "generator_name",
            QCoreApplication.translate("generator_tab", "stablediffusion", None),
        )
        self.generator_form_stablediffusion_upscale.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "upscale", None),
        )
        self.generator_form_stablediffusion_upscale.setProperty(
        ...
        self.tab_widget_stablediffusion.setTabText(
            self.tab_widget_stablediffusion.indexOf(self.tab_stablediffusion_upscale),
            QCoreApplication.translate("generator_tab", "upscale", None),
        )
        self.tab_stablediffusion_superresolution.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "superresolution", None),
        )
        self.tab_stablediffusion_superresolution.setProperty(
            "generator_name",
            QCoreApplication.translate("generator_tab", "stablediffusion", None),
        )
        self.generator_form_stablediffusion_superresolution.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "superresolution", None),
        )
        self.generator_form_stablediffusion_superresolution.setProperty(
        ...
        self.tab_widget_stablediffusion.setTabText(
            self.tab_widget_stablediffusion.indexOf(
                self.tab_stablediffusion_superresolution
            ),
            QCoreApplication.translate("generator_tab", "superresolution", None),
        )
        self.tab_stablediffusion_txt2vid.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "txt2vid", None),
        )
        self.tab_stablediffusion_txt2vid.setProperty(
            "generator_name",
            QCoreApplication.translate("generator_tab", "stablediffusion", None),
        )
        self.generator_form_txt2vid.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "txt2vid", None),
        )
        self.generator_form_txt2vid.setProperty(
        ...
        self.tab_widget_stablediffusion.setTabText(
            self.tab_widget_stablediffusion.indexOf(self.tab_stablediffusion_txt2vid),
            QCoreApplication.translate("generator_tab", "txt2vid", None),
        )
        self.generator_tabs.setTabText(
            self.generator_tabs.indexOf(self.tab_stablediffusion),
            QCoreApplication.translate("generator_tab", "Stable Diffusion", None),
        )
        self.tab_kandinsky_txt2img.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "txt2img", None),
        )
        self.tab_kandinsky_txt2img.setProperty(
            "generator_name",
            QCoreApplication.translate("generator_tab", "kandinsky", None),
        )
        self.generator_form_kandinsky_txt2img.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "txt2img", None),
        )
        self.generator_form_kandinsky_txt2img.setProperty(
        ...
        self.tab_widget_kandinsky.setTabText(
            self.tab_widget_kandinsky.indexOf(self.tab_kandinsky_txt2img),
            QCoreApplication.translate("generator_tab", "txt2img / img2img", None),
        )
        self.tab_kandinsky_outpaint.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "outpaint", None),
        )
        self.tab_kandinsky_outpaint.setProperty(
        ...
        self.generator_form_kandinsky_outpaint.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "outpaint", None),
        )
        self.generator_form_kandinsky_outpaint.setProperty(
        ...
        self.tab_widget_kandinsky.setTabText(
            self.tab_widget_kandinsky.indexOf(self.tab_kandinsky_outpaint),
            QCoreApplication.translate("generator_tab", "inpaint / outapint", None),
        )
        self.generator_tabs.setTabText(
            self.generator_tabs.indexOf(self.tab_kandinsky),
            QCoreApplication.translate("generator_tab", "Kandinsky", None),
        )
        self.tab_shape_txt2img.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "txt2img", None),
        )
        self.tab_shape_txt2img.setProperty(
            "generator_name", QCoreApplication.translate("generator_tab", "shape", None)
        )
        self.generator_form_shape_txt2img.setProperty(
            "generator_section",
            QCoreApplication.translate("generator_tab", "txt2img", None),
        )
        self.generator_form_shape_txt2img.setProperty(
        ...
        self.tab_widget_shape.setTabText(
            self.tab_widget_shape.indexOf(self.tab_shape_txt2img),
            QCoreApplication.translate("generator_tab", "txt2img / img2img", None),
        )
        self.generator_tabs.setTabText(
            self.generator_tabs.indexOf(self.tab_shape),
            QCoreApplication.translate("generator_tab", "Shap-e", None),
        )
