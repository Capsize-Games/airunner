...
class Ui_flan_generator_form(object):
    ...
    def retranslateUi(self, flan_generator_form):
        flan_generator_form.setWindowTitle(
            QCoreApplication.translate("flan_generator_form", "Form", None)
        )
        self.groupBox.setTitle(
            QCoreApplication.translate("flan_generator_form", "Top P", None)
        )
        self.top_p.setProperty(
            "property", QCoreApplication.translate("flan_generator_form", "top_p", None)
        )
        self.groupBox_2.setTitle(
            QCoreApplication.translate("flan_generator_form", "Max length", None)
        )
        self.max_length.setProperty(
            "property",
            QCoreApplication.translate("flan_generator_form", "max_length", None),
        )
        self.random_seed.setText(
            QCoreApplication.translate("flan_generator_form", "Random seed", None)
        )
        self.groupBox_11.setTitle(
            QCoreApplication.translate("flan_generator_form", "Seed", None)
        )
        self.groupBox_5.setTitle(
            QCoreApplication.translate("flan_generator_form", "Length penalty", None)
        )
        self.length_penalty.setProperty(
            "property",
            QCoreApplication.translate("flan_generator_form", "length_penalty", None),
        )
        self.groupBox_6.setTitle(
            QCoreApplication.translate("flan_generator_form", "Num beams", None)
        )
        self.num_beams.setProperty(
            "property",
            QCoreApplication.translate("flan_generator_form", "num_beams", None),
        )
        self.do_sample.setText(
            QCoreApplication.translate("flan_generator_form", "Do sample", None)
        )
        self.early_stopping.setText(
            QCoreApplication.translate("flan_generator_form", "Early stopping", None)
        )
        self.groupBox_3.setTitle(
            QCoreApplication.translate(
                "flan_generator_form", "Repetition penalty", None
            )
        )
        self.repetition_penalty.setProperty(
            "property",
            QCoreApplication.translate(
                "flan_generator_form", "repetition_penalty", None
            ),
        )
        self.groupBox_4.setTitle(
            QCoreApplication.translate("flan_generator_form", "Min length", None)
        )
        self.min_length.setProperty(
            "property",
            QCoreApplication.translate("flan_generator_form", "min_length", None),
        )
        self.groupBox_7.setTitle(
            QCoreApplication.translate(
                "flan_generator_form", "No repeat ngram size", None
            )
        )
        self.ngram_size.setProperty(
            "property", QCoreApplication.translate("flan_generator_form", "ngram", None)
        )
        self.groupBox_8.setTitle(
            QCoreApplication.translate("flan_generator_form", "Temperature", None)
        )
        ...
        self.groupBox_9.setTitle(
            QCoreApplication.translate(
                "flan_generator_form", "Sequences to generate", None
            )
        )
        self.sequences.setProperty(
            "property",
            QCoreApplication.translate("flan_generator_form", "sequences", None),
        )
        self.groupBox_10.setTitle(
            QCoreApplication.translate("flan_generator_form", "Top k", None)
        )
        self.top_k.setProperty(
            "property", QCoreApplication.translate("flan_generator_form", "top_k", None)
        )
        self.groupBox_12.setTitle(
            QCoreApplication.translate("flan_generator_form", "ETA Cutoff", None)
        )
        self.eta_cutoff.setProperty(
            "property",
            QCoreApplication.translate("flan_generator_form", "eta_cutoff", None),
        )
