...
class Ui_prompt_templates_widget(object):
    def setupUi(self, prompt_templates_widget):
        if not prompt_templates_widget.objectName():
            prompt_templates_widget.setObjectName("prompt_templates_widget")
        ...
        self.use_guardrails.setObjectName("use_guardrails")
        ...
        self.system_prompt.textChanged.connect(
            prompt_templates_widget.system_prompt_changed
        )
        self.guardrails_prompt.textChanged.connect(
            prompt_templates_widget.guardrails_prompt_changed
        )
        self.use_guardrails.toggled.connect(
            prompt_templates_widget.toggle_use_guardrails
        )
        ...
        self.template_name.currentIndexChanged.connect(
            prompt_templates_widget.template_changed
        )
    ...
    def retranslateUi(self, prompt_templates_widget):
        prompt_templates_widget.setWindowTitle(
            QCoreApplication.translate("prompt_templates_widget", "Form", None)
        )
        self.groupBox_2.setTitle(
            QCoreApplication.translate("prompt_templates_widget", "System Prompt", None)
        )
        self.pushButton_2.setText(
            QCoreApplication.translate(
                "prompt_templates_widget", "Reset to Default", None
            )
        )
        self.groupBox.setTitle(
            QCoreApplication.translate("prompt_templates_widget", "Template", None)
        )
        self.groupBox_3.setTitle(
            QCoreApplication.translate(
                "prompt_templates_widget", "Guardrails Prompt", None
            )
        )
        ...
        self.use_guardrails.setText(
            QCoreApplication.translate(
                "prompt_templates_widget", "Use guardrails", None
            )
        )
        self.use_datetime.setText(
            QCoreApplication.translate("prompt_templates_widget", "Use datetime", None)
        )
