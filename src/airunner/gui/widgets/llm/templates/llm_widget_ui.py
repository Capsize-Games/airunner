...
class Ui_llm_widget(object):
    def setupUi(self, llm_widget):
        ...
        icon1 = QIcon()
        iconThemeName = "preferences-desktop"
        if QIcon.hasThemeIcon(iconThemeName):
            icon1 = QIcon.fromTheme(iconThemeName)
        else:
            icon1.addFile("../../../", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon2 = QIcon()
        iconThemeName = "preferences-other"
        if QIcon.hasThemeIcon(iconThemeName):
            icon2 = QIcon.fromTheme(iconThemeName)
        else:
            icon2.addFile("../../../", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
    ...
    def retranslateUi(self, llm_widget):
        llm_widget.setWindowTitle(
            QCoreApplication.translate("llm_widget", "Form", None)
        )
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.chat),
            QCoreApplication.translate("llm_widget", "Chat", None),
        )
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.preferences),
            QCoreApplication.translate("llm_widget", "Preferences", None),
        )
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.settings),
            QCoreApplication.translate("llm_widget", "Settings", None),
        )
