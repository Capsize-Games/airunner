...
class Ui_llm_history_widget(object):
    def setupUi(self, llm_history_widget):
        if not llm_history_widget.objectName():
            llm_history_widget.setObjectName("llm_history_widget")
        ...
        self.conversations_scroll_area.setObjectName("conversations_scroll_area")
    ...
    def retranslateUi(self, llm_history_widget):
        llm_history_widget.setWindowTitle(
            QCoreApplication.translate("llm_history_widget", "Form", None)
        )
