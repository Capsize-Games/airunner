...
class Ui_llm_settings_widget(object):
    def setupUi(self, llm_settings_widget):
        ...
        self.prompt_template_container.setObjectName("prompt_template_container")
        ...
        sizePolicy.setHeightForWidth(
            self.length_penalty.sizePolicy().hasHeightForWidth()
        )
        ...
        self.max_new_tokens.setObjectName("max_new_tokens")
        sizePolicy.setHeightForWidth(
            self.max_new_tokens.sizePolicy().hasHeightForWidth()
        )
        ...
        sizePolicy.setHeightForWidth(
            self.repetition_penalty.sizePolicy().hasHeightForWidth()
        )
        ...
        self.model_service.setObjectName("model_service")
        ...
        self.remote_model_path.setObjectName("remote_model_path")
        ...
        self.override_parameters.toggled.connect(
            llm_settings_widget.override_parameters_toggled
        )
        self.early_stopping.toggled.connect(llm_settings_widget.early_stopping_toggled)
        self.pushButton.clicked.connect(
            llm_settings_widget.reset_settings_to_default_clicked
        )
        ...
        self.model_service.currentTextChanged.connect(
            llm_settings_widget.on_model_service_currentTextChanged
        )
        self.model_path.textChanged.connect(
            llm_settings_widget.on_model_path_textChanged
        )
    ...
    def retranslateUi(self, llm_settings_widget):
        llm_settings_widget.setWindowTitle(
            QCoreApplication.translate("llm_settings_widget", "Form", None)
        )
        self.override_parameters.setTitle(
            QCoreApplication.translate(
                "llm_settings_widget", "Override Prameters", None
            )
        )
        self.random_seed.setText(
            QCoreApplication.translate("llm_settings_widget", "Random seed", None)
        )
        self.length_penalty.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "llm_settings_widget", "llm_generator_settings.length_penalty", None
            ),
        )
        self.length_penalty.setProperty(
            "label_text",
            QCoreApplication.translate("llm_settings_widget", "Length Penalty", None),
        )
        self.num_beams.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "llm_settings_widget", "llm_generator_settings.num_beams", None
            ),
        )
        self.num_beams.setProperty(
            "label_text",
            QCoreApplication.translate("llm_settings_widget", "Num Beams", None),
        )
        self.top_p.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "llm_settings_widget", "llm_generator_settings.top_p", None
            ),
        )
        self.top_p.setProperty(
            "label_text",
            QCoreApplication.translate("llm_settings_widget", "Top P", None),
        )
        self.max_new_tokens.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "llm_settings_widget", "llm_generator_settings.max_new_tokens", None
            ),
        )
        self.max_new_tokens.setProperty(
            "label_text",
            QCoreApplication.translate("llm_settings_widget", "Max New Tokens", None),
        )
        self.sequences.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "llm_settings_widget", "llm_generator_settings.sequences", None
            ),
        )
        self.sequences.setProperty(
            "label_text",
            QCoreApplication.translate("llm_settings_widget", "Sequences", None),
        )
        self.top_k.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "llm_settings_widget", "llm_generator_settings.top_k", None
            ),
        )
        self.top_k.setProperty(
            "label_text",
            QCoreApplication.translate("llm_settings_widget", "Top K", None),
        )
        self.ngram_size.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "llm_settings_widget", "llm_generator_settings.ngram_size", None
            ),
        )
        self.ngram_size.setProperty(
            "label_text",
            QCoreApplication.translate("llm_settings_widget", "Ngram Size", None),
        )
        self.temperature.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "llm_settings_widget", "llm_generator_settings.temperature", None
            ),
        )
        self.temperature.setProperty(
            "label_text",
            QCoreApplication.translate("llm_settings_widget", "Temperature", None),
        )
        self.early_stopping.setText(
            QCoreApplication.translate("llm_settings_widget", "Early stopping", None)
        )
        self.use_cache.setText(
            QCoreApplication.translate("llm_settings_widget", "Use Cache", None)
        )
        self.do_sample.setText(
            QCoreApplication.translate("llm_settings_widget", "Do sample", None)
        )
        self.pushButton.setText(
            QCoreApplication.translate(
                "llm_settings_widget", "Reset Settings to Default", None
            )
        )
        self.repetition_penalty.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "llm_settings_widget", "llm_generator_settings.repetition_penalty", None
            ),
        )
        self.repetition_penalty.setProperty(
            "label_text",
            QCoreApplication.translate(
                "llm_settings_widget", "Repetition Penalty", None
            ),
        )
        self.min_length.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "llm_settings_widget", "llm_generator_settings.min_length", None
            ),
        )
        self.min_length.setProperty(
            "label_text",
            QCoreApplication.translate("llm_settings_widget", "Min Length", None),
        )
        self.label_2.setText(
            QCoreApplication.translate("llm_settings_widget", "LLM Settings", None)
        )
        self.groupBox.setTitle(
            QCoreApplication.translate("llm_settings_widget", "Model service", None)
        )
        self.remote_model_path.setTitle(
            QCoreApplication.translate("llm_settings_widget", "Custom path", None)
        )
