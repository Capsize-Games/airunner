...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.guardrails.setObjectName("guardrails")
        ...
        self.template_names.setObjectName("template_names")
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox.setTitle(QCoreApplication.translate("Form", "User name", None))
        self.groupBox_5.setTitle(
            QCoreApplication.translate("Form", "Template name", None)
        )
        self.groupBox_4.setTitle(QCoreApplication.translate("Form", "Bot name", None))
        # if QT_CONFIG(tooltip)
        self.groupBox_3.setToolTip(
            QCoreApplication.translate("Form", "Toggle guardrails", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.groupBox_3.setTitle(QCoreApplication.translate("Form", "Guardrails", None))
        self.add_template_button.setText("")
        self.groupBox_2.setTitle(
            QCoreApplication.translate("Form", "Instructions", None)
        )
