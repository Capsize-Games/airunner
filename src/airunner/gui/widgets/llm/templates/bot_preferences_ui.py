...
class Ui_bot_preferences(object):
    def setupUi(self, bot_preferences):
        ...
        sizePolicy.setHeightForWidth(
            self.system_instructions.sizePolicy().hasHeightForWidth()
        )
        ...
        icon = QIcon(QIcon.fromTheme("list-add"))
        ...
        self.saved_chatbots.setObjectName("saved_chatbots")
        ...
        icon1 = QIcon(QIcon.fromTheme("process-stop"))
        ...
        sizePolicy.setHeightForWidth(
            self.bot_personality.sizePolicy().hasHeightForWidth()
        )
        ...
        self.browse_documents_button.setObjectName("browse_documents_button")

        self.gridLayout_9.addWidget(self.browse_documents_button, 1, 0, 1, 1)

        self.target_files = QScrollArea(self.groupBox_3)
        self.target_files.setObjectName("target_files")
        ...
        sizePolicy.setHeightForWidth(
            self.guardrails_prompt.sizePolicy().hasHeightForWidth()
        )
        ...
        self.voice_groupbox.setObjectName("voice_groupbox")
        self.gridLayout_voice = QGridLayout(self.voice_groupbox)
        self.gridLayout_voice.setObjectName("gridLayout_voice")
        ...
        self.bot_personality.textChanged.connect(
            bot_preferences.bot_personality_changed
        )
        self.names_groupbox.toggled.connect(bot_preferences.toggle_use_names)
        self.personality_groupbox.toggled.connect(
            bot_preferences.toggle_use_personality
        )
        self.guardrails_prompt.textChanged.connect(
            bot_preferences.guardrails_prompt_changed
        )
        self.system_instructions.textChanged.connect(
            bot_preferences.system_instructions_changed
        )
        self.guardrails_groupbox.toggled.connect(bot_preferences.toggle_use_guardrails)
        self.system_instructions_groupbox.toggled.connect(
            bot_preferences.toggle_use_system_instructions
        )
        self.saved_chatbots.currentTextChanged.connect(
            bot_preferences.saved_chatbots_changed
        )
        self.create_new_button.clicked.connect(
            bot_preferences.create_new_chatbot_clicked
        )
        ...
        self.use_weather_prompt.toggled.connect(
            bot_preferences.use_weather_prompt_toggled
        )
    ...
    def retranslateUi(self, bot_preferences):
        bot_preferences.setWindowTitle(
            QCoreApplication.translate("bot_preferences", "Form", None)
        )
        self.system_instructions_groupbox.setTitle(
            QCoreApplication.translate("bot_preferences", "System Instructions", None)
        )
        self.system_instructions.setPlaceholderText(
            QCoreApplication.translate(
                "bot_preferences", "Instructions for the LLM", None
            )
        )
        self.names_groupbox.setTitle(
            QCoreApplication.translate("bot_preferences", "Use names", None)
        )
        self.label.setText(
            QCoreApplication.translate("bot_preferences", "Assistant name", None)
        )
        self.botname.setText(
            QCoreApplication.translate("bot_preferences", "AI Runner", None)
        )
        self.botname.setPlaceholderText(
            QCoreApplication.translate("bot_preferences", "Bot name", None)
        )
        self.groupBox_2.setTitle(
            QCoreApplication.translate("bot_preferences", "Agent Type", None)
        )
        self.comboBox.setItemText(
            0, QCoreApplication.translate("bot_preferences", "Chatbot", None)
        )
        self.comboBox.setItemText(
            1, QCoreApplication.translate("bot_preferences", "Tool", None)
        )

        self.groupBox.setTitle(
            QCoreApplication.translate("bot_preferences", "Existing Agents", None)
        )
        # if QT_CONFIG(tooltip)
        self.create_new_button.setToolTip(
            QCoreApplication.translate("bot_preferences", "Add new agent", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.create_new_button.setText("")
        # if QT_CONFIG(tooltip)
        self.delete_button.setToolTip(
            QCoreApplication.translate("bot_preferences", "Delete agent", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.delete_button.setText("")
        self.personality_groupbox.setTitle(
            QCoreApplication.translate("bot_preferences", "Bot Personality", None)
        )
        self.bot_personality.setPlaceholderText(
            QCoreApplication.translate(
                "bot_preferences",
        ...
        self.label_2.setText(
            QCoreApplication.translate(
                "bot_preferences", "A brief description of the bot's personality", None
            )
        )
        self.groupBox_3.setTitle(
            QCoreApplication.translate("bot_preferences", "Documents", None)
        )
        self.browse_documents_button.setText(
            QCoreApplication.translate("bot_preferences", "Browse", None)
        )
        self.use_weather_prompt.setText(
            QCoreApplication.translate("bot_preferences", "Use Weather Prompt", None)
        )
        self.use_datetime.setText(
            QCoreApplication.translate("bot_preferences", "Use Datetime", None)
        )
        self.label_3.setText(
            QCoreApplication.translate(
                "bot_preferences",
                "Check this and set zipcode in User Settings to give agents access to local weather.",
                None,
            )
        )
        self.guardrails_groupbox.setTitle(
            QCoreApplication.translate("bot_preferences", "Guardrails", None)
        )
        self.guardrails_prompt.setPlaceholderText(
            QCoreApplication.translate(
                "bot_preferences",
                "The guardrails prompt is used to moderate results.",
                None,
            )
        )
        self.groupBox_4.setTitle(
            QCoreApplication.translate("bot_preferences", "Gender", None)
        )
        self.gender.setItemText(
            0, QCoreApplication.translate("bot_preferences", "Male", None)
        )
        self.gender.setItemText(
            1, QCoreApplication.translate("bot_preferences", "Female", None)
        )

        self.voice_groupbox.setTitle(
            QCoreApplication.translate("bot_preferences", "Voice", None)
        )
