...
class Ui_rag_settings(object):
    def setupUi(self, rag_settings):
        if not rag_settings.objectName():
            rag_settings.setObjectName("rag_settings")
        ...
        self.model_path_container.setObjectName("model_path_container")
        ...
        self.service.currentTextChanged.connect(
            rag_settings.on_service_currentTextChanged
        )
    ...
    def retranslateUi(self, rag_settings):
        rag_settings.setWindowTitle(
            QCoreApplication.translate("rag_settings", "Form", None)
        )
        self.enabled.setText(
            QCoreApplication.translate("rag_settings", "Enable RAG", None)
        )
        self.model_path_container.setTitle(
            QCoreApplication.translate("rag_settings", "Model Path", None)
        )
        self.groupBox_2.setTitle(
            QCoreApplication.translate("rag_settings", "Service", None)
        )
