...
class Ui_seed_widget(object):
    def setupUi(self, seed_widget):
        ...
        self.random_button.toggled.connect(
            seed_widget.action_clicked_button_random_seed
        )
    ...
    def retranslateUi(self, seed_widget):
        seed_widget.setWindowTitle(
            QCoreApplication.translate("seed_widget", "Form", None)
        )
        self.lineEdit.setPlaceholderText(
            QCoreApplication.translate("seed_widget", "seed", None)
        )
        # if QT_CONFIG(tooltip)
        self.random_button.setToolTip(
            QCoreApplication.translate("seed_widget", "Toggle random seed", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.random_button.setText("")
        self.label.setText(QCoreApplication.translate("seed_widget", "Seed", None))
