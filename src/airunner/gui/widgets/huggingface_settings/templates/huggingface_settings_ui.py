...
class Ui_huggingface_settings_widget(object):
    def setupUi(self, huggingface_settings_widget):
        if not huggingface_settings_widget.objectName():
            huggingface_settings_widget.setObjectName("huggingface_settings_widget")
        ...
        self.api_key.textEdited.connect(
            huggingface_settings_widget.on_api_key_textChanged
        )
    ...
    def retranslateUi(self, huggingface_settings_widget):
        huggingface_settings_widget.setWindowTitle(
            QCoreApplication.translate("huggingface_settings_widget", "Form", None)
        )
        self.allow.setText(
            QCoreApplication.translate(
                "huggingface_settings_widget", "Allow Huggingface connection", None
            )
        )
        self.groupBox.setTitle(
            QCoreApplication.translate(
                "huggingface_settings_widget", "Huggingface Read API key", None
            )
        )
