...
class Ui_variables_panel(object):
    def setupUi(self, variables_panel):
        if not variables_panel.objectName():
            variables_panel.setObjectName("variables_panel")
        ...
        self.variables_list_widget.setObjectName("variables_list_widget")
        ...
        self.add_variable_button.setObjectName("add_variable_button")
        ...
        self.add_variable_button.clicked.connect(
            variables_panel.on_add_variable_button_clicked
        )
    ...
    def retranslateUi(self, variables_panel):
        variables_panel.setWindowTitle(
            QCoreApplication.translate("variables_panel", "Form", None)
        )
        self.add_variable_button.setText(
            QCoreApplication.translate("variables_panel", "Add Variable", None)
        )
