...
class Ui_node_graph_widget(object):
    def setupUi(self, node_graph_widget):
        ...
        icon = QIcon()
        icon.addFile(u":/dark/icons/feather/dark/folder.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/dark/icons/feather/dark/pause-circle.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/dark/icons/feather/dark/trash-2.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.gridLayout_3.addWidget(self.edit_button, 0, 7, 1, 1)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/dark/icons/feather/dark/stop-circle.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/dark/icons/feather/dark/file-plus.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.new_button.setIcon(icon8)
        ...
        self.new_button.clicked.connect(node_graph_widget.on_new_button_clicked)
