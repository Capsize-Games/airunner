...
class Ui_scheduler_node(object):
    def setupUi(self, scheduler_node):
        if not scheduler_node.objectName():
            scheduler_node.setObjectName("scheduler_node")
        ...
        self.scheduler_combobox.setObjectName("scheduler_combobox")
    ...
    def retranslateUi(self, scheduler_node):
        scheduler_node.setWindowTitle(
            QCoreApplication.translate("scheduler_node", "Form", None)
        )
        self.groupBox.setTitle(
            QCoreApplication.translate("scheduler_node", "Scheduler", None)
        )
