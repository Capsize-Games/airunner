...
class Ui_voice_settings(object):
    def setupUi(self, voice_settings):
        if not voice_settings.objectName():
            voice_settings.setObjectName("voice_settings")
        ...
        self.voice_scroll_area.setObjectName("voice_scroll_area")
        self.voice_scroll_area.setWidgetResizable(True)
        self.voice_scroll_area_contents = QWidget()
        self.voice_scroll_area_contents.setObjectName("voice_scroll_area_contents")
        ...
        self.voice_list_layout.setObjectName("voice_list_layout")
        ...
        self.create_voice_button.setObjectName("create_voice_button")
    ...
    def retranslateUi(self, voice_settings):
        voice_settings.setWindowTitle(
            QCoreApplication.translate("voice_settings", "Voice Settings", None)
        )
        self.create_voice_button.setText(
            QCoreApplication.translate("voice_settings", "Create Voice", None)
        )
