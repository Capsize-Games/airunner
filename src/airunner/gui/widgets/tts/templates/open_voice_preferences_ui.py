...
class Ui_open_voice_preferences(object):
    def setupUi(self, open_voice_preferences):
        if not open_voice_preferences.objectName():
            open_voice_preferences.setObjectName("open_voice_preferences")
        ...
        self.voice_sample_path.setObjectName("voice_sample_path")

        self.horizontalLayout_2.addWidget(self.voice_sample_path)

        self.browse_voice_sample_path_button = QPushButton(self.groupBox_2)
        self.browse_voice_sample_path_button.setObjectName(
            "browse_voice_sample_path_button"
        )
        ...
        self.language_combobox.currentTextChanged.connect(
            open_voice_preferences.language_changed
        )
    ...
    def retranslateUi(self, open_voice_preferences):
        self.groupBox_2.setTitle(
            QCoreApplication.translate(
                "open_voice_preferences", "MP3 Voice Sample", None
            )
        )
        self.voice_sample_path.setText("")
        self.voice_sample_path.setPlaceholderText(
            QCoreApplication.translate(
                "open_voice_preferences", "MP3 voice sample", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.browse_voice_sample_path_button.setToolTip(
            QCoreApplication.translate(
                "open_voice_preferences",
                "Browse for an MP3 voice sample to use with OpenVoice",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.browse_voice_sample_path_button.setText(
            QCoreApplication.translate("open_voice_preferences", "Browse", None)
        )
        self.groupBox.setTitle(
            QCoreApplication.translate("open_voice_preferences", "Language", None)
        )
        self.language_combobox.setCurrentText("")
        self.speed_slider.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "open_voice_preferences", "openvoice_settings.speed", None
            ),
        )
        self.speed_slider.setProperty(
            "label_text",
            QCoreApplication.translate("open_voice_preferences", "Speed", None),
        )
        pass
