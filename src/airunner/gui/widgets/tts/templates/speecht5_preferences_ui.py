...
class Ui_speecht5_preferences(object):
    def setupUi(self, speecht5_preferences):
        ...
        self.preferences_groupbox.setObjectName("preferences_groupbox")
    ...
    def retranslateUi(self, speecht5_preferences):
        speecht5_preferences.setWindowTitle(
            QCoreApplication.translate("speecht5_preferences", "Form", None)
        )
        self.preferences_groupbox.setTitle(
            QCoreApplication.translate("speecht5_preferences", "SpeechT5", None)
        )
        self.label_3.setText(
            QCoreApplication.translate(
                "speecht5_preferences", "More realistic. Slower. Uses VRAM", None
            )
        )
        self.pitch.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "speecht5_preferences", "speech_t5_settings.pitch", None
            ),
        )
        self.pitch.setProperty(
            "label_text",
            QCoreApplication.translate("speecht5_preferences", "Pitch", None),
        )
        self.groupBox.setTitle(
            QCoreApplication.translate("speecht5_preferences", "Voice Style", None)
        )
        self.voice.setItemText(
            0, QCoreApplication.translate("speecht5_preferences", "US Male", None)
        )
        self.voice.setItemText(
            1, QCoreApplication.translate("speecht5_preferences", "US Male 2", None)
        )
        self.voice.setItemText(
            2, QCoreApplication.translate("speecht5_preferences", "US Female", None)
        )
        self.voice.setItemText(
            3, QCoreApplication.translate("speecht5_preferences", "US Female 2", None)
        )
        self.voice.setItemText(
            4, QCoreApplication.translate("speecht5_preferences", "Canadian Male", None)
        )
        self.voice.setItemText(
            5, QCoreApplication.translate("speecht5_preferences", "Scottish Male", None)
        )
        self.voice.setItemText(
            6, QCoreApplication.translate("speecht5_preferences", "Indian Male", None)
        )
