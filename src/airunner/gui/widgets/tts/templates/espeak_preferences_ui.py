...
class Ui_espeak_preferences(object):
    def setupUi(self, espeak_preferences):
        ...
        self.espeak.setObjectName("espeak")
        ...
        self.gender_combobox.currentTextChanged.connect(
            espeak_preferences.gender_changed
        )
    ...
    def retranslateUi(self, espeak_preferences):
        espeak_preferences.setWindowTitle(
            QCoreApplication.translate("espeak_preferences", "Form", None)
        )
        self.espeak.setTitle(
            QCoreApplication.translate("espeak_preferences", "Espeak", None)
        )
        self.pitch.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "espeak_preferences", "espeak_settings.pitch", None
            ),
        )
        self.pitch.setProperty(
            "label_text",
            QCoreApplication.translate("espeak_preferences", "Pitch", None),
        )
        self.groupBox_2.setTitle(
            QCoreApplication.translate("espeak_preferences", "Gender", None)
        )
        self.gender_combobox.setItemText(
            0, QCoreApplication.translate("espeak_preferences", "Male", None)
        )
        self.gender_combobox.setItemText(
            1, QCoreApplication.translate("espeak_preferences", "Female", None)
        )

        self.label_3.setText(
            QCoreApplication.translate(
                "espeak_preferences", "Robotic, fast, no VRAM usage", None
            )
        )
        self.groupBox.setTitle(
            QCoreApplication.translate("espeak_preferences", "Language", None)
        )
        self.volume.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "espeak_preferences", "espeak_settings.volume", None
            ),
        )
        self.volume.setProperty(
            "label_text",
            QCoreApplication.translate("espeak_preferences", "Volume", None),
        )
        self.rate.setProperty(
            "settings_property",
            QCoreApplication.translate(
                "espeak_preferences", "espeak_settings.rate", None
            ),
        )
        self.rate.setProperty(
            "label_text", QCoreApplication.translate("espeak_preferences", "Rate", None)
        )
