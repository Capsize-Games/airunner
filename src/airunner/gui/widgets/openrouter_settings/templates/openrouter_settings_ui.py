...
class Ui_openrouter_settings_widget(object):
    def setupUi(self, openrouter_settings_widget):
        if not openrouter_settings_widget.objectName():
            openrouter_settings_widget.setObjectName("openrouter_settings_widget")
        ...
        self.api_key.textChanged.connect(
            openrouter_settings_widget.on_api_key_textChanged
        )
    ...
    def retranslateUi(self, openrouter_settings_widget):
        openrouter_settings_widget.setWindowTitle(
            QCoreApplication.translate("openrouter_settings_widget", "Form", None)
        )
        self.allow.setText(
            QCoreApplication.translate(
                "openrouter_settings_widget", "Allow OpenRouter connection", None
            )
        )
        self.groupBox.setTitle(
            QCoreApplication.translate(
                "openrouter_settings_widget", "OpenRouter API key", None
            )
        )
