...
class Ui_completion_page(object):
    def setupUi(self, completion_page):
        if not completion_page.objectName():
            completion_page.setObjectName("completion_page")
    ...
    def retranslateUi(self, completion_page):
        completion_page.setWindowTitle(
            QCoreApplication.translate("completion_page", "Form", None)
        )
        self.label.setText(
            QCoreApplication.translate(
                "completion_page",
                "Your installation is complete. Please use AI Runner responsibly.",
                None,
            )
        )
