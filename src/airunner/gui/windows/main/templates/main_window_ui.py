...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon5 = QIcon()
        icon5.addFile(u":/light/icons/feather/light/corner-right-down.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/light/icons/feather/light/corner-left-down.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon36 = QIcon()
        icon36.addFile(u":/light/icons/feather/light/codesandbox.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.menuWorkflow.setIcon(icon36)
