...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon29 = QIcon()
        icon29.addFile(u":/light/icons/feather/light/pencil-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Brush.setIcon(icon29)
        ...
        icon30 = QIcon()
        icon30.addFile(u":/light/icons/feather/light/grid.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Grid.setIcon(icon30)
        ...
        icon31 = QIcon()
        icon31.addFile(u":/light/icons/feather/light/eraser-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Eraser.setIcon(icon31)
        ...
        icon32 = QIcon()
        icon32.addFile(u":/light/icons/feather/light/plus-circle.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.artActionNew.setIcon(icon32)
        self.actionImport_image = QAction(MainWindow)
        self.actionImport_image.setObjectName(u"actionImport_image")
        icon33 = QIcon()
        icon33.addFile(u":/light/icons/feather/light/download.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionImport_image.setIcon(icon33)
        ...
        icon34 = QIcon()
        icon34.addFile(u":/light/icons/feather/light/upload.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionExport_image_button.setIcon(icon34)
        self.actionNew_Conversation = QAction(MainWindow)
        self.actionNew_Conversation.setObjectName(u"actionNew_Conversation")
        icon35 = QIcon()
        icon35.addFile(u":/light/icons/feather/light/message-circle.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionNew_Conversation.setIcon(icon35)
        ...
        icon36 = QIcon()
        icon36.addFile(u":/light/icons/feather/light/trash-2.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionDelete_conversation.setIcon(icon36)
        ...
        icon37 = QIcon()
        icon37.addFile(u":/light/icons/feather/light/message-square.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionDiscord.setIcon(icon37)
