...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy1.setHeightForWidth(self.panel_container.sizePolicy().hasHeightForWidth())
        self.panel_container.setSizePolicy(sizePolicy1)
        self.panel_container.setMinimumSize(QSize(300, 0))
        self.panel_container.setMaximumSize(QSize(16777215, 16777215))
        self.panel_container.setBaseSize(QSize(300, 0))
        ...
        self.menubar.setGeometry(QRect(0, 0, 1257, 23))
        font1 = QFont()
