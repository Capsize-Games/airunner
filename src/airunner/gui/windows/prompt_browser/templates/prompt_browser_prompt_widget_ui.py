...
class Ui_prompt_widget(object):
    def setupUi(self, prompt_widget):
        ...
        self.secondary_negative_prompt.textChanged.connect(
            prompt_widget.action_text_changed
        )
    ...
    def retranslateUi(self, prompt_widget):
        prompt_widget.setWindowTitle(
            QCoreApplication.translate("prompt_widget", "Form", None)
        )
        self.label.setText(QCoreApplication.translate("prompt_widget", "Prompt", None))
        self.label_5.setText(
            QCoreApplication.translate("prompt_widget", "Second negative Prompt", None)
        )
        self.load_button.setText(
            QCoreApplication.translate("prompt_widget", "Load", None)
        )
        self.delete_button.setText(
            QCoreApplication.translate("prompt_widget", "Delete", None)
        )
        self.label_3.setText(
            QCoreApplication.translate("prompt_widget", "Negative Prompt", None)
        )
        self.label_4.setText(
            QCoreApplication.translate("prompt_widget", "Second prompt", None)
        )
