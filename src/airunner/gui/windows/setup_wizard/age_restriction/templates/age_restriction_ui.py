...
class Ui_age_restriction_warning(object):
    def setupUi(self, age_restriction_warning):
        if not age_restriction_warning.objectName():
            age_restriction_warning.setObjectName("age_restriction_warning")
        ...
        sizePolicy.setHeightForWidth(
            age_restriction_warning.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, age_restriction_warning):
        age_restriction_warning.setWindowTitle(
            QCoreApplication.translate("age_restriction_warning", "Form", None)
        )
        self.checkBox.setText("")
        self.label_7.setText(
            QCoreApplication.translate(
                "age_restriction_warning",
                "I am at least 18 years old and agree to the terms and conditions",
                None,
            )
        )
        ...
        self.label_3.setText(
            QCoreApplication.translate(
                "age_restriction_warning",
                "This application may generate content that is not suitable for all audiences, including nude images. Please confirm that you are at least 18 years old before proceeding.",
                None,
            )
        )
        self.label_4.setText(
            QCoreApplication.translate(
                "age_restriction_warning", "Age Restriction and User Agreement", None
            )
        )
        self.label_2.setText(
            QCoreApplication.translate(
                "age_restriction_warning", "Content Warning and Legal Disclaimer", None
            )
        )
        ...
        self.label_6.setText(
            QCoreApplication.translate(
                "age_restriction_warning",
                "I have read and understood the age restrictions, content warnings, and legal disclaimers provided above. I agree to abide by these guidelines",
                None,
            )
        )
        self.label.setText(
            QCoreApplication.translate(
                "age_restriction_warning",
                "AI Runner is for users of 18 years of age or older",
                None,
            )
        )
