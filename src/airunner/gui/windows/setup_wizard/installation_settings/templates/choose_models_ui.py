...
class Ui_install_success_page(object):
    def setupUi(self, install_success_page):
        if not install_success_page.objectName():
            install_success_page.setObjectName("install_success_page")
        ...
        self.stable_diffusion_scrollarea.setObjectName("stable_diffusion_scrollarea")
        self.stable_diffusion_scrollarea.setWidgetResizable(True)
        self.stable_diffusion_layout = QWidget()
        self.stable_diffusion_layout.setObjectName("stable_diffusion_layout")
        ...
        self.speecht5_checkbox.setObjectName("speecht5_checkbox")
        ...
        self.whisper_checkbox.setObjectName("whisper_checkbox")
        ...
        self.ministral_checkbox.setObjectName("ministral_checkbox")
        ...
        self.openvoice_model.setObjectName("openvoice_model")
    ...
    def retranslateUi(self, install_success_page):
        install_success_page.setWindowTitle(
            QCoreApplication.translate("install_success_page", "Form", None)
        )
        self.page_title.setText(
            QCoreApplication.translate(
                "install_success_page", "Choose models to download", None
            )
        )
        self.total_size_label.setText(
            QCoreApplication.translate("install_success_page", "0MB", None)
        )
        self.groupBox.setTitle(
            QCoreApplication.translate(
                "install_success_page", "Stable Diffusion Controlnet", None
            )
        )
        self.checkBox.setText(
            QCoreApplication.translate(
                "install_success_page", "e5 Large: Embedding model (RAG search)", None
            )
        )
        self.speecht5_checkbox.setText(
            QCoreApplication.translate(
                "install_success_page", "SpeechT5: Text-to-Speech", None
            )
        )
        self.whisper_checkbox.setText(
            QCoreApplication.translate(
                "install_success_page",
                "Whisper: Speech-to-Text (voice conversations)",
                None,
            )
        )
        self.ministral_checkbox.setText(
            QCoreApplication.translate(
                "install_success_page",
                "Ministral 8B Instruct 4bit: Large Language Model (LLM)",
                None,
            )
        )
        self.openvoice_model.setText(
            QCoreApplication.translate(
                "install_success_page", "OpenVoice: Text-to-Speech", None
            )
        )
