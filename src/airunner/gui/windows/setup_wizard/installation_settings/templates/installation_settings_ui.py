...
class Ui_PathSettings(object):
    def setupUi(self, PathSettings):
        ...
        self.installation_path.setObjectName("installation_path")
    ...
    def retranslateUi(self, PathSettings):
        ...
        self.label_2.setText(
            QCoreApplication.translate(
                "PathSettings", "Choose a directory to install AI Runner to", None
            )
        )
        self.label.setText(
            QCoreApplication.translate("PathSettings", "Installation", None)
        )
