...
class Ui_install_failed_page(object):
    def setupUi(self, install_failed_page):
        if not install_failed_page.objectName():
            install_failed_page.setObjectName("install_failed_page")
    ...
    def retranslateUi(self, install_failed_page):
        install_failed_page.setWindowTitle(
            QCoreApplication.translate("install_failed_page", "Form", None)
        )
        self.label_2.setText(
            QCoreApplication.translate(
                "install_failed_page",
                "Something went wrong with the installation. Check your settings and try again.",
                None,
            )
        )
        self.label.setText(
            QCoreApplication.translate(
                "install_failed_page", "Installation Failed", None
            )
        )
