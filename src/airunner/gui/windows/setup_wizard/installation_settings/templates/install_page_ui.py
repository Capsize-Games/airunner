...
class Ui_install_page(object):
    def setupUi(self, install_page):
        if not install_page.objectName():
            install_page.setObjectName("install_page")
    ...
    def retranslateUi(self, install_page):
        install_page.setWindowTitle(
            QCoreApplication.translate("install_page", "Form", None)
        )
        self.label.setText(
            QCoreApplication.translate("install_page", "Downloading AI Models", None)
        )
        self.progress_bar.setFormat(
            QCoreApplication.translate(
                "install_page", "Total Installation progress %p%", None
            )
        )
