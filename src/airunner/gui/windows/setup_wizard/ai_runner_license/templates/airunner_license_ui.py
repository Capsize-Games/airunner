...
class Ui_airunner_license(object):
    def setupUi(self, airunner_license):
        if not airunner_license.objectName():
            airunner_license.setObjectName("airunner_license")
    ...
    def retranslateUi(self, airunner_license):
        airunner_license.setWindowTitle(
            QCoreApplication.translate("airunner_license", "Form", None)
        )
        ...
        self.label.setText(
            QCoreApplication.translate("airunner_license", "AI Runner License", None)
        )
        self.checkBox.setText(
            QCoreApplication.translate(
                "airunner_license",
                "I have read and agree to the terms of the AI Runner license",
                None,
            )
        )
