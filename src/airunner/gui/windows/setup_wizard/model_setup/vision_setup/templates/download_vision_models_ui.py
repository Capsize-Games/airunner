...
class Ui_vision_setup(object):
    def setupUi(self, vision_setup):
        if not vision_setup.objectName():
            vision_setup.setObjectName("vision_setup")
    ...
    def retranslateUi(self, vision_setup):
        vision_setup.setWindowTitle(
            QCoreApplication.translate("vision_setup", "Form", None)
        )
        self.label.setText(
            QCoreApplication.translate("vision_setup", "Vision Models", None)
        )
        self.label_2.setText(
            QCoreApplication.translate(
                "vision_setup",
                "This model is used for processing images from your camera feed. That content is used to enhance your conversations with chatbots. You can skip this step if you do not intend to use this feature.",
                None,
            )
        )
        ...
        self.download.setText(
            QCoreApplication.translate(
                "vision_setup", "Download Controlnet Models", None
            )
        )
        self.cancel.setText(QCoreApplication.translate("vision_setup", "Cancel", None))
