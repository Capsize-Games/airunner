...
class Ui_tts_welcome_screen(object):
    def setupUi(self, tts_welcome_screen):
        if not tts_welcome_screen.objectName():
            tts_welcome_screen.setObjectName("tts_welcome_screen")
    ...
    def retranslateUi(self, tts_welcome_screen):
        tts_welcome_screen.setWindowTitle(
            QCoreApplication.translate("tts_welcome_screen", "Form", None)
        )
        self.label.setText(
            QCoreApplication.translate(
                "tts_welcome_screen", "Text-to-Speech setup", None
            )
        )
        self.radioButton.setText(
            QCoreApplication.translate("tts_welcome_screen", "Yes", None)
        )
        self.radioButton_2.setText(
            QCoreApplication.translate("tts_welcome_screen", "No", None)
        )
        self.label_2.setText(
            QCoreApplication.translate(
                "tts_welcome_screen",
                "Would you like to use the Text-to-Speech feature?",
                None,
            )
        )
        self.label_3.setText(
            QCoreApplication.translate(
                "tts_welcome_screen",
                "Text-to-speech requires the download of an AI model.",
                None,
            )
        )
