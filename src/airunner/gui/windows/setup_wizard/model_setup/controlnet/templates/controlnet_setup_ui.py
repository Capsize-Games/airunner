...
class Ui_controlnet_setup(object):
    def setupUi(self, controlnet_setup):
        if not controlnet_setup.objectName():
            controlnet_setup.setObjectName("controlnet_setup")
    ...
    def retranslateUi(self, controlnet_setup):
        controlnet_setup.setWindowTitle(
            QCoreApplication.translate("controlnet_setup", "Form", None)
        )
        self.radioButton.setText(
            QCoreApplication.translate("controlnet_setup", "Yes", None)
        )
        self.label.setText(
            QCoreApplication.translate(
                "controlnet_setup", "Stable Diffusion: Controlnet", None
            )
        )
        self.label_3.setText(
            QCoreApplication.translate(
                "controlnet_setup",
                "Would you like to use Controlnet with Stable Diffusion",
                None,
            )
        )
        self.label_2.setText(
            QCoreApplication.translate(
                "controlnet_setup",
                "These models allow for greater control over the output of your AI Art and are required for AI Runner to function properly",
                None,
            )
        )
        self.radioButton_2.setText(
            QCoreApplication.translate("controlnet_setup", "No", None)
        )
