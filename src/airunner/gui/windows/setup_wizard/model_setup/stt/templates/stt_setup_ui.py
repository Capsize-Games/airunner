...
class Ui_stt_setup(object):
    def setupUi(self, stt_setup):
        if not stt_setup.objectName():
            stt_setup.setObjectName("stt_setup")
    ...
    def retranslateUi(self, stt_setup):
        stt_setup.setWindowTitle(QCoreApplication.translate("stt_setup", "Form", None))
        self.label_2.setText(
            QCoreApplication.translate("stt_setup", "Download whisper", None)
        )
        self.cancel.setText(QCoreApplication.translate("stt_setup", "Cancel", None))
        self.label.setText(
            QCoreApplication.translate("stt_setup", "Speech-To-Text Model", None)
        )
        self.download.setText(QCoreApplication.translate("stt_setup", "Download", None))
