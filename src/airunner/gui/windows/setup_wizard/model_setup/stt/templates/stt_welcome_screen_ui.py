...
class Ui_stt_welcome_screen(object):
    def setupUi(self, stt_welcome_screen):
        if not stt_welcome_screen.objectName():
            stt_welcome_screen.setObjectName("stt_welcome_screen")
    ...
    def retranslateUi(self, stt_welcome_screen):
        stt_welcome_screen.setWindowTitle(
            QCoreApplication.translate("stt_welcome_screen", "Form", None)
        )
        self.label.setText(
            QCoreApplication.translate(
                "stt_welcome_screen", "Speech-To-Text setup", None
            )
        )
        self.radioButton.setText(
            QCoreApplication.translate("stt_welcome_screen", "Yes", None)
        )
        self.radioButton_2.setText(
            QCoreApplication.translate("stt_welcome_screen", "No", None)
        )
        self.label_2.setText(
            QCoreApplication.translate(
                "stt_welcome_screen",
                "Would you like to use the Speech-to-Text feature?",
                None,
            )
        )
        self.label_3.setText(
            QCoreApplication.translate(
                "stt_welcome_screen",
                "Speech-to-text requires the download of an AI model and access to your microphone.",
                None,
            )
        )
