...
class Ui_stable_diffusion_license(object):
    def setupUi(self, stable_diffusion_license):
        if not stable_diffusion_license.objectName():
            stable_diffusion_license.setObjectName("stable_diffusion_license")
        ...
        self.checkBox.clicked["bool"].connect(
            stable_diffusion_license.agreement_clicked
        )
    ...
    def retranslateUi(self, stable_diffusion_license):
        stable_diffusion_license.setWindowTitle(
            QCoreApplication.translate("stable_diffusion_license", "Form", None)
        )
        self.label.setText(
            QCoreApplication.translate(
                "stable_diffusion_license", "Stable Diffusion License", None
            )
        )
        ...
        self.checkBox.setText(
            QCoreApplication.translate(
                "stable_diffusion_license",
                "I have read and agree to the terms of the Stable Diffusion license",
                None,
            )
        )
