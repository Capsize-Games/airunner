...
class Ui_stable_diffusion_model_setup(object):
    def setupUi(self, stable_diffusion_model_setup):
        if not stable_diffusion_model_setup.objectName():
            stable_diffusion_model_setup.setObjectName("stable_diffusion_model_setup")
    ...
    def retranslateUi(self, stable_diffusion_model_setup):
        stable_diffusion_model_setup.setWindowTitle(
            QCoreApplication.translate("stable_diffusion_model_setup", "Form", None)
        )
        self.label_6.setText(
            QCoreApplication.translate(
                "stable_diffusion_model_setup",
                "Optional model download - you can provide your own models later.",
                None,
            )
        )
        self.label_5.setText(
            QCoreApplication.translate(
                "stable_diffusion_model_setup", "Default Model", None
            )
        )
        self.pushButton.setText(
            QCoreApplication.translate("stable_diffusion_model_setup", "Download", None)
        )
        self.label_2.setText(
            QCoreApplication.translate(
                "stable_diffusion_model_setup",
                "Choose your default model settings. These can be overriden at any time.",
                None,
            )
        )
        self.label.setText(
            QCoreApplication.translate(
                "stable_diffusion_model_setup", "Stable Diffusion Model Setup", None
            )
        )
        self.comboBox.setItemText(
            0,
            QCoreApplication.translate(
                "stable_diffusion_model_setup", "Photography", None
            ),
        )
        self.comboBox.setItemText(
            1,
            QCoreApplication.translate(
                "stable_diffusion_model_setup", "Illustration", None
            ),
        )

        self.label_3.setText(
            QCoreApplication.translate("stable_diffusion_model_setup", "Style", None)
        )
        self.label_4.setText(
            QCoreApplication.translate(
                "stable_diffusion_model_setup", "Model Version", None
            )
        )
