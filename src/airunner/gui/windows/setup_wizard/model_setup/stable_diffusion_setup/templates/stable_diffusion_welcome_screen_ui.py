...
class Ui_stable_diffusion_welcome_screen(object):
    def setupUi(self, stable_diffusion_welcome_screen):
        if not stable_diffusion_welcome_screen.objectName():
            stable_diffusion_welcome_screen.setObjectName(
                "stable_diffusion_welcome_screen"
            )
    ...
    def retranslateUi(self, stable_diffusion_welcome_screen):
        stable_diffusion_welcome_screen.setWindowTitle(
            QCoreApplication.translate("stable_diffusion_welcome_screen", "Form", None)
        )
        self.label.setText(
            QCoreApplication.translate(
                "stable_diffusion_welcome_screen", "Stable Diffusion setup", None
            )
        )
        self.radioButton.setText(
            QCoreApplication.translate("stable_diffusion_welcome_screen", "Yes", None)
        )
        self.radioButton_2.setText(
            QCoreApplication.translate("stable_diffusion_welcome_screen", "No", None)
        )
        self.label_2.setText(
            QCoreApplication.translate(
                "stable_diffusion_welcome_screen",
                "Would you like to use Stable Diffusion as your Image Generator?",
                None,
            )
        )
        self.label_3.setText(
            QCoreApplication.translate(
                "stable_diffusion_welcome_screen",
                "Stable Diffusion is an open-source AI image generator powered by Diffusers. It enables the creation of images from text prompts. Depending on the selected model, there is a potential for generating content that could be considered unsafe or disturbing. While measures have been implemented to mitigate this risk, no AI model can be guaranteed to be completely safe.",
                None,
            )
        )
