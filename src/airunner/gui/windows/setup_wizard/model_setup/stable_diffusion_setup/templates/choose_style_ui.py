...
class Ui_choose_model_style(object):
    def setupUi(self, choose_model_style):
        if not choose_model_style.objectName():
            choose_model_style.setObjectName("choose_model_style")
    ...
    def retranslateUi(self, choose_model_style):
        choose_model_style.setWindowTitle(
            QCoreApplication.translate("choose_model_style", "Form", None)
        )
        self.label_3.setText(
            QCoreApplication.translate("choose_model_style", "Style", None)
        )
        self.comboBox.setItemText(
            0, QCoreApplication.translate("choose_model_style", "Photography", None)
        )
        self.comboBox.setItemText(
            1, QCoreApplication.translate("choose_model_style", "Illustration", None)
        )
        ...
        self.label.setText(
            QCoreApplication.translate(
                "choose_model_style", "Stable Diffusion Model Setup", None
            )
        )
