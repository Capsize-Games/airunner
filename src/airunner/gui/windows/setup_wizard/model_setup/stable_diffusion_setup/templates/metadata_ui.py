...
class Ui_metadata_setup(object):
    def setupUi(self, metadata_setup):
        if not metadata_setup.objectName():
            metadata_setup.setObjectName("metadata_setup")
    ...
    def retranslateUi(self, metadata_setup):
        metadata_setup.setWindowTitle(
            QCoreApplication.translate("metadata_setup", "Form", None)
        )
        self.radioButton.setText(
            QCoreApplication.translate("metadata_setup", "Yes", None)
        )
        self.label.setText(
            QCoreApplication.translate("metadata_setup", "Metadata Setup", None)
        )
        self.label_3.setText(
            QCoreApplication.translate(
                "metadata_setup", "Would you like to enable metadata in images?", None
            )
        )
        self.label_2.setText(
            QCoreApplication.translate(
                "metadata_setup",
                "Metadata is attached to PNGs in order to help facilitate the creation of similar images. You may adjust this setting in the preferences of the main application.",
                None,
            )
        )
        self.radioButton_2.setText(
            QCoreApplication.translate("metadata_setup", "No", None)
        )
