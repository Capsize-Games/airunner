...
class Ui_user_agreement(object):
    def setupUi(self, user_agreement):
        if not user_agreement.objectName():
            user_agreement.setObjectName("user_agreement")
    ...
    def retranslateUi(self, user_agreement):
        user_agreement.setWindowTitle(
            QCoreApplication.translate("user_agreement", "Form", None)
        )
        ...
        self.label.setText(
            QCoreApplication.translate("user_agreement", "User Agreement", None)
        )
