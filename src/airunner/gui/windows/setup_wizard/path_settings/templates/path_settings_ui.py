...
class Ui_PathSettings(object):
    def setupUi(self, PathSettings):
        if not PathSettings.objectName():
            PathSettings.setObjectName("PathSettings")
        ...
        self.base_path.setObjectName("base_path")
    ...
    def retranslateUi(self, PathSettings):
        PathSettings.setWindowTitle(
            QCoreApplication.translate("PathSettings", "Form", None)
        )
        self.label_2.setText(
            QCoreApplication.translate(
                "PathSettings",
                "Let's begin by setting up the path to your AI Runner directory. This directory will contain subdirectories which will contain your models, generated images and more.",
                None,
            )
        )
        self.label.setText(
            QCoreApplication.translate("PathSettings", "AI Runner path", None)
        )
        self.base_path.setText(
            QCoreApplication.translate("PathSettings", "~/.local/share/airunner", None)
        )
        self.pushButton.setText(
            QCoreApplication.translate("PathSettings", "Browse", None)
        )
