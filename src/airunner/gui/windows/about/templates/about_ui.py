...
class Ui_about_window(object):
    def setupUi(self, about_window):
        ...
        sizePolicy.setHeightForWidth(
            about_window.sizePolicy().hasHeightForWidth()
        )
    ...
    def retranslateUi(self, about_window):
        about_window.setWindowTitle(
            QCoreApplication.translate("about_window", "About", None)
        )
        self.title.setText(
            QCoreApplication.translate("about_window", "AI Runner v", None)
        )
        self.label_3.setText(
            QCoreApplication.translate(
                "about_window", "Powered by open source software", None
            )
        )
        self.label_2.setText(
            QCoreApplication.translate(
                "about_window", "Copyright \u00a9 2022-2025 Capsize LLC", None
            )
        )
