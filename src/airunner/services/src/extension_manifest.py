"""Service-owned manifest helpers for external extensions."""
...
def resolve_enabled_manifest(
    ...
    *,
    ...
    """Return a validated manifest when a directory is enabled."""
...
def load_extension_manifest(
    ...
    *,
    ...
    """Read and validate a manifest for an external extension."""
...
def _read_manifest_data(manifest_path: Path) -> Optional[dict[str, object]]:
    """Read one manifest file when it contains a JSON object."""
...
def _build_manifest(
    ...
    *,
    ...
    entry_name = _read_optional_field(data, "entry_point")
    entry_name = entry_name or default_entry_point
...
def _read_required_field(
    ...
    """Return one required string field from manifest data."""
...
def _read_optional_field(
    ...
    """Return one optional trimmed string field from manifest data."""
...
def _resolve_entry_path(
    ...
    """Resolve one manifest entry point inside the extension root."""
