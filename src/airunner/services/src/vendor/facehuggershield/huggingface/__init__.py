...
import airunner_services.vendor.facehuggershield.defendatron
from airunner_services.vendor.facehuggershield.huggingface.set_environment_variables import (
...
def activate(
    ...
    airunner_services.vendor.facehuggershield.defendatron.activate(
