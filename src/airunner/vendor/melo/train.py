...
import airunner.vendor.melo.commons
import airunner.vendor.melo.utils
from airunner.vendor.melo.data_utils import (
    TextAudioSpeakerLoader,
    TextAudioSpeakerCollate,
    DistributedBucketSampler,
)
from airunner.vendor.melo.models import (
    SynthesizerTrn,
    MultiPeriodDiscriminator,
    DurationDiscriminator,
)
from airunner.vendor.melo.losses import (
    generator_loss,
    discriminator_loss,
    feature_loss,
    kl_loss,
...
from airunner.vendor.melo.download_utils import load_pretrain_model
...
def run():
    ...
    if (
        ...
        net_dur_disc = DurationDiscriminator(
            ...
            0.1,
            gin_channels=(
                hps.model.gin_channels if hps.data.n_speakers != 0 else 0
            ),
        ).cuda(rank)
    if (
