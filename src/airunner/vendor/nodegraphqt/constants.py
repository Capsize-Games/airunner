...
__doc__ = """
| The :py:mod:`airunner.vendor.nodegraphqt.constants` namespace contains variables and enums 
 used throughout the airunner.vendor.nodegraphqt library.
"""

# ================================== PRIVATE ===================================

MIME_TYPE = "airunner.vendor.nodegraphqt/nodes"
URI_SCHEME = "airunner.vendor.nodegraphqt://"
URN_SCHEME = "airunner.vendor.nodegraphqt::"
...
class LayoutDirectionEnum(Enum):
    ...
    :py:mod:`airunner.vendor.nodegraphqt.constants.ViewerLayoutEnum`
    """
...
class ViewerEnum(Enum):
    ...
    :py:mod:`airunner.vendor.nodegraphqt.constants.ViewerEnum`
    """
...
class ViewerNavEnum(Enum):
    ...
    :py:mod:`airunner.vendor.nodegraphqt.constants.ViewerNavEnum`
    """
...
class NodeEnum(Enum):
    """
    Node styling layout:
    :py:mod:`airunner.vendor.nodegraphqt.constants.NodeEnum`
    """
...
class PortEnum(Enum):
    """
    Port styling layout:
    :py:mod:`airunner.vendor.nodegraphqt.constants.PortEnum`
    """
...
class PortTypeEnum(Enum):
    ...
    :py:mod:`airunner.vendor.nodegraphqt.constants.PortTypeEnum`
    """
...
class PipeEnum(Enum):
    """
    Pipe styling layout:
    :py:mod:`airunner.vendor.nodegraphqt.constants.PipeEnum`
    """
...
class PipeSlicerEnum(Enum):
    ...
    :py:mod:`airunner.vendor.nodegraphqt.constants.PipeSlicerEnum`
    """
...
class PipeLayoutEnum(Enum):
    ...
    :py:mod:`airunner.vendor.nodegraphqt.constants.PipeLayoutEnum`
    """
...
class NodePropWidgetEnum(Enum):
    """
    Mapping used for the :class:`airunner.vendor.nodegraphqt.PropertiesBinWidget` to display a
    node property in the specified widget type.

    :py:mod:`airunner.vendor.nodegraphqt.constants.NodePropWidgetEnum`
    """
