...
class NodesTreeWidget(QtWidgets.QTreeWidget):
    """
    The :class:`airunner.vendor.nodegraphqt.NodesTreeWidget` is a widget for displaying all
    registered nodes from the node graph with this widget a user can create
    nodes by dragging and dropping.

    .. inheritance-diagram:: airunner.vendor.nodegraphqt.NodesTreeWidget
        :parts: 1
    ...
    .. code-block:: python
        ...
        from airunner.vendor.nodegraphqt import NodeGraph, NodesTreeWidget
