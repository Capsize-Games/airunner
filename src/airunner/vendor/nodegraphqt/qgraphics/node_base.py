...
from airunner.vendor.nodegraphqt.qgraphics.node_overlay_disabled import (
    XDisabledItem,
)
from airunner.vendor.nodegraphqt.qgraphics.node_text_item import NodeTextItem
from airunner.vendor.nodegraphqt.qgraphics.port import (
    PortItem,
    CustomPortItem,
)
...
class NodeItem(AbstractNodeItem):
    ...
    def post_init(self, viewer, pos=None):
        ...
        Args:
            viewer (airunner.vendor.nodegraphqt.widgets.viewer.NodeViewer): main viewer
    ...
    def post_init(self, viewer=None, pos=None):
        ...
        Args:
            viewer (airunner.vendor.nodegraphqt.widgets.viewer.NodeViewer): not used
