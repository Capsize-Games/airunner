...
from airunner.vendor.nodegraphqt.constants import Z_VAL_BACKDROP, NodeEnum
from airunner.vendor.nodegraphqt.qgraphics.node_abstract import (
    AbstractNodeItem,
)
from airunner.vendor.nodegraphqt.qgraphics.pipe import PipeItem
...
class BackdropNodeItem(AbstractNodeItem):
    ...
    def get_nodes(self, inc_intersects=False):
        mode = {
            True: QtCore.Qt.IntersectsItemShape,
