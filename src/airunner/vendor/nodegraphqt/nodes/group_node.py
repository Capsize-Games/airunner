...
from airunner.vendor.nodegraphqt.qgraphics.node_group import GroupNodeItem
...
class GroupNode(BaseNode):
    ...
    The ``airunner.vendor.nodegraphqt.GroupNode`` class extends from the :class:`airunner.vendor.nodegraphqt.BaseNode`
    class with the ability to nest other nodes inside of it.

    .. inheritance-diagram:: airunner.vendor.nodegraphqt.GroupNode
