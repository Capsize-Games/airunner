...
class FilterColorBalance(FilterBase):
    ...
    def filter(self):
        return ColorBalanceFilter(
            cyan_red=self.cyan_red.get() / 1000.0,
            magenta_green=self.magenta_green.get() / 1000.0,
            yellow_blue=self.yellow_blue.get() / 1000.0
        )
    ...
    def show(self):
        ...
        def color_balance_cyan_spinbox_change(val):
            self.cyan_red.set(int(val * 1000.0))
        ...
        def color_balance_magenta_spinbox_change(val):
            self.magenta_green.set(int(val * 1000.0))
        ...
        def color_balance_yellow_spinbox_change(val):
            self.yellow_blue.set(int(val * 1000.0))
