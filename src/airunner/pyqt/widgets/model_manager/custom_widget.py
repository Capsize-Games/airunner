...
from airunner.pyqt.widgets.model_manager.model_widget import ModelWidget
from airunner.pyqt.widgets.model_manager.templates.custom_ui import Ui_custom_model_widget
