# Form implementation generated from reading ui file '/home/joe/Projects/imagetopixel/airunner/src/airunner/pyqt/widgets/model_manager/model_form.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.path_line_edit = QtWidgets.QLineEdit(parent=Form)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.branch_label = QtWidgets.QLabel(parent=Form)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        ...
        self.branch_line_edit = QtWidgets.QLineEdit(parent=Form)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.versions = QtWidgets.QComboBox(parent=Form)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.pipeline_action = QtWidgets.QComboBox(parent=Form)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.pipeline_class_line_edit = QtWidgets.QLineEdit(parent=Form)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.enabled = QtWidgets.QCheckBox(parent=Form)
        font = QtGui.QFont()
        font.setPointSize(8)
    ...
    def retranslateUi(self, Form):
        ...
        self.model_name.setPlaceholderText(_translate("Form", "Name"))
        self.path_label.setText(_translate("Form", "Path"))
        self.path_line_edit.setPlaceholderText(_translate("Form", "Path"))
        self.branch_label.setText(_translate("Form", "Branch"))
        self.branch_line_edit.setPlaceholderText(_translate("Form", "Branch"))
        self.label_7.setText(_translate("Form", "Version"))
        self.label.setText(_translate("Form", "Category"))
        self.label_2.setText(_translate("Form", "Pipeline Action"))
        self.label_3.setText(_translate("Form", "Pipeline Class"))
        self.pipeline_class_line_edit.setPlaceholderText(_translate("Form", "Pipeline class"))
        self.enabled.setText(_translate("Form", "Enabled"))
