...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.settings_button = QtWidgets.QPushButton(parent=self.side_toolbar_container)
        self.settings_button.setMaximumSize(QtCore.QSize(40, 40))
        self.settings_button.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("/home/joe/Projects/imagetopixel/airunner/src/airunner/pyqt/widgets/../../src/icons/settings.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.settings_button.setIcon(icon1)
        self.settings_button.setIconSize(QtCore.QSize(24, 24))
        self.settings_button.setFlat(True)
        self.settings_button.setObjectName("settings_button")
        self.gridLayout_2.addWidget(self.settings_button, 13, 0, 1, 1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("/home/joe/Projects/imagetopixel/airunner/src/airunner/pyqt/widgets/../../src/icons/013-move-selector.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.move_button.setIcon(icon2)
        self.move_button.setIconSize(QtCore.QSize(24, 24))
        self.move_button.setCheckable(True)
        self.move_button.setFlat(True)
        self.move_button.setObjectName("move_button")
        self.gridLayout_2.addWidget(self.move_button, 2, 0, 1, 1)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("/home/joe/Projects/imagetopixel/airunner/src/airunner/pyqt/widgets/../../src/icons/032-pixels.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.grid_button.setIcon(icon3)
        ...
        self.gridLayout_2.addWidget(self.grid_button, 9, 0, 1, 1)
        self.zoom_button = QtWidgets.QPushButton(parent=self.side_toolbar_container)
        self.zoom_button.setMaximumSize(QtCore.QSize(40, 40))
        self.zoom_button.setText("")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("/home/joe/Projects/imagetopixel/airunner/src/airunner/pyqt/widgets/../../src/icons/015-zoom-in.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.gridLayout_2.addWidget(self.zoom_button, 7, 0, 1, 1)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("/home/joe/Projects/imagetopixel/airunner/src/airunner/pyqt/widgets/../../src/icons/039-18.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.nsfw_button.setIcon(icon5)
        ...
        self.gridLayout_2.addWidget(self.nsfw_button, 12, 0, 1, 1)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("/home/joe/Projects/imagetopixel/airunner/src/airunner/pyqt/widgets/../../src/icons/014-eraser.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.gridLayout_2.addWidget(self.eraser_button, 6, 0, 1, 1)
        self.select_button = QtWidgets.QPushButton(parent=self.side_toolbar_container)
        self.select_button.setMinimumSize(QtCore.QSize(40, 40))
        self.select_button.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("/home/joe/Projects/imagetopixel/airunner/src/airunner/pyqt/widgets/../../src/icons/040-select.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.select_button.setIcon(icon7)
        self.select_button.setIconSize(QtCore.QSize(24, 24))
        self.select_button.setCheckable(True)
        self.select_button.setFlat(True)
        self.select_button.setObjectName("select_button")
        self.gridLayout_2.addWidget(self.select_button, 3, 0, 1, 1)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("/home/joe/Projects/imagetopixel/airunner/src/airunner/pyqt/widgets/../../src/icons/037-focus.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.gridLayout_2.addWidget(self.focus_button, 8, 0, 1, 1)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("/home/joe/Projects/imagetopixel/airunner/src/airunner/pyqt/widgets/../../src/icons/011-pencil.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.gridLayout_2.addWidget(self.brush_button, 5, 0, 1, 1)
        self.crop_button = QtWidgets.QPushButton(parent=self.side_toolbar_container)
        self.crop_button.setMaximumSize(QtCore.QSize(40, 40))
        self.crop_button.setText("")
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("/home/joe/Projects/imagetopixel/airunner/src/airunner/pyqt/widgets/../../src/icons/001-crop.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.crop_button.setIcon(icon10)
        self.crop_button.setIconSize(QtCore.QSize(24, 24))
        self.crop_button.setCheckable(True)
        self.crop_button.setFlat(True)
        self.crop_button.setObjectName("crop_button")
        self.gridLayout_2.addWidget(self.crop_button, 4, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.move_button.setToolTip(_translate("Form", "Move"))
        ...
        self.grid_button.setShortcut(_translate("Form", "K"))
        self.zoom_button.setToolTip(_translate("Form", "Zoom"))
        ...
        self.select_button.setToolTip(_translate("Form", "Select"))
        ...
        self.crop_button.setToolTip(_translate("Form", "Crop"))
