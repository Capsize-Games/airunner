...
from airunner.pyqt.widgets.batch.batch_widget import BatchWidget
from airunner.pyqt.widgets.embeddings.embeddings_container_widget import EmbeddingsContainerWidget
from airunner.pyqt.widgets.layers.layer_container_widget import LayerContainerWidget
from airunner.pyqt.widgets.lora.lora_container_widget import LoraContainerWidget
from airunner.pyqt.widgets.slider.slider_widget import SliderWidget
from airunner.pyqt.windows.deterministic_generation.deterministic_widget import DeterministicWidget


class ToolMenuWidget(BaseWidget):
    name = "tool_menu/tool_menu"
