...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 239, 364))
        ...
        self.primary_brush_opacity_slider = QtWidgets.QSlider(parent=self.groupBox_4)
        self.primary_brush_opacity_slider.setMaximum(255)
        self.primary_brush_opacity_slider.setProperty("value", 255)
        self.primary_brush_opacity_slider.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.primary_brush_opacity_slider.setObjectName("primary_brush_opacity_slider")
        self.gridLayout_3.addWidget(self.primary_brush_opacity_slider, 2, 0, 1, 1)
        ...
        self.secondary_color_button = QtWidgets.QToolButton(parent=self.groupBox_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.secondary_color_button.sizePolicy().hasHeightForWidth())
        self.secondary_color_button.setSizePolicy(sizePolicy)
        self.secondary_color_button.setText("")
        self.secondary_color_button.setObjectName("secondary_color_button")
        self.gridLayout_3.addWidget(self.secondary_color_button, 0, 1, 1, 1)
        self.secondary_brush_opacity_slider = QtWidgets.QSlider(parent=self.groupBox_4)
        self.secondary_brush_opacity_slider.setMaximum(255)
        self.secondary_brush_opacity_slider.setProperty("value", 255)
        self.secondary_brush_opacity_slider.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.secondary_brush_opacity_slider.setObjectName("secondary_brush_opacity_slider")
        self.gridLayout_3.addWidget(self.secondary_brush_opacity_slider, 2, 1, 1, 1)
        ...
        self.menuFilters.addAction(self.actionGaussian_Blur)
        self.menuFilters.addAction(self.actionBox_Blur)
        ...
        self.menuFilters.addAction(self.actionSaturation)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Opacity 100"))
        self.label_3.setText(_translate("MainWindow", "Opacity 100"))
