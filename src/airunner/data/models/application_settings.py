...
class ApplicationSettings(BaseModel):
    ...
    @classmethod
    def update_active_tabs(cls, section: str, index: int):
        application_settings = cls.objects.first()
        tabs = application_settings.tabs
        
        section_tabs = tabs.get(section, [])
