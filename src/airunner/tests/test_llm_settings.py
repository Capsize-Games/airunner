...
class TestBaseAgentUpdateUserData(unittest.TestCase):
    ...
    @patch(
        "airunner.handlers.llm.agent.agents.base.BaseAgent.update_user_data_tool",
        new_callable=PropertyMock,
    )
    @patch(
        "airunner.handlers.llm.agent.agents.base.BaseAgent.chat_engine",
        new_callable=PropertyMock,
    )
    @patch(
        "airunner.handlers.llm.agent.agents.base.BaseAgent.username",
        new_callable=PropertyMock,
    )
    @patch("airunner.handlers.llm.agent.agents.base.Conversation.objects.update")
    def test_update_user_data(
        self, mock_update, mock_username, mock_chat_engine, mock_update_user_data_tool
    ):
    ...
    @patch("airunner.handlers.llm.agent.agents.base.Conversation.objects.update")
    def test_update_user_data_no_meaningful_info(
        self, mock_update, mock_username, mock_chat_engine, mock_update_user_data_tool
    ):
