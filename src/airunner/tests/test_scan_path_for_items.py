...
from airunner.utils.models.scan_path_for_items import scan_path_for_lora, scan_path_for_embeddings
...
class TestScanPathForItems(unittest.TestCase):
    ...
    @patch('airunner.utils.models.scan_path_for_items.SettingsMixin')
    def test_scan_path_for_embeddings_delete_missing(self, mock_settings_mixin):
