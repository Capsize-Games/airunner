...
class TestAPI(unittest.TestCase):
    ...
    def test_send_llm_request(self, mock_emit_signal):
        ...
        self.api.send_llm_request(prompt, llm_request, action, do_tts_reply=True)
    ...
    def test_show_dynamic_ui_from_string(self, mock_exec, mock_load_ui):
        ...
        mock_load_ui.assert_called_once_with(ui_content, unittest.mock.ANY, unittest.mock.ANY)
        mock_exec.assert_called_once()
