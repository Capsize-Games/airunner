...
class Ui_memory_preferences(object):
    def setupUi(self, memory_preferences):
        ...
        memory_preferences.resize(1007, 1034)
        ...
        self.gridLayout.addWidget(self.use_lastchannels, 17, 0, 2, 4)
        ...
        self.gridLayout.addWidget(self.label_9, 8, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.use_enable_sequential_cpu_offload, 23, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.label, 24, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.line_9, 37, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.line_4, 16, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.line_8, 10, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.line_6, 34, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.enable_model_cpu_offload, 26, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.use_accelerated_transformers, 4, 0, 1, 5)

        self.use_tf32 = QCheckBox(memory_preferences)
        self.use_tf32.setObjectName(u"use_tf32")
        self.use_tf32.setFont(font)

        self.gridLayout.addWidget(self.use_tf32, 29, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.label_4, 14, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.line_3, 28, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.label_7, 36, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.use_attention_slicing, 11, 0, 2, 2)
        ...
        self.gridLayout.addWidget(self.line, 22, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.label_6, 33, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.label_5, 30, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.line_5, 31, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.use_tiled_vae, 35, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.use_tome, 38, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.line_2, 25, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.use_enable_vae_slicing, 32, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.label_2, 27, 0, 1, 5)
        ...
        self.gridLayout.addWidget(self.label_3, 20, 0, 1, 5)

        self.verticalSpacer = QSpacerItem(624, 13, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)

        self.gridLayout.addItem(self.verticalSpacer, 39, 3, 1, 2)
