...
class MemoryPreferencesWidget(BaseWidget):
    ...
    def __init__(self, **kwargs):
        ...
        self.ui.use_accelerated_transformers.setChecked(self.app.settings_manager.memory_settings.use_accelerated_transformers is True)
        self.ui.use_attention_slicing.setChecked(self.app.settings_manager.memory_settings.use_attention_slicing is True)
        self.ui.use_enable_sequential_cpu_offload.setChecked(
            self.app.settings_manager.memory_settings.use_enable_sequential_cpu_offload is True)
        self.ui.enable_model_cpu_offload.setChecked(
            self.app.settings_manager.memory_settings.enable_model_cpu_offload is True
        )
        self.ui.use_lastchannels.setChecked(self.app.settings_manager.memory_settings.use_last_channels is True)
        self.ui.use_tf32.setChecked(self.app.settings_manager.memory_settings.use_tf32 is True)
        self.ui.use_tiled_vae.setChecked(self.app.settings_manager.memory_settings.use_tiled_vae is True)
        self.ui.use_enable_vae_slicing.setChecked(self.app.settings_manager.memory_settings.use_enable_vae_slicing is True)
        self.ui.use_tome.setChecked(self.app.settings_manager.memory_settings.use_tome_sd is True)
    ...
    def action_toggled_tome(self, val):
        self.app.settings_manager.set_value("memory_settings.use_tome_sd", val)

    def action_toggled_tile_vae(self, val):
        self.app.settings_manager.set_value("memory_settings.use_tiled_vae", val)

    def action_toggled_tf32(self, val):
        self.app.settings_manager.set_value("memory_settings.use_tf32", val)

    def action_toggled_last_memory(self, val):
        self.app.settings_manager.set_value("memory_settings.use_last_channels", val)

    def action_toggled_vae_slicing(self, val):
        self.app.settings_manager.set_value("memory_settings.use_enable_vae_slicing", val)

    def action_toggled_sequential_cpu_offload(self, val):
        self.app.settings_manager.set_value("memory_settings.use_enable_sequential_cpu_offload", val)

    def action_toggled_model_cpu_offload(self, val):
        self.app.settings_manager.set_value("memory_settings.enable_model_cpu_offload", val)

    def action_toggled_attention_slicing(self, val):
        self.app.settings_manager.set_value("memory_settings.use_attention_slicing", val)

    def action_toggled_accelerated_transformers(self, val):
        self.app.settings_manager.set_value("memory_settings.use_accelerated_transformers", val)
