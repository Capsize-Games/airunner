...
class Ui_export_preferences(object):
    def setupUi(self, export_preferences):
        ...
        self.actionAuto_export_images = QtWidgets.QCheckBox(export_preferences)
        font = QtGui.QFont()
        font.setBold(True)
        ...
        self.line = QtWidgets.QFrame(export_preferences)
        self.line.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line.setObjectName("line")
        self.gridLayout_2.addWidget(self.line, 1, 0, 1, 2)
        self.label = QtWidgets.QLabel(export_preferences)
        font = QtGui.QFont()
        font.setBold(True)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.gridLayout_2.addWidget(self.label, 2, 0, 1, 1)
        self.label_2 = QtWidgets.QLabel(export_preferences)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.gridLayout_2.addWidget(self.label_2, 3, 0, 1, 1)
        self.image_path = QtWidgets.QLineEdit(export_preferences)
        self.image_path.setObjectName("image_path")
        self.gridLayout_2.addWidget(self.image_path, 4, 0, 1, 1)
        self.image_path_browse_button = QtWidgets.QPushButton(export_preferences)
        ...
        self.line_3 = QtWidgets.QFrame(export_preferences)
        self.line_3.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_3.setObjectName("line_3")
        self.gridLayout_2.addWidget(self.line_3, 5, 0, 1, 2)
        self.label_5 = QtWidgets.QLabel(export_preferences)
        font = QtGui.QFont()
        font.setBold(True)
        self.label_5.setFont(font)
        self.label_5.setObjectName("label_5")
        self.gridLayout_2.addWidget(self.label_5, 6, 0, 1, 1)
        self.line_2 = QtWidgets.QFrame(export_preferences)
        ...
        self.label_3 = QtWidgets.QLabel(export_preferences)
        font = QtGui.QFont()
        font.setBold(True)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3, 0, 0, 1, 1)
        self.export_metadata = QtWidgets.QCheckBox(export_preferences)
        ...
        self.label_4 = QtWidgets.QLabel(export_preferences)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.image_type_dropdown = QtWidgets.QComboBox(export_preferences)
