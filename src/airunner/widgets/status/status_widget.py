...
class StatusWidget(BaseWidget):
    ...
    def update_system_stats(self, queue_size):
        ...
        nsfw_status = f"NSFW Filter {'On' if self.app.settings_manager.settings.nsfw_filter else 'Off'}"
        ...
        self.ui.nsfw_status.setStyleSheet(enabled_css if self.app.settings_manager.settings.nsfw_filter else disabled_css)
