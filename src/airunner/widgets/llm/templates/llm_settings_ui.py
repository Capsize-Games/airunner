...
class Ui_llm_settings_widget(object):
    def setupUi(self, llm_settings_widget):
        ...
        llm_settings_widget.resize(853, 1064)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 833, 1012))
        ...
        self.sequences.setMinimumSize(QSize(0, 20))
        ...
        self.top_k.setMinimumSize(QSize(0, 20))
        ...
        self.ngram_size.setMinimumSize(QSize(0, 20))
        ...
        self.temperature.setMinimumSize(QSize(0, 20))
        ...
        self.repetition_penalty.setMinimumSize(QSize(0, 20))
        ...
        self.min_length.setMinimumSize(QSize(0, 20))
        ...
        self.top_p.setMinimumSize(QSize(0, 20))
        ...
        self.max_new_tokens.setMinimumSize(QSize(0, 20))
        ...
        self.length_penalty.setMinimumSize(QSize(0, 20))
        ...
        self.num_beams.setMinimumSize(QSize(0, 20))
