# Form implementation generated from reading ui file '/home/joe/Projects/imagetopixel/airunner/src/airunner/widgets/llm/templates/llm_settings.ui'
#
...
class Ui_llm_settings_widget(object):
    def setupUi(self, llm_settings_widget):
        ...
        self.groupBox_8 = QtWidgets.QGroupBox(llm_settings_widget)
        self.groupBox_8.setObjectName("groupBox_8")
        self.gridLayout_11 = QtWidgets.QGridLayout(self.groupBox_8)
        self.gridLayout_11.setObjectName("gridLayout_11")
        self.model_version = QtWidgets.QComboBox(self.groupBox_8)
        ...
        self.dtype_description = QtWidgets.QLabel(self.groupBox_6)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.use_gpu_checkbox = QtWidgets.QCheckBox(self.groupBox_6)
        ...
        self.override_parameters = QtWidgets.QGroupBox(llm_settings_widget)
        ...
        self.early_stopping = QtWidgets.QCheckBox(self.override_parameters)
        self.early_stopping.setObjectName("early_stopping")
        self.horizontalLayout_6.addWidget(self.early_stopping)
        self.do_sample = QtWidgets.QCheckBox(self.override_parameters)
        ...
        self.line = QtWidgets.QFrame(self.override_parameters)
        ...
        self.groupBox_24 = QtWidgets.QGroupBox(self.override_parameters)
        ...
        self.groupBox_25 = QtWidgets.QGroupBox(self.override_parameters)
        ...
        self.groupBox_17 = QtWidgets.QGroupBox(self.override_parameters)
        ...
        self.groupBox_18 = QtWidgets.QGroupBox(self.override_parameters)
        ...
        self.leave_in_vram = QtWidgets.QRadioButton(self.override_parameters)
        self.leave_in_vram.setObjectName("leave_in_vram")
        self.horizontalLayout_12.addWidget(self.leave_in_vram)
        self.move_to_cpu = QtWidgets.QRadioButton(self.override_parameters)
        self.move_to_cpu.setObjectName("move_to_cpu")
        self.horizontalLayout_12.addWidget(self.move_to_cpu)
        self.unload_model = QtWidgets.QRadioButton(self.override_parameters)
        ...
        self.groupBox_19 = QtWidgets.QGroupBox(self.override_parameters)
        self.groupBox_19.setObjectName("groupBox_19")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.groupBox_19)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.seed = QtWidgets.QLineEdit(self.groupBox_19)
        self.seed.setObjectName("seed")
        self.horizontalLayout_4.addWidget(self.seed)
        self.random_seed = QtWidgets.QCheckBox(self.groupBox_19)
        ...
        self.label_3 = QtWidgets.QLabel(self.override_parameters)
        font = QtGui.QFont()
        font.setBold(True)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.gridLayout_12.addWidget(self.label_3, 9, 0, 1, 1)
        self.label_4 = QtWidgets.QLabel(self.override_parameters)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.groupBox_11 = QtWidgets.QGroupBox(self.override_parameters)
        ...
        self.groupBox_16 = QtWidgets.QGroupBox(self.override_parameters)
        ...
        self.groupBox_22 = QtWidgets.QGroupBox(self.override_parameters)
        ...
        self.groupBox_23 = QtWidgets.QGroupBox(self.override_parameters)
        ...
        self.groupBox_20 = QtWidgets.QGroupBox(self.override_parameters)
        ...
        self.groupBox_21 = QtWidgets.QGroupBox(self.override_parameters)
        ...
        self.groupBox = QtWidgets.QGroupBox(llm_settings_widget)
        self.groupBox.setObjectName("groupBox")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.groupBox)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.manual_tools = QtWidgets.QRadioButton(self.groupBox)
        self.manual_tools.setObjectName("manual_tools")
        self.horizontalLayout.addWidget(self.manual_tools)
        self.automatic_tools = QtWidgets.QRadioButton(self.groupBox)
        self.automatic_tools.setObjectName("automatic_tools")
        ...
        self.manual_tools.clicked.connect(llm_settings_widget.enable_manual_tools) # type: ignore
        self.automatic_tools.clicked.connect(llm_settings_widget.enable_automatic_tools) # type: ignore
    ...
    def retranslateUi(self, llm_settings_widget):
        ...
        self.groupBox.setTitle(_translate("llm_settings_widget", "Tools"))
        self.manual_tools.setText(_translate("llm_settings_widget", "Manual"))
        self.automatic_tools.setText(_translate("llm_settings_widget", "Automatic"))
        self.label.setText(_translate("llm_settings_widget", "LLMs can use a variety of tools. These settings define how the LLM will use those tools."))
