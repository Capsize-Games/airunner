...
class Ui_llm_settings_widget(object):
    def setupUi(self, llm_settings_widget):
        ...
        llm_settings_widget.resize(1262, 1207)
        ...
        self.gridLayout.addWidget(self.override_parameters, 4, 0, 1, 2)
        self.groupBox_2 = QtWidgets.QGroupBox(parent=llm_settings_widget)
        self.groupBox_2.setObjectName("groupBox_2")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.groupBox_2)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.semantic_temperature_2 = SliderWidget(parent=self.groupBox_2)
        ...
        self.gridLayout_3.addWidget(self.semantic_temperature_2, 0, 0, 1, 1)
        self.gridLayout.addWidget(self.groupBox_2, 5, 0, 1, 2)
        self.groupBox = QtWidgets.QGroupBox(parent=llm_settings_widget)
        self.groupBox.setObjectName("groupBox")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.groupBox)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.semantic_temperature = SliderWidget(parent=self.groupBox)
        ...
        self.groupBox_3 = QtWidgets.QGroupBox(parent=llm_settings_widget)
        self.groupBox_3.setObjectName("groupBox_3")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.groupBox_3)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.semantic_temperature_3 = SliderWidget(parent=self.groupBox_3)
        ...
        self.gridLayout_4.addWidget(self.semantic_temperature_3, 0, 0, 1, 1)
    ...
    def retranslateUi(self, llm_settings_widget):
        ...
        self.groupBox_2.setTitle(_translate("llm_settings_widget", "Fine Temperature"))
        self.semantic_temperature_2.setProperty("settings_property", _translate("llm_settings_widget", "tts_settings.fine_temperature"))
        self.semantic_temperature_2.setProperty("slider_callback", _translate("llm_settings_widget", "handle_value_change"))
        self.groupBox.setTitle(_translate("llm_settings_widget", "Coarse Temperature"))
        self.semantic_temperature.setProperty("settings_property", _translate("llm_settings_widget", "tts_settings.coarse_temperature"))
        self.semantic_temperature.setProperty("slider_callback", _translate("llm_settings_widget", "handle_value_change"))
        self.groupBox_3.setTitle(_translate("llm_settings_widget", "Semantic Temperature"))
        self.semantic_temperature_3.setProperty("settings_property", _translate("llm_settings_widget", "tts_settings.semantic_temperature"))
        self.semantic_temperature_3.setProperty("slider_callback", _translate("llm_settings_widget", "handle_value_change"))
