...
class Ui_llm_settings_widget(object):
    ...
    def retranslateUi(self, llm_settings_widget):
        ...
        self.num_beams.setProperty("slider_callback", QCoreApplication.translate("llm_settings_widget", u"handle_value_change", None))
        ...
        self.ngram_size.setProperty("slider_callback", QCoreApplication.translate("llm_settings_widget", u"handle_value_change", None))
        ...
        self.temperature.setProperty("slider_callback", QCoreApplication.translate("llm_settings_widget", u"handle_value_change", None))
        ...
        self.repetition_penalty.setProperty("slider_callback", QCoreApplication.translate("llm_settings_widget", u"handle_value_change", None))
        ...
        self.min_length.setProperty("slider_callback", QCoreApplication.translate("llm_settings_widget", u"handle_value_change", None))
        ...
        self.sequences.setProperty("slider_callback", QCoreApplication.translate("llm_settings_widget", u"handle_value_change", None))
        ...
        self.top_k.setProperty("slider_callback", QCoreApplication.translate("llm_settings_widget", u"handle_value_change", None))
        ...
        self.top_p.setProperty("slider_callback", QCoreApplication.translate("llm_settings_widget", u"handle_value_change", None))
        ...
        self.max_length.setProperty("slider_callback", QCoreApplication.translate("llm_settings_widget", u"handle_value_change", None))
