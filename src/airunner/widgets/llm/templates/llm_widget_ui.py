...
class Ui_llm_widget(object):
    def setupUi(self, llm_widget):
        ...
        self.conversation = QtWidgets.QTextEdit(parent=self.tab)
        ...
        self.generate_characters_button = QtWidgets.QPushButton(parent=self.tab_2)
        ...
        self.gridLayout_12.addWidget(self.early_stopping, 8, 0, 1, 1)
        ...
        self.gridLayout_12.addWidget(self.do_sample, 7, 0, 1, 1)
        ...
        self.horizontalLayout_4.addWidget(self.seed_2)
        ...
        self.gridLayout_12.addWidget(self.pushButton, 9, 0, 1, 1)
        ...
        self.groupBox_10 = QtWidgets.QGroupBox(parent=self.tab_4)
        ...
        llm_widget.setTabOrder(self.override_parameters, self.seed_2)
        llm_widget.setTabOrder(self.seed_2, self.random_seed)
        llm_widget.setTabOrder(self.random_seed, self.do_sample)
        llm_widget.setTabOrder(self.do_sample, self.early_stopping)
        llm_widget.setTabOrder(self.early_stopping, self.tabWidget)
    ...
    def retranslateUi(self, llm_widget):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("llm_widget", "Quantization"))
