...
class Ui_llm_widget(object):
    def setupUi(self, llm_widget):
        ...
        self.response = QtWidgets.QPlainTextEdit(parent=self.tab)
        self.response.setReadOnly(True)
        self.response.setObjectName("response")
        self.gridLayout_2.addWidget(self.response, 0, 0, 1, 1)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.generate = QtWidgets.QPushButton(parent=self.tab)
        ...
        self.gridLayout_5.addWidget(self.splitter, 3, 0, 1, 1)
        ...
        self.generate.clicked.connect(llm_widget.action_button_clicked_generated) # type: ignore
    ...
    def retranslateUi(self, llm_widget):
        ...
        self.label_2.setText(_translate("llm_widget", "Prompt"))
        self.generate.setText(_translate("llm_widget", "Generate"))
