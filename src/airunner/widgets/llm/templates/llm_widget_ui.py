...
class Ui_llm_widget(object):
    def setupUi(self, llm_widget):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 628, 755))
        ...
        self.gridLayout_14.addWidget(self.botname, 0, 0, 1, 1)
        ...
        self.personality_type.addItem("")
        self.personality_type.addItem("")
        self.gridLayout_14.addWidget(self.personality_type, 0, 1, 1, 1)
        ...
        llm_widget.setTabOrder(self.early_stopping, self.pushButton)
        llm_widget.setTabOrder(self.pushButton, self.tabWidget)
