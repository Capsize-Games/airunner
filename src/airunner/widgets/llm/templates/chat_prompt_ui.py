...
class Ui_chat_prompt(object):
    def setupUi(self, chat_prompt):
        ...
        self.send_button = QtWidgets.QPushButton(chat_prompt)
        self.send_button.setObjectName("send_button")
        self.horizontalLayout_2.addWidget(self.send_button)
        self.progressBar = QtWidgets.QProgressBar(chat_prompt)
        self.progressBar.setProperty("value", 0)
        self.progressBar.setObjectName("progressBar")
        self.horizontalLayout_2.addWidget(self.progressBar)
        self.pushButton = QtWidgets.QPushButton(chat_prompt)
        self.pushButton.setObjectName("pushButton")
        self.horizontalLayout_2.addWidget(self.pushButton)
        self.clear_conversatiion_button = QtWidgets.QPushButton(chat_prompt)
        ...
        self.chat_prompt_splitter = QtWidgets.QSplitter(chat_prompt)
        ...
        self.verticalLayoutWidget = QtWidgets.QWidget(self.chat_prompt_splitter)
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.chat_container = QtWidgets.QScrollArea(self.verticalLayoutWidget)
        ...
        self.conversation = QtWidgets.QTextEdit(self.scrollAreaWidgetContents)
        ...
        self.prompt = QtWidgets.QPlainTextEdit(self.chat_prompt_splitter)
        ...
        self.action = QtWidgets.QComboBox(chat_prompt)
