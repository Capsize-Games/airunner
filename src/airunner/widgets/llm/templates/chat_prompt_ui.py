...
class Ui_chat_prompt(object):
    def setupUi(self, chat_prompt):
        ...
        self.splitter = QtWidgets.QSplitter(parent=chat_prompt)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 659, 515))
        ...
        self.prompt = QtWidgets.QPlainTextEdit(parent=self.splitter)
