...
class BotPreferencesWidget(BaseWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ui.username.setText(self.app.llm_generator_settings["username"])
        self.ui.botname.setText(self.app.llm_generator_settings["botname"])
        self.ui.bot_personality.setPlainText(self.app.llm_generator_settings["bot_personality"])
        self.ui.bot_mood.setPlainText(self.app.llm_generator_settings["bot_mood"])
