...
class Ui_generator_tab(object):
    def setupUi(self, generator_tab):
        ...
        self.generator_tabs = QtWidgets.QTabWidget(generator_tab)
        ...
        self.tab_widget_stablediffusion = QtWidgets.QTabWidget(self.tab_stablediffusion)
        ...
        self.tab_widget_kandinsky = QtWidgets.QTabWidget(self.tab_kandinsky)
        ...
        self.tab_widget_shape = QtWidgets.QTabWidget(self.tab_shape)
