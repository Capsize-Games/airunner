...
class Ui_generator_form(object):
    def setupUi(self, generator_form):
        ...
        self.generator_form_tabs = QtWidgets.QTabWidget(generator_form)
        ...
        self.negative_prompt = QtWidgets.QPlainTextEdit(self.layoutWidget1)
        ...
        self.generate_button = QtWidgets.QPushButton(self.scrollAreaWidgetContents)
        ...
        self.interrupt_button = QtWidgets.QPushButton(self.scrollAreaWidgetContents)
