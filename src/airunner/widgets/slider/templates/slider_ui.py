...
class Ui_slider_widget(object):
    def setupUi(self, slider_widget):
        ...
        slider_widget.setMinimumSize(QSize(0, 75))
        slider_widget.setMaximumSize(QSize(16777215, 75))
        ...
        self.slider.setMinimumSize(QSize(0, 15))
        ...
        sizePolicy2.setHeightForWidth(self.slider_spinbox.sizePolicy().hasHeightForWidth())
        self.slider_spinbox.setSizePolicy(sizePolicy2)
        self.slider_spinbox.setMinimumSize(QSize(75, 15))
