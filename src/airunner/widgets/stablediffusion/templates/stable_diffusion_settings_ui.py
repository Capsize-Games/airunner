...
class Ui_stable_diffusion_settings_widget(object):
    def setupUi(self, stable_diffusion_settings_widget):
        ...
        self.samples_widget_2.setObjectName(u"samples_widget_2")
        self.samples_widget_2.setMinimumSize(QSize(0, 10))
        self.samples_widget_2.setProperty("slider_callback", u"handle_value_change")
        self.samples_widget_2.setProperty("current_value", 0)
        self.samples_widget_2.setProperty("slider_maximum", 500)
        self.samples_widget_2.setProperty("spinbox_maximum", 500.000000000000000)
    ...
    def retranslateUi(self, stable_diffusion_settings_widget):
        ...
        self.samples_widget_2.setProperty("label_text", QCoreApplication.translate("stable_diffusion_settings_widget", u"Samples", None))
        self.samples_widget_2.setProperty("settings_property", QCoreApplication.translate("stable_diffusion_settings_widget", u"generator_settings.n_samples", None))
