# Form implementation generated from reading ui file '/home/joe/Projects/imagetopixel/airunner/src/airunner/../../src/airunner/widgets/stablediffusion/templates/stable_diffusion_settings.ui'
#
...
class Ui_stable_diffusion_settings_widget(object):
    def setupUi(self, stable_diffusion_settings_widget):
        ...
        self.label_4 = QtWidgets.QLabel(parent=stable_diffusion_settings_widget)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        ...
        self.scheduler = QtWidgets.QComboBox(parent=stable_diffusion_settings_widget)
        ...
        self.label_5 = QtWidgets.QLabel(parent=stable_diffusion_settings_widget)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        ...
        self.pipeline = QtWidgets.QComboBox(parent=stable_diffusion_settings_widget)
        ...
        self.label_3 = QtWidgets.QLabel(parent=stable_diffusion_settings_widget)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        ...
        self.model = QtWidgets.QComboBox(parent=stable_diffusion_settings_widget)
        ...
        self.ddim_eta_slider_widget = SliderWidget(parent=stable_diffusion_settings_widget)
        ...
        self.frames_slider_widget = SliderWidget(parent=stable_diffusion_settings_widget)
        ...
        self.seed_widget = SeedWidget(parent=stable_diffusion_settings_widget)
        ...
        self.reload_selected_preset = QtWidgets.QPushButton(parent=stable_diffusion_settings_widget)
        ...
        self.label_6 = QtWidgets.QLabel(parent=stable_diffusion_settings_widget)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        ...
        self.version = QtWidgets.QComboBox(parent=stable_diffusion_settings_widget)
        ...
        self.steps_widget = SliderWidget(parent=stable_diffusion_settings_widget)
        ...
        self.scale_widget = SliderWidget(parent=stable_diffusion_settings_widget)
        ...
        self.samples_widget_2 = SliderWidget(parent=stable_diffusion_settings_widget)
        ...
        self.clip_skip_slider_widget = SliderWidget(parent=stable_diffusion_settings_widget)
        ...
        self.presets = QtWidgets.QComboBox(parent=stable_diffusion_settings_widget)
        self.presets.setObjectName("presets")
        self.gridLayout.addWidget(self.presets, 1, 0, 1, 4)
        self.label = QtWidgets.QLabel(parent=stable_diffusion_settings_widget)
