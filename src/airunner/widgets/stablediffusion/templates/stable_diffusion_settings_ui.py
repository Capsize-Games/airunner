...
class Ui_stable_diffusion_settings_widget(object):
    def setupUi(self, stable_diffusion_settings_widget):
        ...
        stable_diffusion_settings_widget.resize(335, 776)
        ...
        self.widget = QWidget(stable_diffusion_settings_widget)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 315, 721))
        ...
        self.scale_widget.setMinimumSize(QSize(0, 60))
        ...
        self.gridLayout.addLayout(self.model_layout, 3, 0, 1, 1)
        ...
        self.ddim_eta_slider_widget.setMinimumSize(QSize(0, 60))
        ...
        self.frames_slider_widget.setMinimumSize(QSize(0, 60))
        ...
        self.samples = SliderWidget(self.scrollAreaWidgetContents)
        ...
        self.samples.setMinimumSize(QSize(0, 60))
        ...
        self.gridLayout.addWidget(self.use_compel, 9, 0, 1, 1)
