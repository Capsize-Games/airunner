...
class Ui_spd_preferences(object):
    ...
    def retranslateUi(self, spd_preferences):
        ...
        self.semantic_temperature.setProperty("settings_property", _translate("spd_preferences", "tts_settings.spd.pitch"))
        self.semantic_temperature.setProperty("slider_callback", _translate("spd_preferences", "handle_value_change"))
        self.groupBox_4.setTitle(_translate("spd_preferences", "Rate"))
        self.semantic_temperature_2.setProperty("settings_property", _translate("spd_preferences", "tts_settings.spd.rate"))
        self.semantic_temperature_2.setProperty("slider_callback", _translate("spd_preferences", "handle_value_change"))
        ...
        self.semantic_temperature_3.setProperty("settings_property", _translate("spd_preferences", "tts_settings.spd.volume"))
        self.semantic_temperature_3.setProperty("slider_callback", _translate("spd_preferences", "handle_value_change"))
