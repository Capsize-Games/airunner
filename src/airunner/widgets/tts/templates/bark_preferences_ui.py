...
class Ui_bark_preferences(object):
    ...
    def retranslateUi(self, bark_preferences):
        ...
        self.coarse_temperature.setProperty("settings_property", QCoreApplication.translate("bark_preferences", u"coarse_temperature", None))
        self.coarse_temperature.setProperty("slider_callback", QCoreApplication.translate("bark_preferences", u"handle_value_change", None))
        ...
        self.semantic_temperature.setProperty("settings_property", QCoreApplication.translate("bark_preferences", u"semantic_temperature", None))
        self.semantic_temperature.setProperty("slider_callback", QCoreApplication.translate("bark_preferences", u"handle_value_change", None))
        ...
        self.fine_temperature.setProperty("settings_property", QCoreApplication.translate("bark_preferences", u"fine_temperature", None))
        self.fine_temperature.setProperty("slider_callback", QCoreApplication.translate("bark_preferences", u"handle_value_change", None))
