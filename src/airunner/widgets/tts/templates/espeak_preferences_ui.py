...
class Ui_espeak_preferences(object):
    ...
    def retranslateUi(self, espeak_preferences):
        ...
        self.pitch.setProperty("settings_property", QCoreApplication.translate("espeak_preferences", u"espeak.pitch", None))
        ...
        self.volume.setProperty("settings_property", QCoreApplication.translate("espeak_preferences", u"espeak.volume", None))
        self.groupBox_4.setTitle(QCoreApplication.translate("espeak_preferences", u"Rate", None))
        self.rate.setProperty("settings_property", QCoreApplication.translate("espeak_preferences", u"espeak.rate", None))
