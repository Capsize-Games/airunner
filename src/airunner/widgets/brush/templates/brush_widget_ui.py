...
class Ui_brush_widget(object):
    def setupUi(self, brush_widget):
        ...
        self.horizontalLayout.addWidget(self.strength_slider)
        ...
        self.controlnet_guidance_scale = SliderWidget(self.widget_2)
        self.controlnet_guidance_scale.setObjectName(u"controlnet_guidance_scale")
        self.controlnet_guidance_scale.setMinimumSize(QSize(0, 10))
        ...
        self.horizontalLayout_2.addWidget(self.controlnet_guidance_scale)
