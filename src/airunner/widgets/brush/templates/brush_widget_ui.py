...
class Ui_brush_widget(object):
    def setupUi(self, brush_widget):
        ...
        self.strength_slider.setProperty("spinbox_maximum", 100)
        ...
        self.controlnet_conditioning_scale.setProperty("slider_minimum", 1)
        self.controlnet_conditioning_scale.setProperty("slider_maximum", 100)
        self.controlnet_conditioning_scale.setProperty("spinbox_minimum", 1)
        self.controlnet_conditioning_scale.setProperty("spinbox_maximum", 100)
        ...
        self.controlnet_conditioning_scale.setProperty("slider_page_step", 10)
