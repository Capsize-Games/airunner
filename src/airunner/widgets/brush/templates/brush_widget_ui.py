...
class Ui_brush_widget(object):
    def setupUi(self, brush_widget):
        ...
        self.groupBox_4 = QtWidgets.QGroupBox(brush_widget)
        ...
        self.primary_color_button = QtWidgets.QToolButton(self.groupBox_4)
        ...
        self.controlnet = QtWidgets.QComboBox(brush_widget)
        self.controlnet.setObjectName("controlnet")
        self.gridLayout.addWidget(self.controlnet, 0, 0, 1, 1)
        self.toggle_auto_generate_while_drawing = QtWidgets.QCheckBox(brush_widget)
        self.toggle_auto_generate_while_drawing.setObjectName("toggle_auto_generate_while_drawing")
        ...
        self.toggle_auto_generate_while_drawing.toggled['bool'].connect(brush_widget.toggle_auto_generate_while_drawing) # type: ignore
    ...
    def retranslateUi(self, brush_widget):
        ...
        self.toggle_auto_generate_while_drawing.setText(_translate("brush_widget", "Auto-generate while drawing"))
