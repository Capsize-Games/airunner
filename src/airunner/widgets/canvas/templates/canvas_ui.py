...
class Ui_canvas(object):
    def setupUi(self, canvas):
        ...
        self.splitter_2 = QtWidgets.QSplitter(parent=self.central_widget)
        ...
        self.drawing_pad_groupbox = QtWidgets.QGroupBox(parent=self.splitter)
        ...
        self.controlnet_groupbox = QtWidgets.QGroupBox(parent=self.splitter)
        ...
        self.canvas_container = CustomGraphicsView(parent=self.splitter_2)
