...
class Ui_canvas(object):
    def setupUi(self, canvas):
        ...
        self.central_widget = QtWidgets.QWidget(canvas)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.canvas_splitter = QtWidgets.QSplitter(self.central_widget)
        self.canvas_splitter.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.canvas_splitter.setObjectName("canvas_splitter")
        self.canvas_side_splitter = QtWidgets.QSplitter(self.canvas_splitter)
        ...
        self.drawing_pad_groupbox = QtWidgets.QGroupBox(self.canvas_side_splitter)
        ...
        self.controlnet_groupbox = QtWidgets.QGroupBox(self.canvas_side_splitter)
        ...
        self.canvas_position = QtWidgets.QLabel(self.central_widget)
