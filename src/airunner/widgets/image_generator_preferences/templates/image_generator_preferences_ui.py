...
class Ui_image_generator_preferences(object):
    def setupUi(self, image_generator_preferences):
        ...
        self.groupBox = QtWidgets.QGroupBox(image_generator_preferences)
        ...
        self.action = QtWidgets.QComboBox(self.groupBox)
        self.action.setObjectName("action")
        self.gridLayout_2.addWidget(self.action, 8, 0, 1, 1)
        self.pipeline = QtWidgets.QComboBox(self.groupBox)
