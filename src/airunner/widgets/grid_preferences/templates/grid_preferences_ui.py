...
class Ui_grid_preferences(object):
    def setupUi(self, grid_preferences):
        ...
        self.gridLineColorButton = QtWidgets.QPushButton(grid_preferences)
        self.gridLineColorButton.setObjectName("gridLineColorButton")
        self.gridLayout.addWidget(self.gridLineColorButton, 4, 0, 1, 1)
        self.snap_to_grid_checkbox = QtWidgets.QCheckBox(grid_preferences)
        font = QtGui.QFont()
        font.setBold(False)
        ...
        self.grid_line_width_spinbox = QtWidgets.QSpinBox(grid_preferences)
        ...
        self.show_grid_checkbox = QtWidgets.QCheckBox(grid_preferences)
        font = QtGui.QFont()
        font.setBold(False)
        ...
        self.grid_size_spinbox = QtWidgets.QSpinBox(grid_preferences)
        ...
        self.label = QtWidgets.QLabel(grid_preferences)
        font = QtGui.QFont()
        font.setBold(False)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.gridLayout.addWidget(self.label, 0, 0, 1, 1)
        self.label_2 = QtWidgets.QLabel(grid_preferences)
        font = QtGui.QFont()
        font.setBold(False)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2, 2, 0, 1, 1)
        self.canvas_color = QtWidgets.QPushButton(grid_preferences)
