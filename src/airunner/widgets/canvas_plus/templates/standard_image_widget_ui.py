...
class Ui_standard_image_widget(object):
    def setupUi(self, standard_image_widget):
        ...
        self.gridLayout_4 = QtWidgets.QGridLayout(self.similar_groupbox)
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(parent=self.similar_groupbox)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        ...
        self.upscale_model = QtWidgets.QComboBox(parent=self.groupBox)
        ...
        self.gridLayout_3.addWidget(self.upscale_2x, 3, 0, 1, 1)
        self.face_enhance = QtWidgets.QCheckBox(parent=self.groupBox)
        self.face_enhance.setObjectName("face_enhance")
        self.gridLayout_3.addWidget(self.face_enhance, 1, 0, 1, 1)
