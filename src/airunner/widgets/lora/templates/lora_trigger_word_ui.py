...
class Ui_lora_trigger_word(object):
    def setupUi(self, lora_trigger_word):
        ...
        self.trigger_word = QtWidgets.QLabel(lora_trigger_word)
        self.trigger_word.setObjectName("trigger_word")
        self.horizontalLayout.addWidget(self.trigger_word)
        self.button_to_prompt = QtWidgets.QPushButton(lora_trigger_word)
        ...
        self.button_to_negative_prompt = QtWidgets.QPushButton(lora_trigger_word)
        ...
        self.button_copy = QtWidgets.QPushButton(lora_trigger_word)
        ...
        self.button_copy.clicked.connect(lora_trigger_word.action_click_button_copy) # type: ignore
    ...
    def retranslateUi(self, lora_trigger_word):
        ...
        self.button_to_prompt.setToolTip(_translate("lora_trigger_word", "Send trigger word to prompt"))
        self.button_to_prompt.setText(_translate("lora_trigger_word", "Prompt"))
        self.button_to_negative_prompt.setToolTip(_translate("lora_trigger_word", "Send trigger word to negative prompt"))
        self.button_to_negative_prompt.setText(_translate("lora_trigger_word", "Negative"))
        self.button_copy.setToolTip(_translate("lora_trigger_word", "Copy trigger word to clipboard"))
