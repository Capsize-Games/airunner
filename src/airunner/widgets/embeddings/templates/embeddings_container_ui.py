# Form implementation generated from reading ui file '/home/joe/Projects/imagetopixel/airunner/src/airunner/widgets/embeddings/templates/embeddings_container.ui'
#
...
class Ui_embeddings_container(object):
    def setupUi(self, embeddings_container):
        ...
        self.lineEdit = QtWidgets.QLineEdit(embeddings_container)
        self.lineEdit.setObjectName("lineEdit")
        self.horizontalLayout.addWidget(self.lineEdit)
        self.checkBox = QtWidgets.QCheckBox(embeddings_container)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.embeddings = QtWidgets.QScrollArea(embeddings_container)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.pushButton = QtWidgets.QPushButton(embeddings_container)
