...
class Ui_deterministic_widget(object):
    def setupUi(self, deterministic_widget):
        ...
        self.gridLayout_2 = QtWidgets.QGridLayout(deterministic_widget)
        self.gridLayout_2.setContentsMargins(9, 9, 9, 9)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.groupBox_2 = QtWidgets.QGroupBox(parent=deterministic_widget)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        ...
        self.line = QtWidgets.QFrame(parent=deterministic_widget)
        self.line.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line.setObjectName("line")
        self.gridLayout_2.addWidget(self.line, 1, 0, 1, 2)
        self.groupBox = QtWidgets.QGroupBox(parent=deterministic_widget)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        ...
        self.label = QtWidgets.QLabel(parent=deterministic_widget)
        font = QtGui.QFont()
        ...
        self.generate_batches_button = QtWidgets.QPushButton(parent=deterministic_widget)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.generate_batches_button.setFont(font)
        self.generate_batches_button.setObjectName("generate_batches_button")
        self.gridLayout_2.addWidget(self.generate_batches_button, 5, 0, 1, 2)
        self.deterministic_seed = SeedWidget(parent=deterministic_widget)
