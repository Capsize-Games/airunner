# Form implementation generated from reading ui file '/home/joe/Projects/imagetopixel/airunner/src/airunner/widgets/model_manager/templates/default.ui'
#
...
class Ui_default_model_widget(object):
    def setupUi(self, default_model_widget):
        ...
        self.default_scroll_area = QtWidgets.QScrollArea(default_model_widget)
        ...
        self.comboBox = QtWidgets.QComboBox(default_model_widget)
        self.comboBox.setObjectName("comboBox")
        self.horizontalLayout.addWidget(self.comboBox)
        self.toggle_all = QtWidgets.QCheckBox(default_model_widget)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.lineEdit = QtWidgets.QLineEdit(default_model_widget)
