# Form implementation generated from reading ui file '/home/joe/Projects/imagetopixel/airunner/src/airunner/widgets/model_manager/templates/custom.ui'
#
...
class Ui_custom_model_widget(object):
    def setupUi(self, custom_model_widget):
        ...
        self.scan_for_models_button = QtWidgets.QPushButton(custom_model_widget)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.comboBox = QtWidgets.QComboBox(custom_model_widget)
        self.comboBox.setObjectName("comboBox")
        self.horizontalLayout.addWidget(self.comboBox)
        self.toggle_all = QtWidgets.QCheckBox(custom_model_widget)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.custom_scroll_area = QtWidgets.QScrollArea(custom_model_widget)
        ...
        self.lineEdit = QtWidgets.QLineEdit(custom_model_widget)
