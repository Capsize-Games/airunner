...
class Ui_model_manager(object):
    def setupUi(self, model_manager):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 448, 329))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 448, 329))
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QRect(0, 0, 448, 329))
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QRect(0, 0, 448, 329))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 448, 329))
