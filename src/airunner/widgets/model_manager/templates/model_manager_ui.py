...
class Ui_model_manager(object):
    def setupUi(self, model_manager):
        ...
        self.tabs = QtWidgets.QTabWidget(model_manager)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.scrollArea = QtWidgets.QScrollArea(self.default_tab)
        ...
        self.scrollArea_2 = QtWidgets.QScrollArea(self.custom_tab)
        ...
        self.scrollArea_3 = QtWidgets.QScrollArea(self.import_tab)
