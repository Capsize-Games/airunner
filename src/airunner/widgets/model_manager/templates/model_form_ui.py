...
class Ui_model_form_widget(object):
    def setupUi(self, model_form_widget):
        ...
        self.line = QtWidgets.QFrame(model_form_widget)
        ...
        self.model_data_table = QtWidgets.QTableWidget(model_form_widget)
        ...
        self.category = QtWidgets.QComboBox(self.frame)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.model_type = QtWidgets.QComboBox(self.frame)
        self.model_type.setObjectName("model_type")
        self.gridLayout_2.addWidget(self.model_type, 1, 2, 1, 1)
        self.diffuser_model_version = QtWidgets.QComboBox(self.frame)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.path_line_edit = QtWidgets.QLineEdit(self.frame)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.pipeline_action = QtWidgets.QComboBox(self.frame)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.pipeline_class_line_edit = QtWidgets.QLineEdit(self.frame)
        font = QtGui.QFont()
        font.setPointSize(8)
