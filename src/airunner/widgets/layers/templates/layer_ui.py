...
class Ui_LayerWidget(object):
    def setupUi(self, LayerWidget):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/009-hide-light.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon.addPixmap(QtGui.QPixmap(":/icons/010-view-light.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
