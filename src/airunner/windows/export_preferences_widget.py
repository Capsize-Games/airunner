...
class ExportPreferencesWidget(CustomWidget):
    ...
    def initialize_window(self):
        self.actionAuto_export_images.setChecked(self.settings_manager.settings.auto_export_images.get() is True)
        ...
        self.image_type_dropdown.setCurrentText(self.settings_manager.settings.image_export_type.get())
