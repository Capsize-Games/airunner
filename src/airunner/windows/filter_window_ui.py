...
class Ui_filter_window(object):
    def setupUi(self, filter_window):
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(filter_window)
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.label = QtWidgets.QLabel(filter_window)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.auto_apply = QtWidgets.QCheckBox(filter_window)
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(True)
        ...
        self.content = QtWidgets.QFrame(filter_window)
        font = QtGui.QFont()
        font.setPointSize(8)
