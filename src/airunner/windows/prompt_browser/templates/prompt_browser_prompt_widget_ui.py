...
class Ui_prompt_widget(object):
    def setupUi(self, prompt_widget):
        ...
        self.load_button = QtWidgets.QPushButton(prompt_widget)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.load_button.setFont(font)
        self.load_button.setObjectName("load_button")
        self.horizontalLayout.addWidget(self.load_button)
        self.delete_button = QtWidgets.QPushButton(prompt_widget)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.label = QtWidgets.QLabel(prompt_widget)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.prompt = QtWidgets.QPlainTextEdit(prompt_widget)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.label_3 = QtWidgets.QLabel(prompt_widget)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        ...
        self.negative_prompt = QtWidgets.QPlainTextEdit(prompt_widget)
        font = QtGui.QFont()
        font.setPointSize(9)
