...
class ModelMerger(BaseWindow):
    ...
    def output_path(self):
        ...
        if self.section == "outpaint":
            ...
            output_path = self.app.settings_manager.path_settings.depth2img_model_path
        elif self.section == "pix2pix":
            output_path = self.app.settings_manager.path_settings.pix2pix_model_path
        elif self.section == "upscale":
            output_path = self.app.settings_manager.path_settings.upscale_model_path
        if not output_path or output_path == "":
            output_path = self.app.settings_manager.path_settings.model_base_path
        return output_path
    ...
    def do_model_merge(self):
        models = []
        weights = []
        path = self.app.settings_manager.path_settings.model_base_path
