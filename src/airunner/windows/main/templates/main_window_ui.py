...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon8 = QIcon()
        icon8.addFile(u":/light/icons/feather/light/corner-right-down.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionRotate_90_clockwise.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/light/icons/feather/light/corner-left-down.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionRotate_90_counter_clockwise.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/light/icons/feather/light/book-open.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionPrompt_Browser.setIcon(icon10)
        self.actionClear_all_prompts = QAction(MainWindow)
        self.actionClear_all_prompts.setObjectName(u"actionClear_all_prompts")
        icon11 = QIcon()
        icon11.addFile(u":/light/icons/feather/light/delete.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionClear_all_prompts.setIcon(icon11)
        self.actionUndo_2 = QAction(MainWindow)
        self.actionUndo_2.setObjectName(u"actionUndo_2")
        icon12 = QIcon()
        icon12.addFile(u"../../../../../../../../../../../../../../../../../../../../../../../../../../../../../.designer/src/icons/007-undo.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionUndo_2.setIcon(icon12)
        self.actionRedo_2 = QAction(MainWindow)
        self.actionRedo_2.setObjectName(u"actionRedo_2")
        icon13 = QIcon()
        icon13.addFile(u"../../../../../../../../../../../../../../../../../../../../../../../../../../../../../.designer/src/icons/008-redo.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionRedo_2.setIcon(icon13)
        self.actionCut = QAction(MainWindow)
        self.actionCut.setObjectName(u"actionCut")
        icon14 = QIcon()
        icon14.addFile(u":/light/icons/feather/light/scissors.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/light/icons/feather/light/arrow-up-right.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionBrowse_AI_Runner_Path.setIcon(icon15)
        ...
        self.actionBrowse_Images_Path_2.setIcon(icon15)
        ...
        icon16 = QIcon()
        icon16.addFile(u":/light/icons/feather/light/refresh-cw.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionReset_Settings_2.setIcon(icon16)
        ...
        icon17 = QIcon()
        icon17.addFile(u":/light/icons/feather/light/slash.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionSafety_Checker.setIcon(icon17)
        ...
        icon18 = QIcon()
        icon18.addFile(u":/light/icons/feather/light/zap.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionRun_setup_wizard_2.setIcon(icon18)
        self.actionStats = QAction(MainWindow)
        self.actionStats.setObjectName(u"actionStats")
        icon19 = QIcon()
        icon19.addFile(u":/light/icons/feather/light/activity.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionStats.setIcon(icon19)
        self.actionSettings = QAction(MainWindow)
        self.actionSettings.setObjectName(u"actionSettings")
        icon20 = QIcon()
        icon20.addFile(u":/light/icons/feather/light/settings.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon21 = QIcon()
        icon21.addFile(u":/light/icons/feather/light/cpu.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_LLM.setIcon(icon21)
        ...
        icon22 = QIcon()
        icon22.addFile(u":/light/icons/feather/light/speaker.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Text_to_Speech.setIcon(icon22)
        ...
        icon23 = QIcon()
        icon23.addFile(u":/light/icons/feather/light/mic.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Speech_to_Text.setIcon(icon23)
        ...
        icon24 = QIcon()
        icon24.addFile(u":/light/icons/feather/light/image.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Stable_Diffusion.setIcon(icon24)
        ...
        icon25 = QIcon()
        icon25.addFile(u":/light/icons/feather/light/crosshair.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Controlnet.setIcon(icon25)
        self.actionExport_3 = QAction(MainWindow)
        self.actionExport_3.setObjectName(u"actionExport_3")
        icon26 = QIcon(QIcon.fromTheme(u"document-save"))
        self.actionExport_3.setIcon(icon26)
        ...
        icon27 = QIcon()
        icon27.addFile(u":/light/icons/feather/light/move.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Active_Grid_Area.setIcon(icon27)
        ...
        icon28 = QIcon()
        icon28.addFile(u":/icons/light/select-svgrepo-com.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Selection.setIcon(icon28)
        ...
        icon29 = QIcon()
        icon29.addFile(u":/icons/light/pencil-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon30 = QIcon()
        icon30.addFile(u":/icons/light/frame-grid-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon31 = QIcon()
        icon31.addFile(u":/icons/light/circle-center-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionRecenter.setIcon(icon31)
        ...
        icon32 = QIcon()
        icon32.addFile(u":/icons/light/eraser-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Eraser.setIcon(icon32)
        ...
        icon33 = QIcon()
        icon33.addFile(u":/icons/light/layer-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionMask_toggle.setIcon(icon33)
        ...
        icon34 = QIcon()
        icon34.addFile(u":/light/icons/feather/light/plus-circle.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.artActionNew.setIcon(icon34)
        self.actionImport_image = QAction(MainWindow)
        self.actionImport_image.setObjectName(u"actionImport_image")
        icon35 = QIcon()
        icon35.addFile(u":/icons/light/upload-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionImport_image.setIcon(icon35)
        ...
        icon36 = QIcon()
        icon36.addFile(u":/icons/light/download-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionExport_image_button.setIcon(icon36)
        self.actionNew_Conversation = QAction(MainWindow)
        self.actionNew_Conversation.setObjectName(u"actionNew_Conversation")
        icon37 = QIcon()
        icon37.addFile(u":/light/icons/feather/light/message-circle.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionNew_Conversation.setIcon(icon37)
        ...
        icon38 = QIcon()
        icon38.addFile(u":/light/icons/feather/light/trash-2.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionDelete_conversation.setIcon(icon38)
        ...
        self.menuStable_Diffusion.setIcon(icon24)
