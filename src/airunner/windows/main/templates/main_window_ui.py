...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tts = QtWidgets.QPushButton(parent=self.button_menu)
        self.tts.setMinimumSize(QtCore.QSize(50, 45))
        self.tts.setText("")
        icon = QtGui.QIcon.fromTheme("audio-volume-high")
        self.tts.setIcon(icon)
        self.tts.setIconSize(QtCore.QSize(32, 32))
        self.tts.setCheckable(True)
        self.tts.setFlat(True)
        self.tts.setObjectName("tts")
        self.verticalLayout.addWidget(self.tts)
        self.pushButton = QtWidgets.QPushButton(parent=self.button_menu)
        ...
        self.pushButton_2 = QtWidgets.QPushButton(parent=self.button_menu)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tts.setToolTip(_translate("MainWindow", "Toggle Text to Speech"))
        self.pushButton.setToolTip(_translate("MainWindow", "Toggle Speech To Text"))
        self.pushButton_2.setToolTip(_translate("MainWindow", "Toggle Vision"))
