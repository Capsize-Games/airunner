...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 457, 699))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 53, 699))
        ...
        self.gridLayout_6.addWidget(self.mode_tab_widget, 1, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 1147, 46))
        ...
        self.image_generation_button.setMinimumSize(QtCore.QSize(32, 32))
        self.image_generation_button.setText("")
        icon = QtGui.QIcon.fromTheme("applications-graphics")
        self.image_generation_button.setIcon(icon)
        ...
        self.language_processing_button.setMinimumSize(QtCore.QSize(32, 32))
        self.language_processing_button.setText("")
        icon = QtGui.QIcon.fromTheme("applications-development")
        self.language_processing_button.setIcon(icon)
        ...
        self.model_manager_button.setIcon(icon)
        ...
        self.image_generators_button = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents_3)
        self.image_generators_button.setText("")
        icon = QtGui.QIcon.fromTheme("image-x-generic")
        self.image_generators_button.setIcon(icon)
        ...
        self.horizontalLayout_2.addWidget(self.image_generators_button)
        self.txt2vid_button = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents_3)
        self.txt2vid_button.setText("")
        icon = QtGui.QIcon.fromTheme("video-x-generic")
        self.txt2vid_button.setIcon(icon)
        ...
        self.horizontalLayout_2.addWidget(self.txt2vid_button)
        self.txt2gif_button = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents_3)
        self.txt2gif_button.setText("")
        icon = QtGui.QIcon.fromTheme("emblem-photos")
        self.txt2gif_button.setIcon(icon)
        ...
        self.horizontalLayout_2.addWidget(self.txt2gif_button)
        self.line_7 = QtWidgets.QFrame(parent=self.scrollAreaWidgetContents_3)
        ...
        self.prompt_builder_button = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContents_3)
        ...
        self.horizontalLayout_2.addWidget(self.prompt_builder_button)
        self.line_6 = QtWidgets.QFrame(parent=self.scrollAreaWidgetContents_3)
        ...
        spacerItem1 = QtWidgets.QSpacerItem(0, 36, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        self.image_generation_button.toggled['bool'].connect(MainWindow.image_generation_toggled) # type: ignore
        self.language_processing_button.toggled['bool'].connect(MainWindow.language_processing_toggled) # type: ignore
        ...
        self.image_generators_button.clicked.connect(MainWindow.image_generators_clicked) # type: ignore
        self.txt2vid_button.clicked.connect(MainWindow.text_to_video_clicked) # type: ignore
        self.txt2gif_button.clicked.connect(MainWindow.text_to_gif_clicked) # type: ignore
        self.prompt_builder_button.clicked.connect(MainWindow.prompt_builder_toggled_clicked) # type: ignore
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.file_new_button.setToolTip(_translate("MainWindow", "New document"))
        self.open_button.setToolTip(_translate("MainWindow", "Open document"))
        self.save_button.setToolTip(_translate("MainWindow", "Save document"))
