...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.standard_image_widget = StandardImageWidget(parent=self.content_splitter)
        self.standard_image_widget.setMaximumSize(QtCore.QSize(500, 16777215))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 259, 1117))
