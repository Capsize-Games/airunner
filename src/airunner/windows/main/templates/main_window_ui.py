...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon14 = QIcon(QIcon.fromTheme(u"applications-internet"))
        self.llm_button.setIcon(icon14)
        ...
        icon15 = QIcon(QIcon.fromTheme(u"applications-graphics"))
        self.sd_toggle_button.setIcon(icon15)
        ...
        icon16 = QIcon(QIcon.fromTheme(u"insert-image"))
        self.controlnet_toggle_button.setIcon(icon16)
        ...
        icon20 = QIcon()
        icon20.addFile(u":/icons/light/setting-line-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.settings_button.setIcon(icon20)
