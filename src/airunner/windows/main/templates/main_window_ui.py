...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.image_editor_tab_widget = QtWidgets.QWidget(parent=self.content_splitter)
        ...
        self.image_browser = ImagePanelWidget(parent=self.tab_image)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_4.addWidget(self.image_browser, 0, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 441, 1094))
