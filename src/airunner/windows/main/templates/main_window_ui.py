...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/light/setting-line-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 555, 747))
        ...
        self.nullscream = NullscreamWidget(self.tab_4)
        self.nullscream.setObjectName(u"nullscream")

        self.gridLayout_7.addWidget(self.nullscream, 0, 0, 1, 1)

        self.tool_tab_widget.addTab(self.tab_4, "")
        ...
        sizePolicy4.setHeightForWidth(self.button_menu.sizePolicy().hasHeightForWidth())
        self.button_menu.setSizePolicy(sizePolicy4)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/icons/light/object-selected-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/icons/light/select-svgrepo-com.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.toggle_select_button.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/icons/light/pencil-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/icons/light/eraser-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/icons/light/frame-grid-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon16 = QIcon()
        icon16.addFile(u":/icons/light/circle-center-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon18 = QIcon(QIcon.fromTheme(u"applications-graphics"))
        self.sd_toggle_button.setIcon(icon18)
        ...
        icon19 = QIcon(QIcon.fromTheme(u"insert-image"))
        self.controlnet_toggle_button.setIcon(icon19)
        ...
        icon20 = QIcon(QIcon.fromTheme(u"audio-volume-high"))
        self.tts_button.setIcon(icon20)
        ...
        icon21 = QIcon(QIcon.fromTheme(u"audio-input-microphone"))
        self.v2t_button.setIcon(icon21)
        ...
        icon22 = QIcon(QIcon.fromTheme(u"camera-web"))
        self.ocr_button.setIcon(icon22)
