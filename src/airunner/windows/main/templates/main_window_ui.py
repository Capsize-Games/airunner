...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon3 = QIcon()
        icon3.addFile(u":/light/icons/feather/light/copy.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionCopy.setIcon(icon3)
        self.actionPaste = QAction(MainWindow)
        self.actionPaste.setObjectName(u"actionPaste")
        icon4 = QIcon()
        icon4.addFile(u":/light/icons/feather/light/clipboard.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/light/icons/feather/light/x-circle.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/light/icons/feather/light/external-link.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionBug_report.setIcon(icon8)
        ...
        self.actionReport_vulnerability.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/light/icons/feather/light/corner-right-down.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionRotate_90_clockwise.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/light/icons/feather/light/corner-left-down.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionRotate_90_counter_clockwise.setIcon(icon10)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/light/icons/feather/light/book-open.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionPrompt_Browser.setIcon(icon11)
        self.actionClear_all_prompts = QAction(MainWindow)
        self.actionClear_all_prompts.setObjectName(u"actionClear_all_prompts")
        icon12 = QIcon()
        icon12.addFile(u":/light/icons/feather/light/delete.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionClear_all_prompts.setIcon(icon12)
        self.actionUndo_2 = QAction(MainWindow)
        self.actionUndo_2.setObjectName(u"actionUndo_2")
        icon13 = QIcon()
        icon13.addFile(u"../../../../../../../../../../../../../../../../../../../../../../../../../../../../../.designer/src/icons/007-undo.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionUndo_2.setIcon(icon13)
        self.actionRedo_2 = QAction(MainWindow)
        self.actionRedo_2.setObjectName(u"actionRedo_2")
        icon14 = QIcon()
        icon14.addFile(u"../../../../../../../../../../../../../../../../../../../../../../../../../../../../../.designer/src/icons/008-redo.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionRedo_2.setIcon(icon14)
        self.actionCut = QAction(MainWindow)
        self.actionCut.setObjectName(u"actionCut")
        icon15 = QIcon()
        icon15.addFile(u":/light/icons/feather/light/scissors.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon16 = QIcon()
        icon16.addFile(u":/light/icons/feather/light/folder.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionBrowse_AI_Runner_Path.setIcon(icon16)
        ...
        self.actionBrowse_Images_Path_2.setIcon(icon16)
        ...
        icon17 = QIcon()
        icon17.addFile(u":/light/icons/feather/light/refresh-cw.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionReset_Settings_2.setIcon(icon17)
        ...
        icon18 = QIcon()
        icon18.addFile(u":/light/icons/feather/light/slash.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionSafety_Checker.setIcon(icon18)
        ...
        icon19 = QIcon()
        icon19.addFile(u":/light/icons/feather/light/zap.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionRun_setup_wizard_2.setIcon(icon19)
        self.actionStats = QAction(MainWindow)
        self.actionStats.setObjectName(u"actionStats")
        icon20 = QIcon()
        icon20.addFile(u":/light/icons/feather/light/activity.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionStats.setIcon(icon20)
        self.actionSettings = QAction(MainWindow)
        self.actionSettings.setObjectName(u"actionSettings")
        icon21 = QIcon()
        icon21.addFile(u":/light/icons/feather/light/settings.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon22 = QIcon()
        icon22.addFile(u":/light/icons/feather/light/cpu.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_LLM.setIcon(icon22)
        ...
        icon23 = QIcon()
        icon23.addFile(u":/light/icons/feather/light/speaker.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Text_to_Speech.setIcon(icon23)
        ...
        icon24 = QIcon()
        icon24.addFile(u":/light/icons/feather/light/mic.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Speech_to_Text.setIcon(icon24)
        ...
        icon25 = QIcon()
        icon25.addFile(u":/light/icons/feather/light/image.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Stable_Diffusion.setIcon(icon25)
        ...
        icon26 = QIcon()
        icon26.addFile(u":/light/icons/feather/light/crosshair.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Controlnet.setIcon(icon26)
        self.actionExport_3 = QAction(MainWindow)
        self.actionExport_3.setObjectName(u"actionExport_3")
        icon27 = QIcon(QIcon.fromTheme(u"document-save"))
        self.actionExport_3.setIcon(icon27)
        ...
        icon28 = QIcon()
        icon28.addFile(u":/light/icons/feather/light/object-selected-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Active_Grid_Area.setIcon(icon28)
        ...
        icon29 = QIcon()
        icon29.addFile(u":/icons/light/select-svgrepo-com.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Selection.setIcon(icon29)
        ...
        icon30 = QIcon()
        icon30.addFile(u":/light/icons/feather/light/pencil-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Brush.setIcon(icon30)
        ...
        icon31 = QIcon()
        icon31.addFile(u":/light/icons/feather/light/grid.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Grid.setIcon(icon31)
        self.actionRecenter = QAction(MainWindow)
        self.actionRecenter.setObjectName(u"actionRecenter")
        icon32 = QIcon()
        icon32.addFile(u":/icons/light/circle-center-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionRecenter.setIcon(icon32)
        ...
        icon33 = QIcon()
        icon33.addFile(u":/light/icons/feather/light/eraser-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionToggle_Eraser.setIcon(icon33)
        ...
        icon34 = QIcon()
        icon34.addFile(u":/icons/light/layer-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionMask_toggle.setIcon(icon34)
        ...
        self.actionLLM = QAction(MainWindow)
        self.actionLLM.setObjectName(u"actionLLM")
        self.actionLLM.setCheckable(True)
        self.actionLLM.setChecked(True)
        self.actionChat_History = QAction(MainWindow)
        self.actionChat_History.setObjectName(u"actionChat_History")
        self.actionChat_History.setCheckable(True)
        self.actionChat_History.setChecked(True)
        self.artActionNew = QAction(MainWindow)
        self.artActionNew.setObjectName(u"artActionNew")
        icon35 = QIcon()
        icon35.addFile(u":/light/icons/feather/light/plus-circle.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.artActionNew.setIcon(icon35)
        self.actionImport_image = QAction(MainWindow)
        self.actionImport_image.setObjectName(u"actionImport_image")
        icon36 = QIcon()
        icon36.addFile(u":/light/icons/feather/light/download.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionImport_image.setIcon(icon36)
        ...
        icon37 = QIcon()
        icon37.addFile(u":/light/icons/feather/light/upload.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionExport_image_button.setIcon(icon37)
        self.actionNew_Conversation = QAction(MainWindow)
        self.actionNew_Conversation.setObjectName(u"actionNew_Conversation")
        icon38 = QIcon()
        icon38.addFile(u":/light/icons/feather/light/message-circle.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionNew_Conversation.setIcon(icon38)
        ...
        icon39 = QIcon()
        icon39.addFile(u":/light/icons/feather/light/trash-2.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionDelete_conversation.setIcon(icon39)
        self.actionToggle_Active_Grid_Area_2 = QAction(MainWindow)
        self.actionToggle_Active_Grid_Area_2.setObjectName(u"actionToggle_Active_Grid_Area_2")
        self.actionToggle_Active_Grid_Area_2.setCheckable(True)
        self.actionToggle_Selection_2 = QAction(MainWindow)
        self.actionToggle_Selection_2.setObjectName(u"actionToggle_Selection_2")
        self.actionToggle_Selection_2.setCheckable(True)
        self.actionToggle_Brush_2 = QAction(MainWindow)
        self.actionToggle_Brush_2.setObjectName(u"actionToggle_Brush_2")
        self.actionToggle_Brush_2.setCheckable(True)
        self.actionToggle_Eraser_2 = QAction(MainWindow)
        self.actionToggle_Eraser_2.setObjectName(u"actionToggle_Eraser_2")
        self.actionToggle_Eraser_2.setCheckable(True)
        self.actionToggle_Grid_2 = QAction(MainWindow)
        self.actionToggle_Grid_2.setObjectName(u"actionToggle_Grid_2")
        self.actionToggle_Grid_2.setCheckable(True)
        self.actionToggle_Stable_Diffusion_2 = QAction(MainWindow)
        self.actionToggle_Stable_Diffusion_2.setObjectName(u"actionToggle_Stable_Diffusion_2")
        self.actionToggle_Stable_Diffusion_2.setCheckable(True)
        self.actionToggle_Controlnet_2 = QAction(MainWindow)
        self.actionToggle_Controlnet_2.setObjectName(u"actionToggle_Controlnet_2")
        self.actionToggle_Controlnet_2.setCheckable(True)
        self.actionToggle_Safety_Checker = QAction(MainWindow)
        self.actionToggle_Safety_Checker.setObjectName(u"actionToggle_Safety_Checker")
        self.actionToggle_Safety_Checker.setCheckable(True)
        self.actionToggle_LLM_2 = QAction(MainWindow)
        self.actionToggle_LLM_2.setObjectName(u"actionToggle_LLM_2")
        self.actionToggle_LLM_2.setCheckable(True)
        self.actionToggle_Text_to_Speech_2 = QAction(MainWindow)
        self.actionToggle_Text_to_Speech_2.setObjectName(u"actionToggle_Text_to_Speech_2")
        self.actionToggle_Text_to_Speech_2.setCheckable(True)
        self.actionToggle_Speech_to_Text_2 = QAction(MainWindow)
        self.actionToggle_Speech_to_Text_2.setObjectName(u"actionToggle_Speech_to_Text_2")
        self.actionToggle_Speech_to_Text_2.setCheckable(True)
        self.actionDiscord_2 = QAction(MainWindow)
        self.actionDiscord_2.setObjectName(u"actionDiscord_2")
        self.actionDiscord = QAction(MainWindow)
        self.actionDiscord.setObjectName(u"actionDiscord")
        icon40 = QIcon()
        icon40.addFile(u":/light/icons/feather/light/message-square.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionDiscord.setIcon(icon40)
        ...
        self.actionCollapse_to_system_tray.setIcon(icon7)
        ...
        self.actionNew_Conversation.triggered.connect(MainWindow.action_conversation_triggered_new)
        self.actionDelete_conversation.triggered.connect(MainWindow.action_conversation_triggered_delete)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionLLM.setText(QCoreApplication.translate("MainWindow", u"LLM Settings", None))
        self.actionChat_History.setText(QCoreApplication.translate("MainWindow", u"Chat History", None))
        ...
        self.actionToggle_Active_Grid_Area_2.setText(QCoreApplication.translate("MainWindow", u"Toggle Active Grid Area", None))
        self.actionToggle_Selection_2.setText(QCoreApplication.translate("MainWindow", u"Toggle Selection", None))
        self.actionToggle_Brush_2.setText(QCoreApplication.translate("MainWindow", u"Toggle Brush", None))
        self.actionToggle_Eraser_2.setText(QCoreApplication.translate("MainWindow", u"Toggle Eraser", None))
        self.actionToggle_Grid_2.setText(QCoreApplication.translate("MainWindow", u"Toggle Grid", None))
        self.actionToggle_Stable_Diffusion_2.setText(QCoreApplication.translate("MainWindow", u"Toggle Stable Diffusion", None))
        self.actionToggle_Controlnet_2.setText(QCoreApplication.translate("MainWindow", u"Toggle Controlnet", None))
        self.actionToggle_Safety_Checker.setText(QCoreApplication.translate("MainWindow", u"Toggle Safety Checker", None))
        self.actionToggle_LLM_2.setText(QCoreApplication.translate("MainWindow", u"Toggle LLM", None))
        self.actionToggle_Text_to_Speech_2.setText(QCoreApplication.translate("MainWindow", u"Toggle Text-to-Speech", None))
        self.actionToggle_Speech_to_Text_2.setText(QCoreApplication.translate("MainWindow", u"Toggle Speech-to-Text", None))
