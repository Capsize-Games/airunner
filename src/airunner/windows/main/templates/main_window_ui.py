...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.llm_quantization_button.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.llm_quantization_button.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/light/clamp-as-indicated-symbol-icon.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.llm_quantization_button.setIcon(icon7)
        self.llm_quantization_button.setIconSize(QtCore.QSize(24, 24))
        self.llm_quantization_button.setCheckable(True)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/light/photo-editor-icon.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.image_generators_button.setIcon(icon8)
        ...
        self.splitter_2 = QtWidgets.QSplitter(parent=self.tab_image)
        self.splitter_2.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.splitter_2.setObjectName("splitter_2")
        self.image_editor_tab_widget = QtWidgets.QTabWidget(parent=self.splitter_2)
        ...
        self.llm_quantization_button.toggled['bool'].connect(MainWindow.quantization_clicked) # type: ignore
