...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon21 = QIcon()
        icon21.addFile(u":/icons/light/add-plus-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.artActionNew.setIcon(icon21)
        self.actionImport_image = QAction(MainWindow)
        self.actionImport_image.setObjectName(u"actionImport_image")
        icon22 = QIcon()
        icon22.addFile(u":/icons/light/upload-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionImport_image.setIcon(icon22)
        self.actionExport_image_2 = QAction(MainWindow)
        self.actionExport_image_2.setObjectName(u"actionExport_image_2")
        icon23 = QIcon()
        icon23.addFile(u":/icons/light/download-icon.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionExport_image_2.setIcon(icon23)
        ...
        self.main_window_splitter.addWidget(self.canvas_widget)
        ...
        self.menuCanvas = QMenu(self.menuTools)
        self.menuCanvas.setObjectName(u"menuCanvas")
        self.menuStable_Diffusion = QMenu(self.menuTools)
        self.menuStable_Diffusion.setObjectName(u"menuStable_Diffusion")
        self.menuLLM = QMenu(self.menuTools)
        self.menuLLM.setObjectName(u"menuLLM")
        ...
        self.menuArt.addAction(self.actionExport_image_2)
        ...
        self.menuView.addAction(self.actionLLM)
        self.menuView.addAction(self.actionChat_History)
        ...
        self.menuTools.addAction(self.menuCanvas.menuAction())
        self.menuTools.addSeparator()
        self.menuTools.addAction(self.menuLLM.menuAction())
        self.menuTools.addSeparator()
        self.menuTools.addAction(self.actionStats)
        self.menuTools.addSeparator()
        self.menuTools.addAction(self.actionRun_setup_wizard_2)
        self.menuTools.addSeparator()
        self.menuCanvas.addAction(self.actionToggle_Active_Grid_Area_2)
        self.menuCanvas.addAction(self.actionToggle_Selection_2)
        self.menuCanvas.addAction(self.actionToggle_Brush_2)
        self.menuCanvas.addAction(self.actionToggle_Eraser_2)
        self.menuCanvas.addAction(self.actionToggle_Grid_2)
        self.menuStable_Diffusion.addAction(self.actionToggle_Safety_Checker)
        self.menuStable_Diffusion.addAction(self.actionToggle_Stable_Diffusion_2)
        self.menuStable_Diffusion.addAction(self.actionToggle_Controlnet_2)
        self.menuLLM.addAction(self.actionToggle_LLM_2)
        self.menuLLM.addAction(self.actionToggle_Text_to_Speech_2)
        self.menuLLM.addAction(self.actionToggle_Speech_to_Text_2)
    ...
    def retranslateUi(self, MainWindow):
...
#endif // QT_CONFIG(shortcut)
        self.actionExport_image_2.setText(QCoreApplication.translate("MainWindow", u"Export image", None))
#if QT_CONFIG(shortcut)
        self.actionExport_image_2.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+E", None))
#endif // QT_CONFIG(shortcut)
        ...
        self.menuCanvas.setTitle(QCoreApplication.translate("MainWindow", u"Canvas", None))
        self.menuStable_Diffusion.setTitle(QCoreApplication.translate("MainWindow", u"Stable Diffusion", None))
        self.menuLLM.setTitle(QCoreApplication.translate("MainWindow", u"LLM", None))
