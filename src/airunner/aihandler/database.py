...
class RunAISettings(BaseSettings):
    ...
    def initialize(self, settings=None):
        ...
        self.prompt_generator_category_a = StringVar(app, "")
        self.prompt_generator_category_b = StringVar(app, "")
        self.prompt_blend_type = IntVar(app, 0)
        self.prompt_generator_prompt_a = StringVar(app, "")
        self.prompt_generator_weighted_values_a = DictVar(app, {})
        self.prompt_generator_prompt_color_a = StringVar(app, "")
        self.prompt_generator_prompt_genre_a = StringVar(app, "")
        self.prompt_generator_prompt_style_a = StringVar(app, "")
        self.prompt_generator_prefix_a = StringVar(app, "")
        self.prompt_generator_suffix_a = StringVar(app, "")
        self.negative_prompt_generator_prefix_a = StringVar(app, "")
        self.negative_prompt_generator_suffix_a = StringVar(app, "")
        self.prompt_generator_prompt_b = StringVar(app, "")
        self.prompt_generator_weighted_values_b = DictVar(app, {})
        self.prompt_generator_prompt_color_b = StringVar(app, "")
        self.prompt_generator_prompt_genre_b = StringVar(app, "")
        self.prompt_generator_prompt_style_b = StringVar(app, "")
        self.prompt_generator_prefix_b = StringVar(app, "")
        self.prompt_generator_suffix_b = StringVar(app, "")
    ...
    def reset_settings_to_default(self):
        ...
        self.prompt_blend_type.set(0)
        self.prompt_generator_category_a.set("")
        self.prompt_generator_prompt_a.set("")
        self.prompt_generator_weighted_values_a.set({})
        self.prompt_generator_prompt_genre_a.set("")
        self.prompt_generator_prompt_color_a.set()
        self.prompt_generator_prompt_style_a.set("")
        self.prompt_generator_prefix_a.set("")
        self.prompt_generator_suffix_a.set("")
        self.negative_prompt_generator_prefix_a.set("")
        self.negative_prompt_generator_suffix_a.set("")
        self.prompt_generator_category_b.set("")
        self.prompt_generator_prompt_b.set("")
        self.prompt_generator_weighted_values_b.set({})
        self.prompt_generator_prompt_genre_b.set("")
        self.prompt_generator_prompt_color_b.set()
        self.prompt_generator_prompt_style_b.set("")
        self.prompt_generator_prefix_b.set("")
