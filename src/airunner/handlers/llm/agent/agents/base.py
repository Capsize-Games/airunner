...
class BaseAgent(
    ...
    def system_prompt(self) -> str:
        ...
        prompt = (
            ...
            "- When formatting blocks of code or markdown use triple backticks followed by the language name and a newline. Always close with a newline and triple backticks.\n"
            "- When displaying mathematical equations, use LaTeX format: $$ followed by the equation and $$. Always close with $$.\n"
            f"{backstory_prompt}"
