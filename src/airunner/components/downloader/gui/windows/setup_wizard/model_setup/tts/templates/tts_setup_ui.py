...
class Ui_tts_setup(object):
    ...
    def retranslateUi(self, tts_setup):
        ...
        self.label_2.setText(QCoreApplication.translate("tts_setup", u"OpenVoice models are downloaded automatically when first used", None))
        self.cancel.setText(QCoreApplication.translate("tts_setup", u"Cancel", None))
        self.label.setText(QCoreApplication.translate("tts_setup", u"OpenVoice", None))
