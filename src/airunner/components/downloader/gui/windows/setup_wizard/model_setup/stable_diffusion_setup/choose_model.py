...
from airunner.components.downloader.gui.windows.setup_wizard.model_setup.stable_diffusion_setup.templates.choose_model_ui import (
    Ui_choose_model,
)
