...
class Ui_browser(object):
    def setupUi(self, browser):
        ...
        sizePolicy.setHeightForWidth(self.summarize_button.sizePolicy().hasHeightForWidth())
        self.summarize_button.setSizePolicy(sizePolicy)
        icon = QIcon()
        icon.addFile(u":/dark/icons/feather/dark/list.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.summarize_button.setIcon(icon)
        self.summarize_button.setCheckable(True)

        self.gridLayout.addWidget(self.summarize_button, 2, 1, 1, 1)
        ...
        sizePolicy.setHeightForWidth(self.plaintext_button.sizePolicy().hasHeightForWidth())
        self.plaintext_button.setSizePolicy(sizePolicy)
        icon1 = QIcon()
        icon1.addFile(u":/dark/icons/feather/dark/align-justify.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.plaintext_button.setIcon(icon1)
        self.plaintext_button.setCheckable(True)

        self.gridLayout.addWidget(self.plaintext_button, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.clear_data_button, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.browser_tab_widget, 1, 0, 1, 4)
