...
class Ui_browser(object):
    def setupUi(self, browser):
        ...
        self.plaintext_button.setMinimumSize(QSize(30, 30))
        self.plaintext_button.setMaximumSize(QSize(30, 30))
        self.plaintext_button.setSizeIncrement(QSize(0, 0))
        icon = QIcon()
        ...
        self.summarize_button.setMinimumSize(QSize(30, 30))
        self.summarize_button.setMaximumSize(QSize(30, 30))
        self.summarize_button.setSizeIncrement(QSize(0, 0))
        icon1 = QIcon()
        ...
        self.clear_data_button.setMinimumSize(QSize(30, 30))
        self.clear_data_button.setMaximumSize(QSize(30, 30))
        self.clear_data_button.setSizeIncrement(QSize(0, 0))
        icon2 = QIcon()
        ...
        self.private_browse_button.setMinimumSize(QSize(30, 30))
        self.private_browse_button.setMaximumSize(QSize(30, 30))
        self.private_browse_button.setBaseSize(QSize(0, 0))
        icon3 = QIcon()
        ...
        self.bookmark_page_button.setMinimumSize(QSize(30, 30))
        self.bookmark_page_button.setMaximumSize(QSize(30, 30))
        self.bookmark_page_button.setBaseSize(QSize(0, 0))
        icon4 = QIcon()
        ...
        self.submit_button.setMinimumSize(QSize(30, 30))
        self.submit_button.setMaximumSize(QSize(30, 30))
        self.submit_button.setBaseSize(QSize(0, 0))
        icon5 = QIcon()
        ...
        self.back_button.setBaseSize(QSize(0, 0))
        icon7 = QIcon()
        ...
        self.next_button.setMinimumSize(QSize(30, 30))
        self.next_button.setMaximumSize(QSize(30, 30))
        ...
        self.bookmark_button.setMinimumSize(QSize(30, 30))
        self.bookmark_button.setMaximumSize(QSize(30, 30))
        self.bookmark_button.setBaseSize(QSize(0, 0))
        icon9 = QIcon()
        ...
        self.history_button.setBaseSize(QSize(0, 0))
        icon10 = QIcon()
        ...
        self.random_button.setMinimumSize(QSize(30, 30))
        self.random_button.setMaximumSize(QSize(30, 30))
        self.random_button.setBaseSize(QSize(0, 0))
        icon11 = QIcon()
