...
class Ui_browser(object):
    def setupUi(self, browser):
        ...
        self.private_browse_button = QPushButton(self.widget)
        self.private_browse_button.setObjectName(u"private_browse_button")
        icon = QIcon()
        icon.addFile(u":/dark/icons/feather/dark/eye-off.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.private_browse_button.setIcon(icon)
        self.private_browse_button.setCheckable(True)

        self.horizontalLayout_4.addWidget(self.private_browse_button)

        self.bookmark_page_button = QPushButton(self.widget)
        self.bookmark_page_button.setObjectName(u"bookmark_page_button")
        icon1 = QIcon()
        icon1.addFile(u":/dark/icons/feather/dark/star.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.bookmark_page_button.setIcon(icon1)
        self.bookmark_page_button.setCheckable(True)

        self.horizontalLayout_4.addWidget(self.bookmark_page_button)

        self.url = QLineEdit(self.widget)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/dark/icons/feather/dark/chevron-up.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/dark/icons/feather/dark/refresh-cw.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/dark/icons/feather/dark/arrow-right-circle.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.next_button.setIcon(icon5)

        self.horizontalLayout_4.addWidget(self.next_button)

        self.bookmark_button = QPushButton(self.widget)
        self.bookmark_button.setObjectName(u"bookmark_button")
        icon6 = QIcon()
        icon6.addFile(u":/dark/icons/feather/dark/bookmark.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.bookmark_button.setIcon(icon6)
        self.bookmark_button.setCheckable(True)

        self.horizontalLayout_4.addWidget(self.bookmark_button)

        self.history_button = QPushButton(self.widget)
        self.history_button.setObjectName(u"history_button")
        icon7 = QIcon()
        icon7.addFile(u":/dark/icons/feather/dark/clock.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/dark/icons/feather/dark/dice-game-icon.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/dark/icons/feather/dark/align-justify.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.plaintext_button.setIcon(icon9)
        self.plaintext_button.setCheckable(True)

        self.horizontalLayout_5.addWidget(self.plaintext_button)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/dark/icons/feather/dark/list.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.summarize_button.setIcon(icon10)
        self.summarize_button.setCheckable(True)

        self.horizontalLayout_5.addWidget(self.summarize_button)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/dark/icons/feather/dark/trash-2.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.clear_data_button.setIcon(icon11)

        self.horizontalLayout_5.addWidget(self.clear_data_button)
    ...
    def retranslateUi(self, browser):
        ...
        self.browser_tab_widget.setTabText(self.browser_tab_widget.indexOf(self.tab), QCoreApplication.translate("browser", u"Tab 1", None))
#if QT_CONFIG(tooltip)
