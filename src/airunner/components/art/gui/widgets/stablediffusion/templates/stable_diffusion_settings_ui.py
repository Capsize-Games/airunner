...
from airunner.components.application.gui.widgets.seed.seed_widget import SeedWidget
...
class Ui_stable_diffusion_settings_widget(object):
    def setupUi(self, stable_diffusion_settings_widget):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 409, 906))
        ...
        self.scale_widget.setProperty(u"current_value", 0)
        self.scale_widget.setProperty(u"slider_maximum", 10000)
        self.scale_widget.setProperty(u"spinbox_maximum", 100.000000000000000)
        self.scale_widget.setProperty(u"display_as_float", True)
        self.scale_widget.setProperty(u"spinbox_single_step", 0.010000000000000)
        self.scale_widget.setProperty(u"spinbox_page_step", 0.010000000000000)
        self.scale_widget.setProperty(u"settings_property", u"generator_settings.scale")
        ...
        self.steps_widget.setProperty(u"current_value", 0)
        self.steps_widget.setProperty(u"slider_maximum", 200)
        self.steps_widget.setProperty(u"spinbox_maximum", 200.000000000000000)
        self.steps_widget.setProperty(u"display_as_float", False)
        self.steps_widget.setProperty(u"spinbox_single_step", 1)
        self.steps_widget.setProperty(u"spinbox_page_step", 1)
        self.steps_widget.setProperty(u"spinbox_minimum", 1)
        self.steps_widget.setProperty(u"slider_minimum", 1)
        self.steps_widget.setProperty(u"settings_property", u"generator_settings.steps")
        ...
        self.frames_slider_widget.setProperty(u"current_value", 0)
        self.frames_slider_widget.setProperty(u"slider_maximum", 200)
        self.frames_slider_widget.setProperty(u"spinbox_maximum", 200.000000000000000)
        self.frames_slider_widget.setProperty(u"display_as_float", False)
        self.frames_slider_widget.setProperty(u"spinbox_single_step", 1)
        self.frames_slider_widget.setProperty(u"spinbox_page_step", 1)
        self.frames_slider_widget.setProperty(u"spinbox_minimum", 1)
        self.frames_slider_widget.setProperty(u"slider_minimum", 1)
        self.frames_slider_widget.setProperty(u"settings_property", u"generator_settings.n_samples")
        ...
        self.ddim_eta_slider_widget.setProperty(u"current_value", 1)
        self.ddim_eta_slider_widget.setProperty(u"slider_maximum", 10)
        self.ddim_eta_slider_widget.setProperty(u"spinbox_maximum", 10)
        self.ddim_eta_slider_widget.setProperty(u"display_as_float", False)
        self.ddim_eta_slider_widget.setProperty(u"spinbox_single_step", 1)
        self.ddim_eta_slider_widget.setProperty(u"spinbox_page_step", 1)
        self.ddim_eta_slider_widget.setProperty(u"spinbox_minimum", 1)
        self.ddim_eta_slider_widget.setProperty(u"slider_minimum", 1)
        self.ddim_eta_slider_widget.setProperty(u"settings_property", u"generator_settings.ddim_eta")
        ...
        self.scheduler.setCursor(QCursor(Qt.CursorShape.ArrowCursor))
