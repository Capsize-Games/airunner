...
class Ui_input_image(object):
    def setupUi(self, input_image):
        ...
        self.link_to_grid_image_button.setMinimumSize(QSize(28, 28))
        self.link_to_grid_image_button.setMaximumSize(QSize(28, 28))
        self.link_to_grid_image_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        icon = QIcon()
        ...
        self.lock_input_image_button.setMinimumSize(QSize(28, 28))
        self.lock_input_image_button.setMaximumSize(QSize(28, 28))
        self.lock_input_image_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        icon1 = QIcon()
        ...
        self.refresh_button.setMinimumSize(QSize(28, 28))
        self.refresh_button.setMaximumSize(QSize(28, 28))
        ...
        self.delete_button.setMinimumSize(QSize(28, 28))
        self.delete_button.setMaximumSize(QSize(28, 28))
