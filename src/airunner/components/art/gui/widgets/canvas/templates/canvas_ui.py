...
class Ui_canvas(object):
    def setupUi(self, canvas):
        ...
        icon5 = QIcon()
        icon5.addFile(u":/light/icons/feather/light/target.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.recenter_button.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/light/icons/feather/light/object-selected-icon.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.active_grid_area_button.setIcon(icon6)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/light/icons/feather/light/filter.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/light/icons/lucide/light/grid-3x3.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.grid_button.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/light/icons/feather/light/link-2.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.snap_to_grid_button.setIcon(icon10)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/light/icons/lucide/light/image-minus.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.remove_background_button.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/light/icons/lucide/light/undo.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.undo_button.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/light/icons/lucide/light/redo.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.redo_button.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/light/icons/lucide/light/pencil.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.brush_button.setIcon(icon14)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/light/icons/lucide/light/eraser.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.eraser_button.setIcon(icon15)
