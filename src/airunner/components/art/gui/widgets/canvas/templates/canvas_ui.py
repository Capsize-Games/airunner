...
class Ui_canvas(object):
    def setupUi(self, canvas):
        ...
        icon10 = QIcon()
        icon10.addFile(u":/light/icons/feather/light/filter.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.filter_button.setIcon(icon10)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/light/icons/feather/light/link-2.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.widget2.setMaximumSize(QSize(1024, 16777215))
