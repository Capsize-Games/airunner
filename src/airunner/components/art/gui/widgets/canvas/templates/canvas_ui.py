...
class Ui_canvas(object):
    def setupUi(self, canvas):
        ...
        icon3 = QIcon()
        icon3.addFile(u":/light/icons/feather/light/arrow-down.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/light/icons/feather/light/arrow-up.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/light/icons/lucide/light/pencil.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/light/icons/lucide/light/eraser.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/light/icons/lucide/light/grid-3x3.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/light/icons/lucide/light/image-minus.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.remove_background_button.setIcon(icon15)
