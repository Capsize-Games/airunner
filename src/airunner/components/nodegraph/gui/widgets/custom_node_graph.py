    ...
    def dropEvent(self, event):
        if event.mimeData().hasFormat(VARIABLE_MIME_TYPE):
            ...
            if self.widget_ref and hasattr(
                ...
                variable = self.widget_ref.find_variable_by_name(variable_name)
                if variable:
                    ...
                    node_identifier = "airunner.components.nodegraph.gui.widgets.nodes.variable_getter_node.VariableGetterNode"
