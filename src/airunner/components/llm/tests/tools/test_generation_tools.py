...
class TestGenerationToolsRegistration:
    ...
    def test_generate_direct_response_registered(self):
        ...
        assert tool.requires_agent is False
...
class TestGenerationToolsFunctionality:
    ...
    def test_generate_description_without_agent(self):
        """Test generate_description creates a direct-gen request."""
    ...
    def test_categorize_without_agent(self):
        """Test categorize creates a direct-gen request."""
...
class TestGenerationToolsMetadata:
    ...
    def test_generation_tools_do_not_require_agent(self):
        """Direct-generation tools should not depend on agent injection."""
        tools = ToolRegistry.get_by_category(ToolCategory.GENERATION)
        for tool in tools:
            assert (
                tool.requires_agent is False
            ), f"{tool.name} should not require agent"
