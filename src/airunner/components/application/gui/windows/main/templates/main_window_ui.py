...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon28 = QIcon()
        icon28.addFile(u":/light/icons/lucide/light/message-square-heart.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.prompt_editor_button.setIcon(icon28)
        ...
        icon29 = QIcon()
        icon29.addFile(u":/light/icons/feather/light/tool.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.art_tools_button.setIcon(icon29)
        ...
        icon30 = QIcon()
        icon30.addFile(u":/light/icons/feather/light/activity.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.stats_button.setIcon(icon30)
