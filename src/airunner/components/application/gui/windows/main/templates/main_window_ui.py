...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon24 = QIcon()
        icon24.addFile(u":/light/icons/feather/light/save.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionSave_As.setIcon(icon24)
        self.actionDownload_Model = QAction(MainWindow)
        self.actionDownload_Model.setObjectName(u"actionDownload_Model")
        icon25 = QIcon()
        icon25.addFile(u":/light/icons/feather/light/arrow-down-circle.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionDownload_Model.setIcon(icon25)
        ...
        icon26 = QIcon()
        icon26.addFile(u":/light/icons/feather/light/home.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.home_button.setIcon(icon26)
        ...
        icon27 = QIcon()
        icon27.addFile(u":/light/icons/feather/light/file-text.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.document_editor_button.setIcon(icon27)
        ...
        icon28 = QIcon()
        icon28.addFile(u":/light/icons/feather/light/calendar.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.calendar_button.setIcon(icon28)
        ...
        icon29 = QIcon()
        icon29.addFile(u":/dark/icons/feather/dark/radio.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.visualizer_button.setIcon(icon29)
        ...
        self.menuDocuments.setIcon(icon27)
