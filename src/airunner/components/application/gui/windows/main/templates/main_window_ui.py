...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.art_tools_button = QPushButton(self.actionsidebar_right)
        self.art_tools_button.setObjectName(u"art_tools_button")
        self.art_tools_button.setMinimumSize(QSize(35, 35))
        self.art_tools_button.setMaximumSize(QSize(35, 35))
        self.art_tools_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        icon30 = QIcon()
        icon30.addFile(u":/light/icons/feather/light/tool.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.art_tools_button.setIcon(icon30)
        self.art_tools_button.setIconSize(QSize(20, 20))
        self.art_tools_button.setCheckable(True)
        self.art_tools_button.setFlat(True)

        self.verticalLayout.addWidget(self.art_tools_button)
        ...
        icon31 = QIcon()
        icon31.addFile(u":/light/icons/feather/light/activity.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.stats_button.setIcon(icon31)
...
#if QT_CONFIG(tooltip)
        self.art_tools_button.setToolTip(QCoreApplication.translate("MainWindow", u"Toggle Art Settings", None))
#endif // QT_CONFIG(tooltip)
