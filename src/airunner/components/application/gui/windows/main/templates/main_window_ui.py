...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionDiscussions.setIcon(icon23)
        self.actionDownload_Model = QAction(MainWindow)
        self.actionDownload_Model.setObjectName(u"actionDownload_Model")
        icon24 = QIcon()
        icon24.addFile(u":/light/icons/feather/light/arrow-down-circle.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionDownload_Model.setIcon(icon24)
        ...
        icon25 = QIcon()
        icon25.addFile(u":/light/icons/feather/light/home.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.home_button.setIcon(icon25)
