...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon24 = QIcon()
        icon24.addFile(u":/light/icons/feather/light/edit-3.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionPrompt_Builder.setIcon(icon24)
        ...
        icon25 = QIcon()
        icon25.addFile(u":/light/icons/lucide/light/message-square-text.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.chat_button.setIcon(icon25)
        ...
        self.line_3 = QFrame(self.actionsidebar)
        self.line_3.setObjectName(u"line_3")
        self.line_3.setFrameShape(QFrame.Shape.HLine)
        self.line_3.setFrameShadow(QFrame.Shadow.Sunken)

        self.action_sidebar.addWidget(self.line_3)
        ...
        icon26 = QIcon()
        icon26.addFile(u":/light/icons/feather/light/book.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.knowledgebase_button.setIcon(icon26)
        ...
        self.history_sidebar_button = QPushButton(self.actionsidebar)
        self.history_sidebar_button.setObjectName(u"history_sidebar_button")
        self.history_sidebar_button.setMinimumSize(QSize(35, 35))
        self.history_sidebar_button.setMaximumSize(QSize(35, 35))
        self.history_sidebar_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        icon27 = QIcon()
        icon27.addFile(u":/light/icons/lucide/light/history.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.history_sidebar_button.setIcon(icon27)
        self.history_sidebar_button.setIconSize(QSize(20, 20))
        self.history_sidebar_button.setCheckable(True)
        self.history_sidebar_button.setFlat(True)

        self.action_sidebar.addWidget(self.history_sidebar_button)

        self.llm_settings_sidebar_button = QPushButton(self.actionsidebar)
        self.llm_settings_sidebar_button.setObjectName(u"llm_settings_sidebar_button")
        self.llm_settings_sidebar_button.setMinimumSize(QSize(35, 35))
        self.llm_settings_sidebar_button.setMaximumSize(QSize(35, 35))
        self.llm_settings_sidebar_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        icon28 = QIcon()
        icon28.addFile(u":/light/icons/lucide/light/settings-2.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.llm_settings_sidebar_button.setIcon(icon28)
        self.llm_settings_sidebar_button.setIconSize(QSize(20, 20))
        self.llm_settings_sidebar_button.setCheckable(True)
        self.llm_settings_sidebar_button.setFlat(True)

        self.action_sidebar.addWidget(self.llm_settings_sidebar_button)
        ...
        self.canvas_button = QPushButton(self.actionsidebar_right)
        self.canvas_button.setObjectName(u"canvas_button")
        self.canvas_button.setMinimumSize(QSize(35, 35))
        self.canvas_button.setMaximumSize(QSize(35, 35))
        icon29 = QIcon()
        icon29.addFile(u":/light/icons/lucide/light/image.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.canvas_button.setIcon(icon29)
        ...
        self.line_2 = QFrame(self.actionsidebar_right)
        ...
        self.prompt_editor_button = QPushButton(self.actionsidebar_right)
        self.prompt_editor_button.setObjectName(u"prompt_editor_button")
        self.prompt_editor_button.setMinimumSize(QSize(35, 35))
        self.prompt_editor_button.setMaximumSize(QSize(35, 35))
        self.prompt_editor_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        icon30 = QIcon()
        icon30.addFile(u":/light/icons/lucide/light/message-square-heart.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.prompt_editor_button.setIcon(icon30)
        self.prompt_editor_button.setIconSize(QSize(20, 20))
        self.prompt_editor_button.setCheckable(True)
        self.prompt_editor_button.setFlat(True)

        self.verticalLayout.addWidget(self.prompt_editor_button)

        self.line_4 = QFrame(self.actionsidebar_right)
        ...
        self.art_model_button = QPushButton(self.actionsidebar_right)
        self.art_model_button.setObjectName(u"art_model_button")
        self.art_model_button.setMinimumSize(QSize(35, 35))
        self.art_model_button.setMaximumSize(QSize(35, 35))
        self.art_model_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        icon31 = QIcon()
        icon31.addFile(u":/light/icons/lucide/light/sparkles.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.art_model_button.setIcon(icon31)
        self.art_model_button.setIconSize(QSize(20, 20))
        self.art_model_button.setCheckable(True)
        self.art_model_button.setFlat(True)

        self.verticalLayout.addWidget(self.art_model_button)

        self.lora_button = QPushButton(self.actionsidebar_right)
        self.lora_button.setObjectName(u"lora_button")
        self.lora_button.setMinimumSize(QSize(35, 35))
        self.lora_button.setMaximumSize(QSize(35, 35))
        self.lora_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        icon32 = QIcon()
        icon32.addFile(u":/light/icons/lucide/light/puzzle.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.lora_button.setIcon(icon32)
        self.lora_button.setIconSize(QSize(20, 20))
        self.lora_button.setCheckable(True)
        self.lora_button.setFlat(True)

        self.verticalLayout.addWidget(self.lora_button)

        self.embeddings_button = QPushButton(self.actionsidebar_right)
        self.embeddings_button.setObjectName(u"embeddings_button")
        self.embeddings_button.setMinimumSize(QSize(35, 35))
        self.embeddings_button.setMaximumSize(QSize(35, 35))
        self.embeddings_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        icon33 = QIcon()
        icon33.addFile(u":/light/icons/lucide/light/scan-text.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.embeddings_button.setIcon(icon33)
        self.embeddings_button.setIconSize(QSize(20, 20))
        self.embeddings_button.setCheckable(True)
        self.embeddings_button.setFlat(True)

        self.verticalLayout.addWidget(self.embeddings_button)

        self.layers_button = QPushButton(self.actionsidebar_right)
        self.layers_button.setObjectName(u"layers_button")
        self.layers_button.setMinimumSize(QSize(35, 35))
        self.layers_button.setMaximumSize(QSize(35, 35))
        self.layers_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        icon34 = QIcon()
        icon34.addFile(u":/light/icons/lucide/light/layers.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.layers_button.setIcon(icon34)
        self.layers_button.setIconSize(QSize(20, 20))
        self.layers_button.setCheckable(True)
        self.layers_button.setFlat(True)

        self.verticalLayout.addWidget(self.layers_button)

        self.grid_button = QPushButton(self.actionsidebar_right)
        self.grid_button.setObjectName(u"grid_button")
        self.grid_button.setMinimumSize(QSize(35, 35))
        self.grid_button.setMaximumSize(QSize(35, 35))
        self.grid_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        icon35 = QIcon()
        icon35.addFile(u":/light/icons/lucide/light/grid-2x2-check.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.grid_button.setIcon(icon35)
        self.grid_button.setIconSize(QSize(20, 20))
        self.grid_button.setCheckable(True)
        self.grid_button.setFlat(True)

        self.verticalLayout.addWidget(self.grid_button)

        self.image_browser_button = QPushButton(self.actionsidebar_right)
        self.image_browser_button.setObjectName(u"image_browser_button")
        self.image_browser_button.setMinimumSize(QSize(35, 35))
        self.image_browser_button.setMaximumSize(QSize(35, 35))
        self.image_browser_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        icon36 = QIcon()
        icon36.addFile(u":/light/icons/lucide/light/images.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.image_browser_button.setIcon(icon36)
        self.image_browser_button.setIconSize(QSize(20, 20))
        self.image_browser_button.setCheckable(True)
        self.image_browser_button.setFlat(True)

        self.verticalLayout.addWidget(self.image_browser_button)
        ...
        icon37 = QIcon()
        icon37.addFile(u":/light/icons/feather/light/activity.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.stats_button.setIcon(icon37)
        ...
        self.left_panel_tab = QTabWidget(self.documents_sidebar)
        self.left_panel_tab.setObjectName(u"left_panel_tab")
        self.left_documents_page = QWidget()
        self.left_documents_page.setObjectName(u"left_documents_page")
        self.gridLayout_left_documents_page = QGridLayout(self.left_documents_page)
        self.gridLayout_left_documents_page.setObjectName(u"gridLayout_left_documents_page")
        self.gridLayout_left_documents_page.setContentsMargins(0, 0, 0, 0)
        self.left_documents_placeholder = QWidget(self.left_documents_page)
        self.left_documents_placeholder.setObjectName(u"left_documents_placeholder")

        self.gridLayout_left_documents_page.addWidget(self.left_documents_placeholder, 0, 0, 1, 1)

        self.left_panel_tab.addTab(self.left_documents_page, "")
        self.left_history_page = QWidget()
        self.left_history_page.setObjectName(u"left_history_page")
        self.gridLayout_left_history_page = QGridLayout(self.left_history_page)
        self.gridLayout_left_history_page.setObjectName(u"gridLayout_left_history_page")
        self.gridLayout_left_history_page.setContentsMargins(0, 0, 0, 0)
        self.left_history_placeholder = QWidget(self.left_history_page)
        self.left_history_placeholder.setObjectName(u"left_history_placeholder")

        self.gridLayout_left_history_page.addWidget(self.left_history_placeholder, 0, 0, 1, 1)

        self.left_panel_tab.addTab(self.left_history_page, "")
        self.left_llm_settings_page = QWidget()
        self.left_llm_settings_page.setObjectName(u"left_llm_settings_page")
        self.gridLayout_left_llm_settings_page = QGridLayout(self.left_llm_settings_page)
        self.gridLayout_left_llm_settings_page.setObjectName(u"gridLayout_left_llm_settings_page")
        self.gridLayout_left_llm_settings_page.setContentsMargins(0, 0, 0, 0)
        self.left_llm_settings_placeholder = QWidget(self.left_llm_settings_page)
        self.left_llm_settings_placeholder.setObjectName(u"left_llm_settings_placeholder")

        self.gridLayout_left_llm_settings_page.addWidget(self.left_llm_settings_placeholder, 0, 0, 1, 1)

        self.left_panel_tab.addTab(self.left_llm_settings_page, "")

        self.gridLayout_documents_sidebar.addWidget(self.left_panel_tab, 0, 0, 1, 1)
        ...
        self.gridLayout_stats_page = QGridLayout(self.stats_page)
        self.gridLayout_stats_page.setObjectName(u"gridLayout_stats_page")
        self.gridLayout_stats_page.setContentsMargins(0, 0, 0, 0)
        self.stats_placeholder = QWidget(self.stats_page)
        ...
        self.gridLayout_art_tools_page.setObjectName(u"gridLayout_art_tools_page")
        self.gridLayout_art_tools_page.setContentsMargins(0, 0, 0, 0)
        self.art_tools_placeholder = QWidget(self.art_tools_page)
        self.art_tools_placeholder.setObjectName(u"art_tools_placeholder")

        self.gridLayout_art_tools_page.addWidget(self.art_tools_placeholder, 0, 0, 1, 1)

        self.sidebar_tab.addTab(self.art_tools_page, "")
        ...
        self.menuStable_Diffusion.addAction(self.actionPrompt_Builder)
        self.menuStable_Diffusion.addAction(self.actionDownload_Model)

        self.retranslateUi(MainWindow)

        self.left_panel_tab.setCurrentIndex(0)
        self.sidebar_tab.setCurrentIndex(1)
    ...
    def retranslateUi(self, MainWindow):
...
#if QT_CONFIG(tooltip)
        self.history_sidebar_button.setToolTip(QCoreApplication.translate("MainWindow", u"Chat history", None))
#endif // QT_CONFIG(tooltip)
        self.history_sidebar_button.setText("")
#if QT_CONFIG(tooltip)
        self.llm_settings_sidebar_button.setToolTip(QCoreApplication.translate("MainWindow", u"LLM generator settings", None))
#endif // QT_CONFIG(tooltip)
        self.llm_settings_sidebar_button.setText("")
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.canvas_button.setToolTip(QCoreApplication.translate("MainWindow", u"Toggle Canvas", None))
#endif // QT_CONFIG(tooltip)
        self.canvas_button.setText("")
#if QT_CONFIG(tooltip)
        self.prompt_editor_button.setToolTip(QCoreApplication.translate("MainWindow", u"Toggle Art Prompt", None))
#endif // QT_CONFIG(tooltip)
        self.prompt_editor_button.setText("")
#if QT_CONFIG(tooltip)
        self.art_model_button.setToolTip(QCoreApplication.translate("MainWindow", u"Toggle Art Model Settings", None))
#endif // QT_CONFIG(tooltip)
        self.art_model_button.setText("")
#if QT_CONFIG(tooltip)
        self.lora_button.setToolTip(QCoreApplication.translate("MainWindow", u"Toggle LoRA Settings", None))
#endif // QT_CONFIG(tooltip)
        self.lora_button.setText("")
#if QT_CONFIG(tooltip)
        self.embeddings_button.setToolTip(QCoreApplication.translate("MainWindow", u"Toggle Embedding Settings", None))
#endif // QT_CONFIG(tooltip)
        self.embeddings_button.setText("")
#if QT_CONFIG(tooltip)
        self.layers_button.setToolTip(QCoreApplication.translate("MainWindow", u"Toggle Layer Settings", None))
#endif // QT_CONFIG(tooltip)
        self.layers_button.setText("")
#if QT_CONFIG(tooltip)
        self.grid_button.setToolTip(QCoreApplication.translate("MainWindow", u"Toggle Grid Settings", None))
#endif // QT_CONFIG(tooltip)
        self.grid_button.setText("")
#if QT_CONFIG(tooltip)
        self.image_browser_button.setToolTip(QCoreApplication.translate("MainWindow", u"Toggle Image Browser", None))
#endif // QT_CONFIG(tooltip)
        self.image_browser_button.setText("")
#if QT_CONFIG(tooltip)
        self.stats_button.setToolTip(QCoreApplication.translate("MainWindow", u"Toggle Model Resources", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.left_panel_tab.setTabText(self.left_panel_tab.indexOf(self.left_documents_page), QCoreApplication.translate("MainWindow", u"Documents", None))
