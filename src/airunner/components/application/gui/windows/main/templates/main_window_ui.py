...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon30 = QIcon()
        icon30.addFile(u":/light/icons/feather/light/arrow-down-circle.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionDownload_Model.setIcon(icon30)
        ...
        icon31 = QIcon()
        icon31.addFile(u":/light/icons/feather/light/home.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.home_button.setIcon(icon31)
