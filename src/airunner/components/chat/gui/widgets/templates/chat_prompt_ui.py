...
class Ui_chat_prompt(object):
    def setupUi(self, chat_prompt):
        ...
        self.prompt = QPlainTextEdit(self.prompt_wrapper)
        ...
        self.prompt_wrapper_layout.addWidget(self.prompt, 0, 0, 1, 1)

        self.token_count = QLabel(self.prompt_wrapper)
        ...
        self.token_count.setStyleSheet(u"background-color: transparent; color: rgba(255, 255, 255, 0.5); padding: 4px 24px; font-size: 11px;")

        self.prompt_wrapper_layout.addWidget(self.token_count, 0, 0, 1, 1, Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignTop)

        self.last_message_tokens = QLabel(self.prompt_wrapper)
        ...
        self.last_message_tokens.setStyleSheet(u"background-color: transparent; color: rgba(255, 255, 255, 0.5); padding: 4px 24px; font-size: 11px;")

        self.prompt_wrapper_layout.addWidget(self.last_message_tokens, 0, 0, 1, 1, Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignBottom)

        self.total_tokens = QLabel(self.prompt_wrapper)
        ...
        self.total_tokens.setStyleSheet(u"background-color: transparent; color: rgba(255, 255, 255, 0.5); padding: 4px 24px; font-size: 11px;")

        self.prompt_wrapper_layout.addWidget(self.total_tokens, 0, 0, 1, 1, Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignBottom)


        self.gridLayout.addWidget(self.prompt_wrapper, 0, 0, 1, 1)
