...
services/src/airunner_services/database/alembic/versions/01b52e38f588_add_long_running_project_tables.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/04e4b744a3f6_add_columns_to_conversation.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/04ea79f25b7a_add_calendar_tables.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/06f6460f4c0e_add_columns_to_document.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/073c56efe38b_change_llm_settings_defaults.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/080398045849_add_auto_extract_knowledge.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/0d0ca894ae0b_add_negative_crops_coords_top_left.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/0f8b4e43d1c2_remove_retired_adapter_schema.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/16692f02ba0d_add_zimfiles_table.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/16a14e141cc8_add_prevent_unload_on_llm_image_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/181e31f78151_initial_migration.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/1a9e7c2de7c9_add_reference_speaker_path_column_to_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/1ca474ca1d8f_change_default_langauge.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/201952ffe80a_remove_current_conversation_from_llm_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/20c05328cd3b_restore_nsfw_filter_setting.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/2a7206a1ff79_add_expression_parameters_to_openvoice_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/2d372e78d20b_added_rag_settings_table.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/2d6569089de6_remove_tts_settings.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/2efcc1665030_adds_workflow.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/310819639420_add_agentconfig_table_for_custom_agent_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/31194f554323_add_drawingpad_text_items_column.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/32782f73752d_add_age_restriction_column_to_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/3b1030ac9b9c_remove_splitter_settings.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/449cbcdca2c4_update_bootstrap_data.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/48b1c0d3e4f5_drop_retired_mode_routing_columns.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/4cd9977eb573_add_mode_based_routing_settings.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/500b6c395d38_add_knowledge_migrated_flag.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/50e125c2e188_remove_window_settings.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/533e97f2b74c_add_adapter_path_to_fine_tuned_models.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/5a4d9d9e0b67_add_quantization_and_enabled_adapters_to_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/5dbbe8800572_add_tabs_table.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/647a8e1098ce_rename_crops_coord_top_left_to_crops_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/64ca532067c9_added_playback_and_recording_device_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/65aa37e4593f_add_chunk_size_and_chunk_overlap_to_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/69fb44e0d99f_add_airunner_settings_table.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/6b0f0f6c3e4a_move_client_local_application_settings_to_qsettings.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/6b36790f3292_add_layer_id_to_settings_models.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/72977a42e2a2_add_generate_infinite_images_column.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/738edc36e34f_add_images_per_batch_to_generator_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/7a320f14497a_add_current_to_chatbot.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/7b88f4d9a4a1_add_reasoning_effort_to_llm_generator_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/7e840c47b899_remove_tab_table.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/7fb526dc074c_modify_default_stt_and_tts_paths.py:{down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/810df6adb9db_add_fine_tuned_models_table.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/82e99b1a4ccc_add_detected_language_columsn_to_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/843e4b044d4d_add_model_id_column_to_llm_generator_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/8ae5502625f5_added_custom_path_column_to_generator_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/904f01f8f439_add_nodegraph_settings.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/91e21ecaef23_add_video_projects_table.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/9623fe2fc53a_add_service_settings_fields.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/970363fddcd6_add_n_ctx_and_enable_tools_to_llm_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/978459f9d332_add_variables_column_to_workflow.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/986e262645eb_add_gender_to_chatbot.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/9d70f20f2fed_add_enable_thinking_column_to_llm_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/9d76c1e50d8f_remove_enabled_col_from_rag_settings.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/9e321c582dbe_add_dtype_column_to_generator_settings.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/a2b5afa74dde_add_flow_match_euler_scheduler.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/ac88a4dea04b_add_voice_support.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/aee3c6d6452c_added_strength_column_to_image_to_image_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/b1c4d5e6f7a8_remove_nodegraph_schema.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/b5f6cf56def4_add_canvas_layer_table.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/b808bb218e22_create_openvoice_settings.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/b96406b64944_remove_bot_mood_and_bot_mood_emoji_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/bbd45baafc6f_make_chatbot_name_distinct.py:{down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/c0f6743e26e9_better_splitter_handling.py:{down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/c3f4b2a1d9e8_remove_retired_calendar_news_video_schema.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/c42b9a3d807a_remove_nsfw.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/c81d3ee091da_modify_latest_columns.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/cd69b4cecaed_add_language_settings.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/d2ab5f1c9a7e_move_client_local_language_and_audio_to_qsettings.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/d4184aabeff9_remove_allow_online_mode_column_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/def3ae90b66d_add_knowledge_relationships_table.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/dffe1636eeaf_add_xtts_settings_table.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/e2e0d379a36e_update_generator_settings_columns.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/e6ef79c17a07_add_use_refiner_column_to_generator_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/eda1c0c1f709_make_canvas_layer_name_unique.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/eda751de4bed_add_llm_tool_and_knowledge_tables.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/ee56e41aa8cb_added_allow_hf_downloads_column.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/f0b1f4cf8f41_add_document_size_to_application_settings.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/f480bbc9acdb_drop_knowledge_facts_and_knowledge_.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/f54532589efa_change_enabled_to_false_by_default.py:{branch_labels, down_revision, downgrade}
services/src/airunner_services/database/alembic/versions/f8077817b00e_add_documents.py:{branch_labels, down_revision, downgrade}
